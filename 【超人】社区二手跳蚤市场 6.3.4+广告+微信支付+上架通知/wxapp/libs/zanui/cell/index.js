...
Component({
    ...
    methods: {
        navigateTo: function() {
            ...
            this.triggerEvent("tap", {}), this.data.isLink && e && "true" !== e && "false" !== e && ("boolean" === i || "string" === i ? -1 !== [ "navigateTo", "redirectTo", "switchTab", "reLaunch" ].indexOf(this.data.linkType) ? wx[this.data.linkType].call(wx, {
                url: e
