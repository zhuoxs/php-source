...
Page({
    ...
    onLoad: function(t) {
        var e = t.uid, a = t.today, r = this.data.param;
        wx.setNavigationBarTitle({
            title: a ? "今日浏览" : "总浏览"
        }), r.count = a ? 2 : 0;
        var n = getApp().globalData, i = {
            logoImg: n.logoImg,
            productDefault: n.productDefault,
            isIphoneX: n.isIphoneX
        }, o = e || wx.getStorageSync("userid");
        this.setData({
            $gd: i,
            to_uid: o,
            today: a || 0,
        ...
        return _asyncToGenerator(regeneratorRuntime.mark(function t() {
            ...
            return regeneratorRuntime.wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                  case 0:
                    return a = (e = l).data, r = a.refresh, n = a.param, i = a.list, t.next = 4, _index.pluginModel.getViewRecord(n);
