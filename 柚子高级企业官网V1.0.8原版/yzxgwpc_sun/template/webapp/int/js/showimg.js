...
METUI_FUN['img_list_detail_met_m1156_1']=METUI['img_list_detail_met_m1156_1_x']={
	name: 'img_list_detail_met_m1156_1',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['img_list_detail_met_m1156_1_x'].slide(1);
		}
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['img_list_detail_met_m1156_1_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['img_list_detail_met_m1156_1']
						.css('background-image','url('+METUI['img_list_detail_met_m1156_1'].attr('data-background')+')')
						.removeAttr('data-background')
				}
				METUI['img_list_detail_met_m1156_1'].find('.shownews-slide img').each(function(index, element) {
					$(this).data('src',$(this).attr('data-src'));
				});
				shownews_container = new Swiper('.img_list_detail_met_m1156_1 .shownews-container',{
					...
					watchSlidesProgress: true,
					watchSlidesVisibility: true,
					prevButton: '.img_list_detail_met_m1156_1 .swiper-button-prev',
					nextButton: '.img_list_detail_met_m1156_1 .swiper-button-next',
					onSlideChangeStart: function(swiper){
						METUI['img_list_detail_met_m1156_1'].find('.shownews-slide-small').removeClass('active').eq(swiper.activeIndex).addClass('active');
						METUI['img_list_detail_met_m1156_1'].find('.shownews-slide img').each(function(index, element) {
				...
				var shownews_small_length=METUI['img_list_detail_met_m1156_1'].find('.shownews-container-small').length;
				if(shownews_small_length>0){
					METUI['img_list_detail_met_m1156_1'].find('.shownews-container-small').css(
						'max-width',
						METUI['img_list_detail_met_m1156_1'].find('.shownews-slide-small').length*95-15+'px'
					);
					shownews_container_small = new Swiper('.img_list_detail_met_m1156_1 .shownews-container-small',{
					...
					shownews_container_small.on('tap',function(swiper){
						...
						METUI['img_list_detail_met_m1156_1'].find('.shownews-slide-small').removeClass('active').eq(swiper.clickedIndex).addClass('active');
					});
				}
			break;
			case 2:
...
var x=new metui(METUI_FUN['img_list_detail_met_m1156_1']);
