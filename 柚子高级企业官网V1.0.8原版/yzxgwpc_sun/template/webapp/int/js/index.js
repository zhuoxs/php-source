...
METUI_FUN['join_list_met_m1156_1']=METUI['join_list_met_m1156_1_x']={
	name: 'join_list_met_m1156_1',
	IE9: navigator.userAgent.indexOf('MSIE 9.0')>0,
	init: function(){
		if($('.swiper-header').length==0){
			METUI['join_list_met_m1156_1_x'].slide(1);
		}		
	},
	resize: function(res){
		if(METUI['join_list_met_m1156_1'].hasClass('full')) METUI['join_list_met_m1156_1'].height($(window).height());
		if(!res) $(window).resize(function(){ METUI['join_list_met_m1156_1_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['join_list_met_m1156_1']
						.css('background-image','url('+METUI['join_list_met_m1156_1'].attr('data-background')+')')
						.removeAttr('data-background');
				}
				METUI['join_list_met_m1156_1_join']=new Swiper('.join-list',{ 
					wrapperClass: 'join-ul',
					slideClass: 'join-li',
					autoplay: 3500, 
					lazyLoading: true,
					lazyLoadingClass: 'join-lazy',
					lazyLoadingOnTransitionStart: true,
					watchSlidesProgress: true,
					watchSlidesVisibility: true,
					observer:true,
				...
				METUI['join_list_met_m1156_1'].addClass('active');
			break;
			case 2:
				METUI['join_list_met_m1156_1_join'].init();
				METUI['join_list_met_m1156_1'].addClass('active');
			break;
			case 3:
				if(METUI['join_list_met_m1156_1_join']) METUI['join_list_met_m1156_1_join'].destroy(false);
				METUI['join_list_met_m1156_1'].removeClass('active');
			break;
		}
	}
}
var x=new metui(METUI_FUN['join_list_met_m1156_1']);
...
METUI_FUN['help_list_met_m1156_1']=METUI['help_list_met_m1156_1_x']={
	name: 'help_list_met_m1156_1',
	IE9: navigator.userAgent.indexOf('MSIE 9.0')>0,
	init: function(){
		if($('.swiper-header').length==0){
			METUI['help_list_met_m1156_1_x'].slide(1);
		}	
	},
	resize: function(res){
		if(METUI['help_list_met_m1156_1'].hasClass('full')) METUI['help_list_met_m1156_1'].height($(window).height());
		if(!res) $(window).resize(function(){ METUI['help_list_met_m1156_1_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['help_list_met_m1156_1']
						.css('background-image','url('+METUI['help_list_met_m1156_1'].attr('data-background')+')')
						.removeAttr('data-background');
				}
				if(METUI['help_list_met_m1156_1'].find('.help-list').length>0){
					METUI['help_list_met_m1156_1_help']=new Swiper('.help-list',{
						wrapperClass: 'help-ul',
						slideClass: 'help-li',
						autoplay: 3500,
						lazyLoading: true,
						lazyLoadingClass: 'help-lazy',
						lazyLoadingOnTransitionStart: true,
						observer:true,
						observeParents:true,
						watchSlidesProgress: true,
					...
					if(METUI['help_list_met_m1156_1'].find('.help-list').length==1){
						var picture=METUI['help_list_met_m1156_1_help'];
						METUI['help_list_met_m1156_1_help']=[];
						METUI['help_list_met_m1156_1_help'][0]=picture;
					}
					for(var i in METUI['help_list_met_m1156_1_help']){
						METUI['help_list_met_m1156_1_help'][i].stopAutoplay(); 
					}
					METUI['help_list_met_m1156_1_help'][0].startAutoplay(); 
					METUI['help_list_met_m1156_1'].find('.help-nav b').click(function(){
						METUI['help_list_met_m1156_1'].find('.help-nav b').removeClass('active');
						$(this).addClass('active');
						METUI['help_list_met_m1156_1'].find('.help-list').removeClass('active');
						METUI['help_list_met_m1156_1'].find('.help-list[data-id='+$(this).attr('data-id')+']').addClass('active');
						for(var i in METUI['help_list_met_m1156_1_help']){
							METUI['help_list_met_m1156_1_help'][i].stopAutoplay(); 
						}
						METUI['help_list_met_m1156_1_help'][$(this).index()].startAutoplay(); 
					});
					METUI['help_list_met_m1156_1'].find('.help-ctrl .ctrl-left').click(function(){
						METUI['help_list_met_m1156_1_help'][METUI['help_list_met_m1156_1'].find('.help-list.active').index()].slidePrev();
					});
					METUI['help_list_met_m1156_1'].find('.help-ctrl .ctrl-right').click(function(){
						METUI['help_list_met_m1156_1_help'][METUI['help_list_met_m1156_1'].find('.help-list.active').index()].slideNext();
					});
					METUI['help_list_met_m1156_1'].find('.help-nav b').dblclick(function(){
						window.location.href=$(this).attr('data-href');
					});
				}
				METUI['help_list_met_m1156_1'].find('.help-li p').click(function(){
					var imglist = $(this).data("imglist"),
						dyarr = new Array(),
						arlt = imglist.split('|');
					$.each(arlt,function(name,value){
				...
				METUI['help_list_met_m1156_1'].addClass('active');
			break;
			case 2:
				for(var i in METUI['help_list_met_m1156_1_help']){
					METUI['help_list_met_m1156_1_help'][i].init();
				}
				METUI['help_list_met_m1156_1'].addClass('active');
			break;
			case 3:
				for(var i in METUI['help_list_met_m1156_1_help']){
					METUI['help_list_met_m1156_1_help'][i].destroy(false);
				}
				METUI['help_list_met_m1156_1'].removeClass('active');
			break;
		}
	}
}
var x=new metui(METUI_FUN['help_list_met_m1156_1']);
