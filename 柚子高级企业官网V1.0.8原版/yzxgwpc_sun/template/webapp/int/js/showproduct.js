...
METUI_FUN['product_list_detail_met_m1156_1']=METUI['product_list_detail_met_m1156_1_x']={
	name: 'product_list_detail_met_m1156_1',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['product_list_detail_met_m1156_1_x'].slide(1);
		}
		if(METUI['product_list_detail_met_m1156_1'].find('.met-showproduct').hasClass('pagetype2')){
			$(window).scroll(function(){
				if( METUI['product_list_detail_met_m1156_1'].find('.navbar.navbar-default').hasClass('navbar-fixed-top') ){
					METUI['product_list_detail_met_m1156_1'].find('.met-showproduct').addClass('top');
				}else{
					METUI['product_list_detail_met_m1156_1'].find('.met-showproduct').removeClass('top');
				}
			});
		}
	},
	scroll: function(res){
		if(METUI['product_list_detail_met_m1156_1'].find('.met-showproduct').hasClass('pagetype2')){
			...
			times=window.setTimeout(function(){
				var nav=METUI['product_list_detail_met_m1156_1'].find("nav.navbar.navbar-default");
		...
		if(!res) $(window).scroll(function(){ METUI['product_list_detail_met_m1156_1_x'].scroll(true); });
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['product_list_detail_met_m1156_1_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['product_list_detail_met_m1156_1']
						.css('background-image','url('+METUI['product_list_detail_met_m1156_1'].attr('data-background')+')')
						.removeAttr('data-background')
				}
				METUI['product_list_detail_met_m1156_1'].find('.shownews-slide img').each(function(index, element) {
					$(this).data('src',$(this).attr('data-src'));
				});
				shownews_container = new Swiper('.product_list_detail_met_m1156_1 .shownews-container',{
					...
					watchSlidesProgress: true,
					watchSlidesVisibility: true,
					prevButton: '.product_list_detail_met_m1156_1 .swiper-button-prev',
					nextButton: '.product_list_detail_met_m1156_1 .swiper-button-next',
					onSlideChangeStart: function(swiper){
						METUI['product_list_detail_met_m1156_1'].find('.shownews-slide-small').removeClass('active').eq(swiper.activeIndex).addClass('active');
						METUI['product_list_detail_met_m1156_1'].find('.shownews-slide img').each(function(index, element) {
				...
				var shownews_small_length=METUI['product_list_detail_met_m1156_1'].find('.shownews-container-small').length;
				if(shownews_small_length>0){
					METUI['product_list_detail_met_m1156_1'].find('.shownews-container-small').css(
						'max-width',METUI['product_list_detail_met_m1156_1'].find('.shownews-slide-small').length*95-15+'px'
					);
					shownews_container_small = new Swiper('.product_list_detail_met_m1156_1 .shownews-container-small',{
					...
					shownews_container_small.on('tap',function(swiper){
						...
						METUI['product_list_detail_met_m1156_1'].find('.shownews-slide-small').removeClass('active').eq(swiper.clickedIndex).addClass('active');
					});
				}
			break;
			case 2:
...
var x=new metui(METUI_FUN['product_list_detail_met_m1156_1']);
