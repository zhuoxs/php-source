...
$GLOBALS['frames'] = $this->getMainMenu();
	$info = pdo_get('zhls_sun_yellowtype',array('uniacid' => $_W['uniacid'],'id'=>$_GPC['id']));
		if(checksubmit('submit')){
			...
			if($_GPC['id']==''){				
				$res=pdo_insert('zhls_sun_yellowtype',$data);
				if($res){
				...
				$res = pdo_update('zhls_sun_yellowtype', $data, array('id' => $_GPC['id']));
				if($res){
