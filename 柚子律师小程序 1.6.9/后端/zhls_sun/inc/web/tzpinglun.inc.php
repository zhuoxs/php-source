...
$sql="select a.* ,b.details as tzinfo from " . tablename("zhls_sun_comments") . " a"  . " left join " . tablename("zhls_sun_information") . " b on a.information_id=b.id ".$where." order by time DESC";
