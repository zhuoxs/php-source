...
$pagesize=10;
$sql="select * from".tablename('zhls_sun_news')." where uniacid={$_W['uniacid']} ORDER BY num ASC";
$total=pdo_fetchcolumn("select count(*) from".tablename('zhls_sun_news')." where uniacid={$_W['uniacid']} ");
