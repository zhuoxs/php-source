...
Page({
    ...
    getMore: function() {
        ...
        var t = i.data.article.id, e = i.data.pindex, a = i.data.psize;
    ...
    formSubmit: function(t) {
        ...
        if (0 == a.length) wx.showModal({
            ...
            var i = e.data.article.id, s = e.data.user.id, n = JSON.stringify(e.data.picall);
            _request2.default.post("artmessage", {
                op: "addmessage",
                articleid: i,
                userid: s,
    ...
    onLoad: function(t) {
        ...
        e.setData({
            ...
            param: i,
            user: s
        }), 0 == i.openart && null == s && wx.redirectTo({
            url: "../login/login"
        });
        var n = t.articleid;
        null == s || s.id;
        _request2.default.get("artmessage", {
            articleid: n
        }).then(function(t) {
            e.setData({
                article: t.article,
