...
Page({
    ...
    radioChange: function(e) {
        this.setData({
            luserid: e.detail.value
        });
    },
    formSubmit: function(e) {
        var t = this, a = e.detail.value.title, i = e.detail.value.realname, n = e.detail.value.mobile, s = e.detail.value.details, o = t.data.luserid;
        if (0 == o) wx.showModal({
            title: "提示",
            content: "请选择信息收件人",
            showCancel: !1,
            success: function(e) {}
        }); else if (0 == a.length) wx.showModal({
            title: "提示",
            content: "内容主题不能为空",
            showCancel: !1,
            success: function(e) {}
            ...
            var l = t.data.user.id, r = JSON.stringify(t.data.picall);
            _request2.default.post("supmailbox", {
                op: "post",
                userid: l,
                luserid: o,
                title: a,
    ...
    onLoad: function(e) {
        var t = this, a = wx.getStorageSync("attachurl") || "", i = wx.getStorageSync("param") || null, n = wx.getStorageSync("user") || null;
        t.setData({
            attachurl: a,
            param: i,
            user: n,
