...
$return_url = "http://".$url_base."/plugin/tenpay/payReturnUrl.php";
$notify_url = "http://".$url_base."/plugin/tenpay/payNotifyUrl.php";
$partner = $setting['tenpay_user']; 
$key = $setting['tenpay_key']; 
/* 获取提交的订单号 */
$out_trade_no = $v_oid;
/* 获取提交的商品名称 */
$product_name = $url_base;
...
/* 创建支付请求对象 */
$reqHandler = new RequestHandlerClass();
$reqHandler->init();
...
<br/><a href="<?php echo $reqUrl ?>" target="_blank">财付通支付</a>
 -->
<form action="<?php echo $reqHandler->getGateUrl() ?>" method="POST" name="tenpay_from">
<?php
