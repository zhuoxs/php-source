...
if($_GPC['op']=='fh'){
    $res=pdo_update('yzcj_sun_order',array('status'=>6),array('orderNum'=>$_GPC['orderNum'],'uniacid'=>$_W['uniacid']));
    if($res){
...
if($_GPC['op']=='sh'){
    $res=pdo_update('yzcj_sun_order',array('status'=>5),array('orderNum'=>$_GPC['orderNum'],'uniacid'=>$_W['uniacid']));
    if($res){
