...
$sql="select a.* ,b.details as tzinfo,c.name from " . tablename("chbl_sun_comments") . " a"  . " left join " . tablename("chbl_sun_information") . " b on a.information_id=b.id  left join " . tablename("chbl_sun_user") . " c on a.user_id=c.id ".$where." order by time DESC";
