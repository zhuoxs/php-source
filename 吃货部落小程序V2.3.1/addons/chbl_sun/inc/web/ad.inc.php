...
$pagesize=10;
$sql="select * from".tablename('chbl_sun_ad')." where uniacid={$_W['uniacid']} ORDER BY orderby ASC";
$total=pdo_fetchcolumn("select count(*) from".tablename('chbl_sun_ad')." where uniacid={$_W['uniacid']} ");
