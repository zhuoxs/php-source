...
Page({
    ...
    onLoad: function(t) {
        ...
        wx.setNavigationBarTitle({
        ...
        }), 0 < (t = app.func.decodeScene(t)).d_user_id && o.setData({
            ...
            1 == t.is_layout && o.setData({
                sort: t.index_layout
            }), o.setData({
                setting: t,
                showAd: null == app.globalData.showAd ? t.is_adv : app.globalData.showAd
    ...
    onShareAppMessage: function() {
        return {
            path: "/yzqzk_sun/pages/index/index?d_user_id=" + this.data.user.id
        };
    },
    ...
    toMember: function() {
        wx.navigateTo({
            url: "/yzqzk_sun/pages/member/member"
        });
    },
