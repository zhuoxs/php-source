            ...
            wx.scanCode({
                success: function(t) {
                    ...
                    app.util.request({
                        ...
                        success: function(t) {
                            if (1 == t.data.errcode) {
                                var a = "/yzqzk_sun/pages/backstage/coupon/coupon?id=" + t.data.user_coupon_id + "&uid=" + t.data.uid;
                                wx.navigateTo({
                                    url: a
                                });
                            } else if (2 == t.data.errcode) {
                                a = "/yzqzk_sun/pages/backstage/writeoff/writeoff?orderid=" + t.data.orderid + "&uid=" + t.data.uid;
                                wx.navigateTo({
                                    url: a
                                });
                            }
