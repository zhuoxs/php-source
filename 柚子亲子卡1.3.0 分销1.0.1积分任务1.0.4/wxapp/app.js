...
App({
    ...
    _defineProperty(_globalData, "isIpx", !1), _defineProperty(_globalData, "Plugin_distribution", "yzqzk_sun_plugin_distribution"), 
    _defineProperty(_globalData, "Plugin_scoretask", "yzqzk_sun_plugin_scoretask"), 
    _defineProperty(_globalData, "tabBar", {
        ...
        borderStyle: "#ccc",
        list: [ {
            pagePath: "/yzqzk_sun/pages/index/index",
            text: "首页",
            ...
            pagePath: "/yzqzk_sun/pages/punch/punch",
            text: "打卡",
            ...
            pagePath: "/yzqzk_sun/pages/member/member",
            text: "亲子卡",
            ...
            pagePath: "/yzqzk_sun/pages/shop/shop",
            text: "好店",
            ...
            pagePath: "/yzqzk_sun/pages/user/user",
            text: "我的",
