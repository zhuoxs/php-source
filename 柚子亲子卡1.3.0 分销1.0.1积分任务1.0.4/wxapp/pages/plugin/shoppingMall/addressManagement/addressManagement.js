...
Page({
    ...
    install: function(e) {
        var s = this, t = e.currentTarget.dataset.id, a = (this.data.gid, wx.getStorageSync("user").openid);
        app.util.request({
    ...
    jump: function(e) {
        this.data.gid;
        var t = wx.getStorageSync("jump_type"), s = e.currentTarget.dataset.address_id;
        wx.setStorageSync("scoretask_address_id", s), 1 == t ? (wx.setStorageSync("jump_type", 0), 
        wx.navigateTo({
    ...
    chooseAddress: function() {
        ...
        wx.chooseAddress({
            success: function(e) {
                var t = e.userName, s = e.telNumber, a = e.provinceName, o = e.cityName, d = e.countyName, i = e.detailInfo, n = e.postalCode, r = c.data.radioValue, l = wx.getStorageSync("user").openid;
                app.util.request({
