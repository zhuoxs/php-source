...
Page({
    ...
    onLoad: function(t) {
        ...
        var l = this, o = wx.getStorageSync("user").openid;
        app.util.request({
    ...
    getAddressList: function() {
        var c = this, t = wx.getStorageSync("user").openid, a = wx.getStorageSync("scoretask_address_id");
    ...
    submit1: function(t) {
        ...
        var o = wx.getStorageSync("user").openid, n = t.currentTarget.dataset.title, s = t.currentTarget.dataset.icon;
    ...
    getOrderDetailByGid: function() {
        var a = this, t = wx.getStorageSync("user").openid, e = this.data.id;
        app.util.request({
    ...
    orderUser: function(t) {
        ...
        if (n <= 0) wx.showToast({
            ...
            var s = wx.getStorageSync("user").openid;
            app.util.request({
    ...
    onShow: function() {
        this.getAddressList(), this.getOrderDetailByGid();
    },
    editor: function(t) {
