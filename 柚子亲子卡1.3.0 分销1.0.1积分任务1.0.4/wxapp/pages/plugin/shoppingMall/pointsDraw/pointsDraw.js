...
Page({
    ...
    onLoad: function() {
        ...
        for (var t = 7.5, a = 7.5, i = [], n = 0; n < 24; n++) {
            if (0 == n) t = a = 15; else if (n < 6) a = 7.5, t += 102.5; else if (6 == n) a = 15, 
            t = 620; else if (n < 12) a += 94, t = 620; else if (12 == n) a = 565, t = 620; else if (n < 18) a = 570, 
            t -= 102.5; else if (18 == n) a = 565, t = 15; else {
                if (!(n < 24)) return;
                a -= 94, t = 7.5;
            }
            i.push({
        ...
        app.util.request({
            ...
            success: function(e) {
                if ((e = e.data).data.length < 8) wx.showModal({
                    ...
                    for (var t = 0; t < 8; t++) {
                        0 == t ? c = o = 25 : t < 3 ? (o = o, c = c + 166.6666 + 15) : t < 5 ? (c = c, o = o + 150 + 15) : t < 7 ? (c = c - 166.6666 - 15, 
                        o = o) : t < 8 && (c = c, o = o - 150 - 15);
    ...
    startGame: function() {
        ...
        if (!this.data.isRunning) {
            ...
            var i = this, n = 0, r = 0, t = wx.getStorageSync("user").openid;
            app.util.request({
                ...
                success: function(e) {
                    0 == (e = e.data) ? wx.showModal({
                        ...
                        showLoading: !1,
                        success: function(e) {
                            if (1 != e.data.code) var t = 30 * (e = e.data).data.index + 960, a = setInterval(function() {
