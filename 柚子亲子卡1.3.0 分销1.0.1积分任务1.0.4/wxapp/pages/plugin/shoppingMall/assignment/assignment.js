...
Page({
    ...
    onLoad: function(t) {
        var a = wx.getStorageSync("user").openid, e = this;
        app.util.request({
    ...
    sign: function() {
        var e = this, t = wx.getStorageSync("user").openid;
        app.util.request({
    ...
    onShareAppMessage: function(t) {
        ...
        if ("button" === t.from) {
            ...
            console.log(a);
            var e = t.target.dataset.article_id, o = t.target.dataset.openid, s = t.target.dataset.title, i = t.target.dataset.icon;
            if (1 == a) return {
                title: s,
                imageUrl: this.data.imgroot + i,
                path: "/pages/plugin/shoppingMall/home/home?share_type=" + a + "&d_user=" + o + "&article_id=" + e,
                success: function(t) {
                    console.log("转发成功");
                },
                fail: function(t) {
            ...
            if (2 == a) return console.log("邀请好友"), o = wx.getStorageSync("user").openid, {
                title: "看好文，获积分，...",
                imageUrl: this.data.imgroot + i,
                path: "/pages/plugin/shoppingMall/home/home?share_type=" + a + "&d_user=" + o,
                success: function(t) {
                    console.log("转发成功");
                },
                fail: function(t) {
    ...
    invite: function(t) {
        var a = t.currentTarget.dataset.id, e = wx.getStorageSync("user").openid, o = t.currentTarget.dataset.title, s = t.currentTarget.dataset.icon;
        this.setData({
            showModel: !0,
            type: 1,
            article_id: a,
    ...
    onShow: function() {
        var t = wx.getStorageSync("article_id"), a = wx.getStorageSync("user").openid;
