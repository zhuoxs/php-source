...
Page({
    ...
    getMyOrder: function() {
        var o = this, a = wx.getStorageSync("user").openid, r = o.data.page, d = (o.data.pagesize, 
    ...
    getSign: function() {
        var o = this, a = wx.getStorageSync("user").openid, r = o.data.page1, d = (o.data.pagesize, 
        o.data.sign);
        app.util.request({
            url: "entry/wxapp/getMyOrder",
            data: {
    ...
    getSend: function() {
        var o = this, a = wx.getStorageSync("user").openid, r = o.data.page2, d = (o.data.pagesize, 
        o.data.send);
        app.util.request({
            url: "entry/wxapp/getMyOrder",
            data: {
    ...
    getComplete: function() {
        var o = this, a = wx.getStorageSync("user").openid, r = o.data.page3, d = (o.data.pagesize, 
        o.data.complete);
        app.util.request({
            url: "entry/wxapp/getMyOrder",
            data: {
