...
Page((_defineProperty(_Page = {
    ...
    making: function(t) {
        var e = this, a = t.currentTarget.dataset.id, o = wx.getStorageSync("user").openid, s = e.data.list, i = t.currentTarget.dataset.index, n = t.currentTarget.dataset.is_mark;
    ...
    getList: function() {
        var a = this, t = this.data.value, o = a.data.page, s = a.data.list, e = wx.getStorageSync("user").openid;
        console.log("还在吗"), console.log(t), console.log(wx.getStorageSync("user")), app.util.request({
            ...
            success: function(t) {
                ...
                if (1 == o) s = t.data.data; else for (var e in t.data.data) s.push(t.data.data[e]);
                o += 1, a.setData({
                    list: s,
    ...
    var a = wx.getStorageSync("user").openid, o = t.currentTarget.dataset.title, s = t.currentTarget.dataset.icon;
    ...
    if ("button" === t.from) {
        ...
        console.log(e);
        var a = t.target.dataset.article_id, o = t.target.dataset.openid, s = t.target.dataset.title, i = t.target.dataset.icon;
        if (1 == e) return {
            title: s,
            imageUrl: i,
        ...
        if (2 == e) return console.log("邀请好友"), {
            title: "看好文，获积分，...",
            imageUrl: i,
            path: "/pages/plugin/shoppingMall/home/home?share_type=" + e + "&d_user=" + (o = wx.getStorageSync("user").openid),
            success: function(t) {
                console.log("转发成功");
            },
            fail: function(t) {
