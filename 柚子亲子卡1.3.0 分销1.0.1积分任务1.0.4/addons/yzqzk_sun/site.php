...
class yzqzk_sunModuleSite extends Core {
...
public function doMobileDeleteGoods(){
    global $_W, $_GPC;
        $res=pdo_delete('yzqzk_sun_goods',array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileAdoptGoods(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_goods',array('state'=>2),array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileRejectGoods(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_goods',array('state'=>3),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('goods',array()),'success');
        }else{
            message('操作失败','','error');
