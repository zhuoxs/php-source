...
$GLOBALS['frames'] = $this->getMainMenu();
 $type=pdo_getall('yzqzk_sun_zx_type',array('uniacid'=>$_W['uniacid']));
$system=pdo_get('yzqzk_sun_system',array('uniacid'=>$_W['uniacid']));
$info=pdo_get('yzqzk_sun_zx',array('id'=>$_GPC['id']));
//var_dump($info);die;
//if($info['imgs']){
//            if(strpos($info['imgs'],',')){
...
if(checksubmit('submit')){
        ...
        $data['imgs']=$_GPC['imgs'];
        //$data['indeximg']=$_GPC['indeximg'];有这个会出错
     ...
     if($_GPC['id']==''){  
        ...
        $res=pdo_insert('yzqzk_sun_zx',$data,false);
        if($res){
