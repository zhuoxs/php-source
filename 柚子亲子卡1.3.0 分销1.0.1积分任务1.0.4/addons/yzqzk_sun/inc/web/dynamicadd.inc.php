...
$info=pdo_get('yzqzk_sun_dynamic',array('uniacid'=>$_W['uniacid'],'id'=>$_GPC['id']));
...
if(checksubmit('submit')){
    ...
    if($_GPC['imgs']){
        ...
        $system=pdo_get('yzqzk_sun_system',array('uniacid'=>$_W['uniacid']));
			...
			if(empty($_GPC['id'])){
                $res = pdo_insert('yzqzk_sun_dynamic', $data);
            }else{
                $res = pdo_update('yzqzk_sun_dynamic', $data, array('id' => $_GPC['id']));
            }
				if($res){
