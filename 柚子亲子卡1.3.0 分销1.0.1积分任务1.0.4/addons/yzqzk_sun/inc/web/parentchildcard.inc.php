...
$GLOBALS['frames'] = $this->getMainMenu();
 $item=pdo_get('yzqzk_sun_settings',array('uniacid'=>$_W['uniacid']));
    ...
    if(checksubmit('submit')){
            ...
            $data['privilege_title']=$_GPC['privilege_title'];
            $data['privilege_info']=$_GPC['privilege_info'];
            $data['bg']=$_GPC['bg'];

            if($_GPC['id']==''){                
                $res=pdo_insert('yzqzk_sun_settings',$data);
                if($res){
                ...
                $res = pdo_update('yzqzk_sun_settings', $data, array('id' => $_GPC['id']));
                if($res){
