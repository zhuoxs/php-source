...
$info=pdo_get('yzqzk_sun_bargain',array('uniacid'=>$_W['uniacid'],'id'=>$_GPC['id']));
$id = $_GPC['id'];
...
if(checksubmit('submit')){
        ...
        if (!empty($id)) {
            ...
            unset($data['status']);
           $res = pdo_update('yzqzk_sun_bargain',$data, array('id' => $id));
        } else {
           $res = pdo_insert('yzqzk_sun_bargain',$data);
