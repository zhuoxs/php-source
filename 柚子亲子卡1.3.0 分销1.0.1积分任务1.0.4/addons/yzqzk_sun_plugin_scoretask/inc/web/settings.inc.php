...
$GLOBALS['frames'] = $this->getMainMenu();
 $item=pdo_get('yzqzk_sun_plugin_scoretask_system',array('uniacid'=>$_W['uniacid']));
if($item['shopdes_img']){
...
if($item['shop_banner']){
    ...
    if(checksubmit('submit')){
            ...
            if($_GPC['id']==''){                
                $res=pdo_insert('yzqzk_sun_plugin_scoretask_system',$data);
                if($res){
                ...
                $res = pdo_update('yzqzk_sun_plugin_scoretask_system', $data, array('id' => $_GPC['id']));
                if($res){
