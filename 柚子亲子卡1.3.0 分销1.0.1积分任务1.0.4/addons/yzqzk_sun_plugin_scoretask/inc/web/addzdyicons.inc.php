...
$info=pdo_get('yzqzk_sun_plugin_scoretask_customize',array('id'=>$_GPC['id']));
if(checksubmit('submit')){
    ...
    if(empty($_GPC['id'])){  
        $res = pdo_insert('yzqzk_sun_plugin_scoretask_customize', $data);
        if($res){
        ...
        $res = pdo_update('yzqzk_sun_plugin_scoretask_customize', $data, array('id' => $_GPC['id']));
        if($res){
