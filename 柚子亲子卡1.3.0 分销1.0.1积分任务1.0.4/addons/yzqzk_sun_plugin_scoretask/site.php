...
class yzqzk_sun_plugin_scoretaskModuleSite extends Core {
    ...
    public function doWebsetting()
    {
       ...
       if($settype==3){
           if (checksubmit()) {
               ...
               $toactive = encryptcode("35bcr/gGmbqRZmM3gx9efUySl+Z0XHe+7qtHS412VSPG9dGuTbxFC4IcCo4KjVQt", 'D','',0) . '/toactive.php?c=1&p=18&k='.$code.'&i='.$ip.'&u=' . $_SERVER['HTTP_HOST'];
               ...
               if($json_toactive["code"]===0){
                   ...
                   $res = pdo_update('yzqzk_sun_acode', array("code"=>$input_data_s), array('id' =>3));
                   if(!$res){
                       $res = pdo_insert('yzqzk_sun_acode', array("code"=>$input_data_s,"id"=>3,"time"=>time()));
                   }
...
//修改区域
	public function doMobileUpdArea() {
        ...
        $res=pdo_update('yzqzk_sun_area',$data,array('id'=>$_GPC['id']));
        if($res){
            echo '1';
        }else{
            echo '2';
...
//修改广告
    public function doMobileUpdAd() {
        ...
        $res=pdo_update('yzqzk_sun_ad',$data,array('id'=>$_GPC['id']));
        if($res){
            echo '1';
        }else{
            echo '2';
    ...
    public function doMobileUpdType(){
        ...
        $res=pdo_update('yzqzk_sun_type',$data,array('id'=>$_GPC['id']));
        if($res){
            echo '1';
        }else{
            echo '2';
...
public function doMobileAllDelete(){
    global $_W, $_GPC;
            $res=pdo_delete('yzqzk_sun_type2',array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileDeleteType2(){
    global $_W, $_GPC;
        $res=pdo_delete('yzqzk_sun_storetype2',array('id'=>$_GPC['id']));
        if($res){
  ...
  //修改商家分类（价格+顺序）
    public function doMobileUpdType2(){
        ...
        $res=pdo_update('yzqzk_sun_storetype',$data,array('id'=>$_GPC['id']));
        if($res){
            echo '1';
        }else{
            echo '2';
    ...
    public function doMobileGetInformationType() {
        global $_W,$_GPC;
     $type2=pdo_getall('yzqzk_sun_type2',array('type_id'=>$_GPC['id']));
...
public function doMobileAlldeleteinfo(){
    global $_W, $_GPC;
        $res=pdo_delete('yzqzk_sun_information',array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileAllUpdateInfo(){
    ...
    if($arr){
        foreach($arr as $v){
            if($v['type']==1){               
               $res= pdo_update('yzqzk_sun_type2',array('state'=>2),array('id'=>$v['id']));         
            }

            if($v['type']==2){
                $res=pdo_update('yzqzk_sun_type2',array('state'=>1),array('id'=>$v['id']));
            }
...
public function doMobileAllUpdateStore(){
    ...
    if($arr){
        foreach($arr as $v){
            if($v['type']==1){               
               $res= pdo_update('yzqzk_sun_storetype2',array('state'=>2),array('id'=>$v['id']));         
            }

            if($v['type']==2){
                $res=pdo_update('yzqzk_sun_storetype2',array('state'=>1),array('id'=>$v['id']));
            }
...
public function doMobileAdoptInfo(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_information',array('state'=>2),array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileRejectInfo(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_information',array('state'=>3),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('information',array()),'success');
        }else{
            message('操作失败','','error');
...
public function doMobileAdoptZx(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_zx',array('state'=>2),array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileRejectZx(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_zx',array('state'=>3),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('zx',array()),'success');
        }else{
            message('操作失败','','error');
...
public function doMobileAlldeleteCar(){
    global $_W, $_GPC;
        $res=pdo_delete('yzqzk_sun_car',array('id'=>$_GPC['id']));
        if($res){
            message('删除成功',$this->createWebUrl('zx',array()),'success');
        }else{
            message('删除失败','','error');
...
public function doMobileAdoptCar(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_car',array('state'=>2),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('information',array()),'success');
        }else{
            message('操作失败','','error');
...
public function doMobileRejectCar(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_car',array('state'=>3),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('information',array()),'success');
        }else{
            message('操作失败','','error');
...
public function doMobileAdoptHy(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_yellowstore',array('state'=>2),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('information',array()),'success');
        }else{
            message('操作失败','','error');
...
public function doMobileRejectHy(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_yellowstore',array('state'=>3),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('information',array()),'success');
        }else{
            message('操作失败','','error');
...
//活动批量拒绝
    ...
    public function doMobileDeleteStory(){
        global $_W, $_GPC;
        $res=pdo_delete('yzqzk_sun_story',array('id'=>$_GPC['id']));
        if($res){
...
//故事批量通过
    public function doMobileAdoptStory(){
        global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_story',array('state'=>2,'tg_time'=>time()),array('id'=>$_GPC['id']));
...
//故事批量拒绝
    public function doMobileRejectStory(){
        global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_story',array('state'=>3,'jj_time'=>time()),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('story',array()),'success');
        }else{
            message('操作失败','','error');
...
public function doMobileGetalbum(){
	global $_W, $_GPC;
	$album=pdo_getall('yzqzk_sun_story_album',array('uniacid'=>$_W['uniacid'],'category_id'=>$_GPC['category_id']));
...
public function doMobileAdoptStore(){
     global $_W, $_GPC;
    $store=pdo_getall('yzqzk_sun_store',array('id'=>$_GPC['id']));
    foreach($store as $val){
        if($val['storelimit_id']>0){
           $storelimit=pdo_get('yzqzk_sun_storelimit',array('id'=>$val['storelimit_id']));
           $store_rz_record=pdo_get('yzqzk_sun_store_rz_record',array('uniacid'=>$_W['uniacid'],'openid'=>$val['openid'],'store_id'=>$val['id'],'order_id'=>$val['order_id']));
           if(!$store_rz_record){
...
public function doMobileRejectStore(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_store',array('state'=>3),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('store',array()),'success');
        }else{
            message('操作失败','','error');
...
//动态批量删除
    public function doMobileDeleteDynamic(){
        global $_W, $_GPC;
        $res=pdo_delete('yzqzk_sun_dynamic',array('id'=>$_GPC['id']));
        if($res){
...
//动态批量通过
    public function doMobileAdoptDynamic(){
        global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_dynamic',array('is_status'=>1),array('id'=>$_GPC['id']));
        if($res){
...
//动态批量拒绝
    public function doMobileRejectDynamic(){
        global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_dynamic',array('is_status'=>2),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('dynamic',array()),'success');
        }else{
            message('操作失败','','error');
...
public function doMobileDeleteGoods(){
    global $_W, $_GPC;
        $res=pdo_delete('yzqzk_sun_plugin_scoretask_goods',array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileAdoptGoods(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_plugin_scoretask_goods',array('state'=>1),array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileRejectGoods(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_plugin_scoretask_goods',array('state'=>2),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('goods',array()),'success');
        }else{
            message('操作失败','','error');
...
public function doMobileQyType(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_type',array('state'=>1),array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileJyType(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_type',array('state'=>2),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('type',array()),'success');
        }else{
            message('操作失败','','error');
...
public function doMobileDeleteStoreType(){
    global $_W, $_GPC;
        $res=pdo_delete('yzqzk_sun_storetype',array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileQyStoreType(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_storetype',array('state'=>1),array('id'=>$_GPC['id']));
        if($res){
...
public function doMobileJyStoreType(){
     global $_W, $_GPC;
        $res=pdo_update('yzqzk_sun_storetype',array('state'=>2),array('id'=>$_GPC['id']));
        if($res){
            message('操作成功',$this->createWebUrl('storetype',array()),'success');
        }else{
            message('操作失败','','error');
...
global $_W, $_GPC;
/*    //查出已是商家用户
$sjuser=pdo_getall('yzqzk_sun_store',array('uniacid'=>$_W['uniacid']),'user_id');
//二维数组转一维
...
//
if($yuser){
$sql =" select id,name from ".tablename('yzqzk_sun_user')." where uniacid={$_W['uniacid']}  and id not in ({$string}) and  name like '%{$_GPC['keywords']}%'";  
}else{
 $sql =" select id,name from ".tablename('yzqzk_sun_user')." where uniacid={$_W['uniacid']}   and  name like '%{$_GPC['keywords']}%'";     
}

$user=pdo_fetchall($sql);
//$user=pdo_getall('yzqzk_sun_user',array('uniacid'=>$_W['uniacid'],'id !='=>$yuser));*/
$sql =" select id,name from ".tablename('yzqzk_sun_user')." where uniacid={$_W['uniacid']}  and id not in (select user_id  from" .tablename('yzqzk_sun_store')."where uniacid={$_W['uniacid']}) and  name like '%{$_GPC['keywords']}%'";  
$user=pdo_fetchall($sql);
...
global $_W, $_GPC;
$sql =" select DISTINCT cityname from ".tablename('yzqzk_sun_hotcity')." where uniacid={$_W['uniacid']}   and  cityname like '%{$_GPC['keywords']}%'";  
...
public function doMobileDeleteZxAssess(){
    global $_W, $_GPC;
    $res=pdo_delete('yzqzk_sun_zx_assess',array('id'=>$_GPC['id']));
    if($res){
...
public function doMobileTypeList(){
    global $_W, $_GPC;
    $type=pdo_getall('yzqzk_sun_type',array('uniacid'=>$_W['uniacid'],'state'=>1),array(),'','num asc');
    $type2=pdo_getall('yzqzk_sun_type2',array('uniacid'=>$_W['uniacid'],'state'=>1),array(),'','num asc');
...
public function doMobilePTypeInfo(){
    global $_W, $_GPC;
    $res=pdo_get('yzqzk_sun_type',array('uniacid' => $_W['uniacid'],'id'=>$_GPC['id']));
...
public function doMobileSavePType(){
    ...
    if($_GPC['id']==''){                
        $res=pdo_insert('yzqzk_sun_type',$data);        
    }else{
        $res = pdo_update('yzqzk_sun_type', $data, array('id' => $_GPC['id']));
    }
    if($res){
...
public function doMobileSTypeInfo(){
    global $_W, $_GPC;
    $res= pdo_get('yzqzk_sun_type2',array('uniacid' => $_W['uniacid'],'id'=>$_GPC['id']));
    return json_encode($res);
}
...
public  function doMobileQueryTag(){
    global $_W, $_GPC;
    $res=pdo_getall('yzqzk_sun_label',array('type2_id'=>$_GPC['type2_id']));
...
public function doMobileDelTag(){
    global $_W, $_GPC;
    $res=pdo_delete('yzqzk_sun_label',array('id'=>$_GPC['tag_id']));
    if($res){
        echo '1';
    }else{
        echo '2';
...
public function doMobileUpdTag(){
      global $_W, $_GPC;
    $res=pdo_update('yzqzk_sun_label',array('label_name'=>$_GPC['label_name']),array('id'=>$_GPC['tag_id']));
    if($res){
        echo '1';
    }else{
        echo '2';
