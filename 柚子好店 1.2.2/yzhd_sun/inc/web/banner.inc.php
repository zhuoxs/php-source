...
$info=pdo_get('yzhd_sun_banner',array('uniacid'=>$_W['uniacid']));
if($info['lb_imgs']){
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        $res=pdo_insert('yzhd_sun_banner',$data,array('uniacid'=>$_W['uniacid']));
        ...
        $res = pdo_update('yzhd_sun_banner', $data, array('id' => $_GPC['id'],'uniacid'=>$_W['uniacid']));
