...
Page({
    ...
    formSubmit: function(t) {
        var e = this, o = t.detail.formId, i = t.detail.value.uname, n = t.detail.value.phone, a = "", c = !0, s = e.data.goods, r = e.data.baby;
        if (null == r.id) a = "请选择汽车"; else if ("" == i) a = "请输入您的姓名"; else if (/^1(3|4|5|7|8)\d{9}$/.test(n)) {
            ...
            1 == s.qzk_status ? app.get_openid().then(function(t) {
                var a;
                app.util.request({
                    ...
                    data: (a = {
                        ...
                        name: i,
                        phone: n
                    }, _defineProperty(a, "baby_id", r.id), _defineProperty(a, "formId", o), a),
                    success: function(t) {
                ...
                app.util.request({
                    ...
                    data: (a = {
                        ...
                        name: i,
                        phone: n
                    }, _defineProperty(a, "baby_id", r.id), _defineProperty(a, "num", e.data.goodsNum), 
                                        ...
                                        wx.showModal({
                                            ...
                                            success: function(t) {
                                                t.confirm ? wx.redirectTo({
                                                    url: "/yzcyk_sun/pages/user/myorder/myorder"
                                                }) : wx.reLaunch({
    ...
    totalPrice: function() {
        ...
        }), console.log("总商品价格"), console.log(i);
    },
    get_coupon: function() {
        var a = this;
