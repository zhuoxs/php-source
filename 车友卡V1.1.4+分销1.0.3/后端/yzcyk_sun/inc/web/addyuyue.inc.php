...
$info=pdo_get('yzcyk_sun_goods',array('id'=>$_GPC['id']));
$spec=pdo_getall('yzcyk_sun_goods_spec');
$type=pdo_getall('yzcyk_sun_type',array('uniacid'=>$_W['uniacid'],'state'=>1));
...
if(checksubmit('submit')){
    ...
    if(empty($_GPC['id'])){
        ...
        $res = pdo_update('yzcyk_sun_goods', $data, array('id' => $_GPC['id']));
    }
    if($res){
