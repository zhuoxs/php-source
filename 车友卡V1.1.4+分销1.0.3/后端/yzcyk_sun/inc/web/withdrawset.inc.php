...
$item=pdo_get('yzcyk_sun_withdrawset',array('uniacid'=>$_W['uniacid']));
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        ...
        $res=pdo_insert('yzcyk_sun_withdrawset',$data);
        if($res){
        ...
        unset($data['ad_time']);
        $res = pdo_update('yzcyk_sun_withdrawset', $data, array('id' => $_GPC['id']));
        if($res){
