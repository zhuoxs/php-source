...
class Room_EweiShopV2Page extends PluginWebPage
{
    ...
    protected function post()
    {
        ...
        if ($_W["ispost"]) {
            ...
            $tabs = array("interaction" => array("name" => trim($_GPC["dtab"]["tabtitle"]), "isshow" => 1), "goods" => array("name" => trim($_GPC["dtab"]["goodstitle"]), "isshow" => $_GPC["dtab"]["goodstitleshow"] === "0" ? 0 : 1), "introduce" => array("name" => trim($_GPC["dtab"]["introducetitle"]), "isshow" => $_GPC["dtab"]["introducetitleshow"] === "0" ? 0 : 1), "customname1" => array("name" => trim($_GPC["dtab"]["customname1"]), "type" => trim($_GPC["dtab"]["customtype1"]), "url" => $_GPC["dtab"]["customurl1"], "introduce" => m("common")->html_images($_GPC["dtab"]["customintroduce1"]), "isshow" => in_array("customname1", $nestable) ? 1 : 0), "customname2" => array("name" => trim($_GPC["dtab"]["customname2"]), "type" => trim($_GPC["dtab"]["customtype2"]), "url" => $_GPC["dtab"]["customurl2"], "introduce" => m("common")->html_images($_GPC["dtab"]["customintroduce2"]), "isshow" => in_array("customname2", $nestable) ? 1 : 0), "customname3" => array("name" => trim($_GPC["dtab"]["customname3"]), "type" => trim($_GPC["dtab"]["customtype3"]), "url" => $_GPC["dtab"]["customurl3"], "introduce" => m("common")->html_images($_GPC["dtab"]["customintroduce3"]), "isshow" => in_array("customname3", $nestable) ? 1 : 0), "customname4" => array("name" => trim($_GPC["dtab"]["customname4"]), "type" => trim($_GPC["dtab"]["customtype4"]), "url" => $_GPC["dtab"]["customurl4"], "introduce" => m("common")->html_images($_GPC["dtab"]["customintroduce4"]), "isshow" => in_array("customname4", $nestable) ? 1 : 0));
