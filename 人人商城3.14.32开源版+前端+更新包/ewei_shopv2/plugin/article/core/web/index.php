...
class Index_EweiShopV2Page extends PluginWebPage
{
	...
	protected function post()
	{
		...
		if ($_W['ispost']) {
			...
			$data["resp_img"] = iserializer($resp_img);
			$advs = array();
		...
		if (!empty($article)) {
			...
			$article["resp_img"] = iunserializer($article["resp_img"]);
