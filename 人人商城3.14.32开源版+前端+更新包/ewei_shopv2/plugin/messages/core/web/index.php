    ...
    protected function post()
    {
        ...
        if ($_W["ispost"]) {
            ...
            if (intval($_GPC["sendlimittype"]) == 1) {
                ...
                if (intval($_GPC["sendlimittype"]) == 2) {
                    $data["send_openid"] = implode(",", $_GPC["send_openid2"]);
                } else {
                    if (intval($_GPC["sendlimittype"]) == 3) {
                        $data["send_level"] = intval($_GPC["send_level"]);
                    } else {
                        if (intval($_GPC["sendlimittype"]) == 4) {
    ...
    public function build()
    {
        ...
        if (!empty($item)) {
            ...
            if (intval($item["sendlimittype"]) == 1 || intval($item["sendlimittype"]) == 2) {
                ...
                if (intval($item["sendlimittype"]) == 3) {
                    ...
                    if (intval($item["sendlimittype"]) == 4) {
