...
if (!class_exists("SnsModel")) {
    class SnsModel extends PluginModel
    {
        ...
        public function sendMemberSnsUpgradeMessage($openid, $nickname, $oldlevel, $level)
        {
            ...
            $title = "社区等级升级";
            $message = array("first" => array("value" => "亲爱的" . $nickname . "，您的社区等级已升级", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => $title, "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的人人社区等级已升级成功", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
        ...
        public function sendReplyMessage($openid, $data)
        {
            ...
            $title = "您的话题有新的评论";
            $message = array("first" => array("value" => "您的话题有新的评论", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => $title, "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的话题有新的评论", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => $remark, "color" => "#000000"));
        ...
        public function check($member, $board, $isPost = false)
        {
            ...
            if ($plugin_commission) {
                ...
                if (!empty($board["notagent"]) && !$member["status"] && !$member["isagent"]) {
                    if ($_W["isajax"]) {
            ...
            if ($plugin_globonus) {
                ...
                if (!empty($board["notpartner"]) && !$member["partnerstatus"] && !$member["ispartner"]) {
                    if ($_W["isajax"]) {
