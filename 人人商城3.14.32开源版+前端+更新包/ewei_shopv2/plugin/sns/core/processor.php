...
class SnsProcessor extends PluginProcessor
{
    ...
    public function respond($obj = NULL)
    {
        ...
        if ($msgtype == "text" || $event == "click") {
            ...
            $r_img = $board["logo"];
            $r_img = tomedia($r_img);
            $news = array(array("title" => $r_title, "picurl" => $r_img, "description" => $r_desc, "url" => $_W["siteroot"] . "app/index.php?i=" . $_W["uniacid"] . "&c=entry&m=ewei_shopv2&do=mobile&r=sns.board&id=" . $board["id"]));
