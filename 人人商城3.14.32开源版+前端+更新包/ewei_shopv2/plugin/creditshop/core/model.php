    ...
    class CreditshopModel extends PluginModel
    {
        ...
        public function getGoods($id, $member, $optionid = 0, $num = 1)
        {
            ...
            if (empty($goods["canbuy"])) {
                ...
                if ($goods["canbuy"] && $num - 1 < $goods["chanceday"]) {
                ...
                if ($goods["canbuy"] && $num - 1 < $goods["usermaxbuy"]) {
            ...
            if ($log["status"] == 2) {
                if (!empty($type)) {
                    if ($log["status"] == 2) {
                        ...
                        $msg = array("first" => array("value" => "恭喜您，您中奖啦~", "color" => "#4a5077"), "keyword1" => array("title" => "业务类型", "value" => "【" . $shop["name"] . "】抽奖", "color" => "#4a5077"), "keyword2" => array("title" => "业务内容", "value" => "奖品" . $goods["title"], "color" => "#4a5077"), "keyword3" => array("title" => "处理结果", "value" => "已中奖", "color" => "#4a5077"), "keyword4" => array("title" => "操作时间", "value" => date("Y-m-d H:i", time()), "color" => "#4a5077"), "remark" => array("value" => $remark, "color" => "#4a5077"));
                        if (!empty($tm["award"])) {
                    ...
                    if ($log["dispatchstatus"] != 1) {
                        ...
                        $msg = array("first" => array("value" => "恭喜您，商品兑换成功~", "color" => "#4a5077"), "keyword1" => array("title" => "业务类型", "value" => "奖品名称" . $goods["title"], "color" => "#4a5077"), "keyword2" => array("title" => "业务内容", "value" => "消耗积分" . $credits, "color" => "#4a5077"), "keyword3" => array("title" => "处理结果", "value" => "剩余积分" . $credit, "color" => "#4a5077"), "keyword4" => array("title" => "操作时间", "value" => date("Y-m-d H:i", time()), "color" => "#4a5077"), "remark" => array("value" => $remark, "color" => "#4a5077"));
                ...
                if ($log["dispatchstatus"] == 1 || $log["dispatchstatus"] == -1) {
                    ...
                    $msg = array("first" => array("value" => "积分商城商品兑换成功~", "color" => "#4a5077"), "keyword1" => array("title" => "业务类型", "value" => "商品信息" . $goods["title"], "color" => "#4a5077"), "keyword2" => array("title" => "业务内容", "value" => "订单金额" . $credits, "color" => "#4a5077"), "keyword3" => array("title" => "处理结果", "value" => "兑换码" . $goods["isverify"] ? "已发放" : "物流配送", "color" => "#4a5077"), "keyword4" => array("title" => "操作时间", "value" => date("Y-m-d H:i", $log["createtime"]), "color" => "#4a5077"), "remark" => array("value" => $remark, "color" => "#4a5077"));
                ...
                if ($log["status"] == 3) {
                    ...
                    $remark = "";
                    $msg = array("first" => array("value" => "您的积分兑换奖品已发货~", "color" => "#4a5077"), "keyword1" => array("title" => "业务类型", "value" => "已发货 ", "color" => "#4a5077"), "keyword2" => array("title" => "业务内容", "value" => "商品详情" . $goods["title"], "color" => "#4a5077"), "keyword3" => array("title" => "处理结果", "value" => $info, "color" => "#4a5077"), "keyword4" => array("title" => "操作时间", "value" => date("Y-m-d H:i", time()), "color" => "#4a5077"), "remark" => array("value" => $remark, "color" => "#4a5077"));
                    if (!empty($tm["send"])) {
                    ...
                    $msg_saler = array("first" => array("value" => "用户奖品兑换成功~", "color" => "#4a5077"), "keyword1" => array("title" => "业务类型", "value" => "兑换成功 ", "color" => "#4a5077"), "keyword2" => array("title" => "业务内容", "value" => "商品信息" . $goods["title"], "color" => "#4a5077"), "keyword3" => array("title" => "处理结果", "value" => $info, "color" => "#4a5077"), "keyword4" => array("title" => "操作时间", "value" => date("Y-m-d H:i", time()), "color" => "#4a5077"), "remark" => array("value" => $remark, "color" => "#4a5077"));
                    if (!empty($tm["send"])) {
        ...
        public function allow($logid, $times = 0, $verifycode = "", $openid = "")
        {
            ...
            if (!empty($log["storeid"]) && !empty($saler["storeid"]) && $saler["storeid"] != $log["storeid"]) {
                return error(-1, "您无此门店的操作权限!");
            }
