...
class User_EweiShopV2Page extends MerchWebPage
{
    ...
    protected function post()
    {
        ...
        if (empty($item)) {
            $_W["accounttotal"] <= $total and $this->message("你最多添加" . $_W["accounttotal"] . "个操作员", "", "error");
        }
        if ($_W["ispost"]) {
