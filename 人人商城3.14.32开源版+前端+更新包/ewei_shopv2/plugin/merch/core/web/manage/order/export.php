...
class Export_EweiShopV2Page extends MerchWebPage
{
    ...
    public function main()
    {
        ...
        if ($_GPC["export"] == 1) {
            ...
            if ($address2index != -1) {
                array_splice($columns, $address2index + 1, 0, array(array("title" => "", "field" => "address_city", "width" => 12), array("title" => "", "field" => "address_area", "width" => 12), array("title" => "", "field" => "address_street", "width" => 12), array("title" => "", "field" => "address_address", "width" => 24)));
            }
            ...
            foreach ($list as &$value) {
                ...
                $m2 = false;
                $m3 = false;
                if (!empty($level) && !empty($value["agentid"])) {
