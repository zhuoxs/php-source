...
class Clearing_EweiShopV2Page extends PluginWebPage
{
    ...
    protected function post()
    {
        ...
        if ($_W["ispost"]) {
            if (!$id) {
                empty($merchid) and show_json(0, "没有选择联系人!");
            }
            $_GPC["goodsprice"] === "" and show_json(0, "订单商品总额不能为空!");
            $_GPC["dispatchprice"] === "" and show_json(0, "快递金额不能为空!");
            $_GPC["deductprice"] === "" and show_json(0, "积分抵扣金额不能为空!");
            $_GPC["deductcredit2"] === "" and show_json(0, "余额抵扣金额不能为空!");
            $_GPC["discountprice"] === "" and show_json(0, "会员折扣金额不能为空!");
            $_GPC["isdiscountprice"] === "" and show_json(0, "促销金额不能为空!");
            $_GPC["price"] === "" and show_json(0, "实际支付金额不能为空!");
            $_GPC["realprice"] === "" and show_json(0, "实际支付金额不能为空!");
            $_GPC["realpricerate"] === "" and show_json(0, "实际支付金额不能为空!");
            ...
            $data["realprice"] < $data["goodsprice"] + $data["dispatchprice"] ? $data["realprice"] : $data["realprice"];
            if ($data["status"] == 2) {
        ...
        if ($id) {
            ...
            empty($item) and $this->message("未找到该账单", "", "error");
