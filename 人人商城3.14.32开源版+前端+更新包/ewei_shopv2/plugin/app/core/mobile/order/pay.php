...
class Pay_EweiShopV2Page extends AppMobilePage
{
    ...
    public function main()
    {
        ...
        return app_json(array("order" => array("id" => $order["id"], "ordersn" => $order["ordersn"], "price" => $order["price"], "title" => $set["shop"]["name"] . "订单"), "credit" => $credit, "wechat" => $wechat, "alipay" => $alipay, "cash" => $cash));
    }
