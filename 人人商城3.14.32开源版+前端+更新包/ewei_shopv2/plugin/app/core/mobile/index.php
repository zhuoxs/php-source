...
class Index_EweiShopV2Page extends AppMobilePage
{
    ...
    public function wxAppSetting()
    {
        global $_W;
        global $_GPC;
        $ret["sysset"] = array("shopname" => $_W["shopset"]["shop"]["name"], "shoplogo" => tomedia($_W["shopset"]["shop"]["logo"]), "description" => $_W["shopset"]["shop"]["description"], "saleout_icon" => isset($_W["shopset"]["shop"]["saleout"]) ? tomedia($_W["shopset"]["shop"]["saleout"]) : "", "share" => $_W["shopset"]["share"], "texts" => array("credit" => $_W["shopset"]["trade"]["credittext"], "money" => $_W["shopset"]["trade"]["moneytext"]), "isclose" => $_W["shopset"]["app"]["isclose"], "force_auth" => isset($_W["shopset"]["app"]["force_auth"]) ? $_W["shopset"]["app"]["force_auth"] : 0);
