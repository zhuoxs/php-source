...
class Pay_EweiShopV2Page extends CashierMobilePage
{
    ...
    public function main()
    {
        ...
        if ($payment["is_new"] && ($payment["type"] == 2 || $payment["type"] == 3) && !empty($payment["sub_appsecret"])) {
    ...
    {
        global $_W;
        $params = array("out_trade_no" => $this->log["logno"], "seller_id" => "", "total_amount" => $this->log["money"], "subject" => $this->log["title"], "body" => (string) $_W["uniacid"] . ":2:" . $_W["cashierid"]);
