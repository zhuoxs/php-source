...
class CashierModel extends PluginModel 
{
	...
	public function sendMessage($params, $type, $openid = NULL) 
	{
		...
		switch ($type) 
		{
			...
			break;
			case self::CHECKED: $message = array( 'first' => array('value' => '收银台审核通知！', 'color' => '#ff0000'), 'keyword1' => array('title' => '联系人', 'value' => $params['name'], 'color' => '#ff0000'), 'keyword2' => array('title' => '联系电话', 'value' => $params['mobile'], 'color' => '#000000'), 'keyword3' => array('title' => '审核状态', 'value' => $params['status'], 'color' => '#000000'), 'keyword4' => array('title' => '审核时间', 'value' => $params['createtime'], 'color' => '#000000'), 'keyword5' => array('title' => '驳回原因', 'value' => $params['reason'], 'color' => '#000000') );
			$datas = array('[联系人]' => $params['name'], '[联系电话]' => $params['mobile'], '[审核状态]' => $params['status'], '[审核时间]' => $params['createtime'], '[驳回原因]' => $params['reason']);
			break;
			case self::APPLY_CLEARING: $message = array( 'first' => array('value' => '收银台申请结算通知！', 'color' => '#ff0000'), 'keyword1' => array('title' => '联系人', 'value' => $params['name'], 'color' => '#ff0000'), 'keyword2' => array('title' => '联系电话', 'value' => $params['mobile'], 'color' => '#000000'), 'keyword3' => array('title' => '申请时间', 'value' => $params['createtime'], 'color' => '#000000'), 'keyword4' => array('title' => '打款时间', 'value' => $params['paytime'], 'color' => '#000000'), 'keyword5' => array('title' => '申请金额', 'value' => $params['money'], 'color' => '#000000'), 'keyword6' => array('title' => '打款金额', 'value' => $params['realmoney'], 'color' => '#000000') );
			$datas = array('[联系人]' => $params['name'], '[联系电话]' => $params['mobile'], '[申请时间]' => $params['createtime'], '[申请金额]' => $params['money']);
			break;
			case self::PAY: $message = array( 'first' => array('value' => '收银台申请结算通知！', 'color' => '#ff0000'), 'keyword1' => array('title' => '联系人', 'value' => $params['name'], 'color' => '#ff0000'), 'keyword2' => array('title' => '联系电话', 'value' => $params['mobile'], 'color' => '#000000'), 'keyword3' => array('title' => '申请时间', 'value' => $params['createtime'], 'color' => '#000000'), 'keyword4' => array('title' => '打款时间', 'value' => $params['paytime'], 'color' => '#000000'), 'keyword5' => array('title' => '申请金额', 'value' => $params['money'], 'color' => '#000000'), 'keyword6' => array('title' => '打款金额', 'value' => $params['realmoney'], 'color' => '#000000') );
			...
			break;
			case self::PAY_CASHIER: $message = array( 'first' => array('value' => '收银台付款提醒！', 'color' => '#ff0000'), 'keyword1' => array('title' => '订单编号', 'value' => $params['logno'], 'color' => '#ff0000'), 'keyword2' => array('title' => '付款金额', 'value' => $params['money'], 'color' => '#000000'), 'keyword3' => array('title' => '余额抵扣', 'value' => $params['deduction'], 'color' => '#000000'), 'keyword4' => array('title' => '付款时间', 'value' => $params['paytime'], 'color' => '#000000'), 'keyword5' => array('title' => '收银台名称', 'value' => $params['cashier_title'], 'color' => '#000000') );
			$datas = array('[订单编号]' => $params['logno'], '[付款金额]' => $params['money'], '[余额抵扣]' => $params['deduction'], '[付款时间]' => $params['paytime'], '[收银台名称]' => $params['cashier_title']);
			break;
			case self::PAY_CASHIER_USER: $message = array( 'first' => array('value' => '收银台付款提醒！', 'color' => '#ff0000'), 'keyword1' => array('title' => '订单编号', 'value' => $params['logno'], 'color' => '#ff0000'), 'keyword2' => array('title' => '付款金额', 'value' => $params['money'], 'color' => '#000000'), 'keyword3' => array('title' => '余额抵扣', 'value' => $params['deduction'], 'color' => '#000000'), 'keyword4' => array('title' => '付款时间', 'value' => $params['paytime'], 'color' => '#000000'), 'keyword5' => array('title' => '收银台名称', 'value' => $params['cashier_title'], 'color' => '#000000') );
			$datas = array('[订单编号]' => $params['logno'], '[付款金额]' => $params['money'], '[余额抵扣]' => $params['deduction'], '[付款时间]' => $params['paytime'], '[收银台名称]' => $params['cashier_title']);
			break;
			default: break;
		}
			...
			if (!(empty($stocktype))) 
			{
				if (!(empty($g['optionid']))) 
				{
					...
					if (!(empty($option)) && ($option['stock'] != -1)) 
					{
						...
						if ($stock != -1) 
						{
							...
							{
								$msg = array( 'first' => array('value' => '您的商品库存已经不足' . $goodstotal . '，请及时补货！' . "\n", 'color' => '#ff0000'), 'keyword1' => array('title' => '任务名称', 'value' => '商品库存不足', 'color' => '#000000'), 'keyword2' => array('title' => '通知类型', 'value' => '请及时补货', 'color' => '#4b9528'), 'remark' => array('value' => '商品名称：' . $g['title'] . '-' . $option['title'], 'color' => '#000000') );
				...
				if (!(empty($g['goodstotal'])) && ($g['goodstotal'] != -1)) 
				{
					...
					if ($totalstock != -1) 
					{
						...
						{
							$msg = array( 'first' => array('value' => '您的商品库存已经不足' . $goodstotal . '，请及时补货！' . "\n", 'color' => '#ff0000'), 'keyword1' => array('title' => '任务名称', 'value' => '商品库存不足', 'color' => '#000000'), 'keyword2' => array('title' => '通知类型', 'value' => '请及时补货', 'color' => '#4b9528'), 'remark' => array('value' => '商品名称：' . $g['title'], 'color' => '#000000') );
							$this->sendNotice(array('openid' => $manageopenid, 'saler_stockwarn' => 'saler_stockwarn_template'), 'saler_stockwarn', $msg);
						}
					}
				}
