...
class Selecturl_EweiShopV2Page extends WebPage
{
    ...
    public function main()
    {
        ...
        if ($platform) {
          ...
          $allUrls[0]["list"][] = array('name' => '店铺入口', 'url_wxapp' => '/pages/changce/merch/index');
            $allUrls[0]['list'][] = array('name' => '店铺入驻', 'url' => mobileUrl('', NULL, $full), 'url_wxapp' => '/pages/changce/merch/apply');
        ...
        if (cv("open_messikefu.set.edit") && p("open_messikefu") && !$platform) {
            $allUrls[] = array("name" => m("plugin")->getName("open_messikefu"), "list" => array(array("name" => "万能客服", "url" => mobileUrl("open_messikefu", NULL, $full), "url_wxapp" => "")));
        }      
