...
class Group_EweiShopV2Page extends WebPage
{
    public function main()
    {
        ...
        $list = array(array("id" => "default", "groupname" => "无标签组", "membercount" => pdo_fetchcolumn("select count(id) from " . tablename("ewei_shop_member") . " where uniacid=:uniacid and groupid=0 limit 1", array(":uniacid" => $_W["uniacid"]))));
