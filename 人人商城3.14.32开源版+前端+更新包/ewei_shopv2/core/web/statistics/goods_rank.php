...
class Goods_rank_EweiShopV2Page extends WebPage
{
    public function main()
    {
        ...
        if ($_GPC["export"] == 1) {
            ...
            unset($row);
            m("excel")->export($list, array("title" => "商品销售报告-" . date("Y-m-d-H-i", time()), "columns" => array(array("title" => "商品名称", "field" => "title", "width" => 36), array("title" => "销售量", "field" => "ordercount", "width" => 12), array("title" => "维权订单量", "field" => "refundcount", "width" => 12), array("title" => "销售额", "field" => "money", "width" => 12), array("title" => "维权金额", "field" => "refundprice", "width" => 12))));
