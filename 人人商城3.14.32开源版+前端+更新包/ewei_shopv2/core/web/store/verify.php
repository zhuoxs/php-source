...
class Verify_EweiShopV2Page extends WebPage
{
    ...
    public function log()
    {
        ...
        if ($_GPC["export"] == 1) {
            ...
            $columns = array(array("title" => "记次时商品信息", "field" => "title", "width" => 34), array("title" => "订单号", "field" => "ordersn", "width" => 32), array("title" => "核销次数", "field" => "verifynum", "width" => 32), array("title" => "核销时间", "field" => "verifydate", "width" => 22), array("title" => "购买时间", "field" => "paytime", "width" => 20), array("title" => "购买人", "field" => "username", "width" => 15), array("title" => "手机号", "field" => "mobile", "width" => 15), array("title" => "核销人", "field" => "salername", "width" => 12), array("title" => "核销门店", "field" => "storename", "width" => 20), array("title" => "备注信息", "field" => "remarks", "width" => 45));
            $exportlist = array();
