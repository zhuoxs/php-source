...
var nearshop, a, e, i = getApp(), s = i.requirejs("core"), n = i.requirejs("wxParse/wxParse"), o = i.requirejs("biz/diypage"), r = i.requirejs("biz/diyform"), d = i.requirejs("biz/goodspicker"), c = (i.requirejs("foxui"), 
i.requirejs("jquery"));
...
Page((e = {
		 ...
		 wx.getLocation({
			 type: 'wgs84',
				success: function (res) {
				  i.setCache("mypos", {
					lat: res.latitude + 0.0044,  // 误差0.0044
					lng: res.longitude + 0.0104, // 误差0.0104			  
					speed: res.speed,
				  ...
				  a.setData({
					mypos: {
					  lat: res.latitude + 0.0044,  // 误差0.0044
					  lng: res.longitude + 0.0104, // 误差 0.0104				
					  speed: res.speed,
					  accuracy: res.accuracy
					}
				  });
	...
	getNearShop: function () {
		var b = this;
		var nearshop;
		console.log(this.data.mypos);
		s.get("shop/getNearShop", {
	...
	//---门店开始3---------------------
		...
		wx.getLocation({
		  ...
		  success: function (res) {
			i.setCache("mypos", {
			  lat: res.latitude + 0.0044,  
			  lng: res.longitude + 0.0104, 
			  speed: res.speed,
			  accuracy: res.accuracy
			}, 7200);
		   that.setData({
