...
Page({
    ...
    joinTeam: function(a) {
        ...
        if (o.setData({
            ...
            op: ""
        }), "ladder" == e) s = o.data.data.id, t.get("groups.goods.goodsCheck", {
            id: s,
            type: "group"
        }, function(a) {
            0 == a.error ? o.setData({
        ...
        }); else if (0 == o.data.data.more_spec) s = o.data.data.id, t.get("groups.goods.goodsCheck", {
            id: s,
            type: "group"
        }, function(a) {
    ...
    specsTap: function(a) {
        ...
        t.pdata(a).idx, d[n].item.forEach(function(a, t) {
