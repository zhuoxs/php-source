    ...
    getDetail: function(t) {
        ...
        e.setData({
            ...
            if (0 != t.error) return e.setData({
                show: !0,
                showgoods: !1
            }), i.toast(e, t.message), void setTimeout(function() {
                wx.navigateBack();
            }, 1500);
            [ "marketprice", "productprice" ].forEach(function(e) {
                void 0 !== t.goods[e] && (t.goods[e] = parseFloat(t.goods[e]));
            });
            var o = t.goods.coupons, n = (t.goods.thumbMaxHeight, t.goods.thumbMaxWidth, t.goods.goodscircle);
            if (e.setData({
                coupon: o,
                coupon_l: o.length,
            ...
            r = setInterval(function() {
                ...
                discountTitle: "活动已结束"
            }), t.goods.istime > 0 && (clearInterval(e.data.timer), r = setInterval(function() {
