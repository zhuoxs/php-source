var t = getApp(), a = t.requirejs("core"), e = t.requirejs("jquery"), i = t.requirejs("foxui");
...
Page({
    ...
    typeChange: function(t) {
        var a = t.detail.value, e = this.data.type_array[a].type;
        this.setData({
            applytype: e,
            applyIndex: a
        });
    ...
    inputChange: function(t) {
        var a = this.data.reg, i = t.currentTarget.dataset.type, s = e.trim(t.detail.value);
        a[i] = s, this.setData({
            reg: a
        });
    },
