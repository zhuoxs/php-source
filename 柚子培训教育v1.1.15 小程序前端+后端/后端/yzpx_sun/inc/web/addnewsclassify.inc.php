...
if($_GPC['id']){
    $info=pdo_get('yzpx_sun_newsclassify',array('id'=>$_GPC['id']));
...
if (checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        ...
        $res=pdo_insert('yzpx_sun_newsclassify',$data);
        if($res){
        ...
        $res=pdo_update('yzpx_sun_newsclassify',$data,array('id'=>$_GPC['id']));
        if($res){
