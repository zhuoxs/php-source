...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        ...
        $res=pdo_insert('yzpx_sun_we',$data,array('uniacid'=>$_W['uniacid']));
        ...
        $res = pdo_update('yzpx_sun_we', $data, array('id' => $_GPC['id']));
        if($res){
