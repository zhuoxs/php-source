...
$GLOBALS['frames'] = $this->getMainMenu();
	$info = pdo_get('ymmf_sun_yellowtype',array('uniacid' => $_W['uniacid'],'id'=>$_GPC['id']));
		if(checksubmit('submit')){
			...
			if($_GPC['id']==''){				
				$res=pdo_insert('ymmf_sun_yellowtype',$data);
				if($res){
				...
				$res = pdo_update('ymmf_sun_yellowtype', $data, array('id' => $_GPC['id']));
				if($res){
