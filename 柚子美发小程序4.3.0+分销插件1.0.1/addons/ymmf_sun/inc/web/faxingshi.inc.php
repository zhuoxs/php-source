...
$GLOBALS['frames'] = $this->getMainMenu();
 ...
 global $_W, $_GPC;
    $type=pdo_getall('ymmf_sun_hairers',array('uniacid'=>$_W['uniacid']),array(),'','id asc');
...
if($_GPC['op']=='delete'){
    $res=pdo_delete('ymmf_sun_hairers',array('id'=>$_GPC['id']));
    if($res){
...
if($_GPC['op']=='change'){
	 $res=pdo_update('ymmf_sun_hairers',array('state'=>$_GPC['state']),array('id'=>$_GPC['id']));
    if($res){
