...
$info=pdo_get('ymmf_sun_banner',array('uniacid'=>$_W['uniacid']));
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        $res=pdo_insert('ymmf_sun_banner',$data,array('uniacid'=>$_W['uniacid']));
        ...
        $res = pdo_update('ymmf_sun_banner', $data, array('id' => $_GPC['id'],'uniacid'=>$_W['uniacid']));
