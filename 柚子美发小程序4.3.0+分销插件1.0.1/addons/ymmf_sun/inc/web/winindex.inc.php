...
$info=pdo_get('ymmf_sun_winindex',array('uniacid'=>$_W['uniacid']));
if($info['img1']){
    $img1 = $info['img1'];
}
if($info['img2']){
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        $res=pdo_insert('ymmf_sun_winindex',$data,array('uniacid'=>$_W['uniacid']));
        ...
        $res = pdo_update('ymmf_sun_winindex', $data, array('id' => $_GPC['id'],'uniacid'=>$_W['uniacid']));
