...
Page({
    ...
    shareCanvas: function() {
        ...
        this.creatPoster("ymmf_sun/pages/index/index", 430, e, 8, "shareImg");
    },
    ...
    toFxCash: function(t) {
        wx.navigateTo({
            url: "/ymmf_sun/plugin/distribution/fxCash/fxCash"
        });
    },
    toFxWd: function(t) {
        wx.navigateTo({
            url: "/ymmf_sun/plugin/distribution/fxWithdraw/fxWithdraw"
        });
    },
    toFxOrder: function(t) {
        wx.navigateTo({
            url: "/ymmf_sun/plugin/distribution/fxOrder/fxOrder"
        });
    },
    toFxDetail: function(t) {
        wx.navigateTo({
            url: "/ymmf_sun/plugin/distribution/fxDetail/fxDetail"
        });
    },
    toFxTeam: function(t) {
        wx.navigateTo({
            url: "/ymmf_sun/plugin/distribution/fxTeam/fxTeam"
        });
    },
    toFxGoods: function(t) {
        wx.navigateTo({
            url: "/ymmf_sun/plugin/distribution/fxGoods/fxGoods"
        });
    }
});