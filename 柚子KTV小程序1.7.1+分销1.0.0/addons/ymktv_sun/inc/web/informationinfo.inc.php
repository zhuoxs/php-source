...
$info=pdo_get('ymktv_sun_information',array('id'=>$_GPC['id']));
//$type=pdo_get('ymktv_sun_type',array('id'=>$info['type_id']));
$type=pdo_getall('ymktv_sun_type',array('uniacid'=>$_W['uniacid'],'state'=>1),array(),'','num asc');
$type2=pdo_get('ymktv_sun_type2',array('id'=>$info['type2_id']));
