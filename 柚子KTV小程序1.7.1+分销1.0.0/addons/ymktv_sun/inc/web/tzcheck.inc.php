...
$item=pdo_get('ymktv_sun_money',array('uniacid'=>$_W['uniacid'],'id'=>$_GPC['id']));
if(checksubmit('submit')){           
    ...
    if($_GPC['id']==''){                
        $res=pdo_insert('ymktv_sun_money',$data);
        if($res){
        ...
        $res = pdo_update('ymktv_sun_money', $data, array('id' => $_GPC['id']));
        if($res){
