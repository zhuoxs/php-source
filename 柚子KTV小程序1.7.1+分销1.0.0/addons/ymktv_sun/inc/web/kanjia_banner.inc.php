...
$info=pdo_get('ymmf_sun_kanjia_banner',array('uniacid'=>$_W['uniacid']));
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        $res=pdo_insert('ymmf_sun_kanjia_banner',$data);
        if($res){
        ...
        $res = pdo_update('ymmf_sun_kanjia_banner', $data, array('id' => $_GPC['id']));
        if($res){
