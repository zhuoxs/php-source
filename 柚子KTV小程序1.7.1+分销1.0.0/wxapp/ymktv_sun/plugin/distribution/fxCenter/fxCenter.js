...
Page({
    ...
    shareCanvas: function() {
        ...
        this.creatPoster("ymktv_sun/pages/booking/index/index", 430, e, 8, "shareImg");
    },
    creatPoster: function(t, e, o, n, s) {
        var l = this, a = app.siteInfo.siteroot.split("/app/")[0] + "/attachment/", u = "", c = "", r = "", i = o.scene;
        wx.showLoading({
            title: "获取图片中..."
        });
        var d = o.uid ? o.uid : 0;
        app.util.request({
            ...
            success: function(i) {
                console.log("获取小程序二维码"), console.log(i), u = i.data.wxcode_pic, console.log("woshiceshi--------------------"), 
                console.log(u), console.log("woshiceshi--------------------"), c = i.data.blogo, 
                r = i.data.postertoptitle ? i.data.postertoptitle : o.title;
                var t = new Promise(function(e, t) {
                    wx.getImageInfo({
                        ...
                        fail: function(t) {
                            console.log("图片1保存失败"), e(c), console.log(t);
                        }
                    });
                ...
                Promise.all([ t, e ]).then(function(t) {
                    ...
                    var e = wx.createCanvasContext(s), o = r, n = t[0], a = t[1];
    ...
    drawText: function(t, e, o, n, a) {
        ...
        s += i[u];
        l.push(s);
        for (var c = 0; c < l.length; c++) a.fillText(l[c], e, o + 30 * (c + 1));
    },
    toFxCash: function(t) {
        wx.navigateTo({
            url: "/ymktv_sun/plugin/distribution/fxCash/fxCash"
        });
    },
    toFxWd: function(t) {
        wx.navigateTo({
            url: "/ymktv_sun/plugin/distribution/fxWithdraw/fxWithdraw"
        });
    },
    toFxOrder: function(t) {
        wx.navigateTo({
            url: "/ymktv_sun/plugin/distribution/fxOrder/fxOrder"
        });
    },
    toFxDetail: function(t) {
        wx.navigateTo({
            url: "/ymktv_sun/plugin/distribution/fxDetail/fxDetail"
        });
    },
    toFxTeam: function(t) {
        wx.navigateTo({
            url: "/ymktv_sun/plugin/distribution/fxTeam/fxTeam"
        });
    },
    toFxGoods: function(t) {
        wx.navigateTo({
            url: "/ymktv_sun/plugin/distribution/fxGoods/fxGoods"
        });
    }
});