var func = {
    ...
    creatPoster2: function(e, t, a, c, r) {
        console.log("-------------------");
        var s = getApp(), u = s, n = getCurrentPages(), f = n[n.length - 1], l = (f.__route__, 
        s.siteInfo.siteroot.split("/app/")[0] + "/attachment/"), g = "", i = (a.gid && a.gid, 
        a.scene), d = wx.getStorageSync("users");
        s.util.request({
            ...
            success: function(e) {
                wx.showLoading({
                    title: "获取图片中..."
                }), console.log("获取小程序二维码22"), console.log(e.data), g = e.data;
                ...
                Promise.all([ t, o, n, i ]).then(function(e) {
                    ...
                    var t = wx.createCanvasContext(r), n = a.bname, i = e[0], o = e[1], s = e[2], l = e[3];
                    ...
                    t.setFillStyle("#000"), u.Func.func.drawText(n, 65, 780, 600, t), t.drawImage(s, 85, 890, 70, 70), 
                    t.setFillStyle("#222"), t.setFontSize(28), t.fillText(d.name, 180, 910), t.setFillStyle("#e5bb03"), 
                    t.setFontSize(20), t.fillText("向您推荐", 180, 945), t.setFillStyle("#e9472c"), t.setFontSize(22), 
                    a.price && (2 == c && t.drawImage(a.br, 73, 985), t.fillText("￥", 73, 1073), t.setFillStyle("#e9472c"), 
