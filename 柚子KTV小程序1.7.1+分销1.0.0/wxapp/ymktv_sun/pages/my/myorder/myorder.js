...
Page({
    ...
    onShow: function() {
        var e = this, o = wx.getStorageSync("bid");
        console.log(o), wx.getStorage({
            key: "openid",
            success: function(t) {
                var a = t.data;
                app.util.request({
                    url: "entry/wxapp/OrderData",
                    cachetime: "0",
                    data: {
                        openid: a,
                        bid: o
    ...
    goDetails: function(t) {
        ...
        wx.navigateTo({
            url: "../../booking/bookingDetail/bookingDetail?id=" + a
        });
    },
    orderTab: function(t) {
