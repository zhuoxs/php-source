...
Page({
    ...
    attention: function(t) {
        var m = this, e = t.currentTarget.dataset.index, i = m.data.fans, a = wx.getStorageSync("openid"), n = i[e].fans_id;
        0 == i[e].isfollow ? i[e].isfollow = 1 : i[e].isfollow = 0, app.util.request({
