...
$.extend({
    Confirm: function(){
        var template = multiline(function(){/*!@preserve
            ...
            <div style="position:absolute;width:100%;height:100%;top:0;left:0;background:#000;opacity:0.2;filter: alpha(opacity=40);"></div>
        ...
        */console.log()});
        ...
        function multiline(fn){ //http://maoqqzs.cn
