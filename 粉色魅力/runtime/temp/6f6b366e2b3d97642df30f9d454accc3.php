<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:34:"template/RX03/html/user\login.html";i:1541384290;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <title>
      用户登录 - <?php echo $maccms['site_name']; ?>
    </title>
    <!-- Favicon Icon -->
  ...
  <body class="login-main-body">
            ...
            <div class="login-main-left">
              ...
              <form method="post" id="fm" action="">
                ...
                <div class="mt-4">
                  <div class="row">
                    <div class="col-12">
                      <input type="button" id="btn_submit" class="btn btn-outline-primary btn-block btn-lg" value="立即登录">
                    </div>
                  </div>
                </div>
              </form>
              ...
              <div class="owl-carousel owl-carousel-login">
                <div class="item">
                  <div class="carousel-login-card text-center">
                    <img src="<?php echo $maccms['path_tpl']; ?>html/style/images/recharge_loading_bg.png" width="75%" class="img-fluid"
                    alt="LOGO">
                    <h5 class="mt-5 mb-3">
                      ​海量美女主播视频免费看
                    </h5>
                ...
                <div class="item">
                  <div class="carousel-login-card text-center">
                    <img src="<?php echo $maccms['path_tpl']; ?>html/style/images/loading_empty.png" width="75%" class="img-fluid"
                    alt="LOGO">
                    <h5 class="mt-5 mb-3">
                      VIP专区视频更精彩
                    </h5>
    ...
    <script src="<?php echo $maccms['path_tpl']; ?>html/style/js/jquery.min.js">
    </script>
    <script src="<?php echo $maccms['path_tpl']; ?>html/style/js/bootstrap.bundle.min.js">
    </script>
    <!-- Core plugin JavaScript-->
    <script src="<?php echo $maccms['path_tpl']; ?>html/style/js/jquery.easing.min.js">
    </script>
    <!-- Owl Carousel -->
    <script src="<?php echo $maccms['path_tpl']; ?>html/style/js/owl.carousel.js">
    </script>
    <!-- Custom scripts for all pages-->
    <script src="<?php echo $maccms['path_tpl']; ?>html/style/js/custom.js">
    </script>
  </body>
</html>