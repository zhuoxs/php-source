<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:32:"template/RX03/html/vod\play.html";i:1565778148;s:66:"D:\phpStudy\PHPTutorial\WWW\template\RX03\html\public\include.html";i:1553153526;s:63:"D:\phpStudy\PHPTutorial\WWW\template\RX03\html\public\head.html";i:1563779151;s:63:"D:\phpStudy\PHPTutorial\WWW\template\RX03\html\public\left.html";i:1549128216;s:63:"D:\phpStudy\PHPTutorial\WWW\template\RX03\html\public\foot.html";i:1554795880;}*/ ?>
<!DOCTYPE html>
<html lang="en">
 <head> 
  <meta charset="utf-8" /> 
...
.mac_pop,.mac_pop_msg { z-index:99999; display: none; min-height: 20px; max-height: 750px; position: fixed;  top: 0;  left: 0;  bottom: 0;  right: 0;  margin: auto;  padding: 25px;  z-index: 130;  border-radius: 8px;  background-color: #fff;  box-shadow: 0 3px 18px rgba(0, 0, 0, .5);}
...
.gbook_content {width: 100% !important;border: 1px #E5E5E5 solid;border-radius：: 2px;padding: 10px 10px 0;}
...
.mac_login .mac_login_form .login_form_group input{padding:4px 10px 4px 36px;width:100%;height:38px;line-height:38px;border:1px solid #cacaca;box-sizing:border-box;display: block;border-color: #dcdfdf;border-radius: 2px;}
...
.mac_login .mac_login_form .login_form_group .mac_verify_img{margin-top: -39px;height: 39px;}
...
.mac_login .mac_login_form .login_form_link a{font-size:12px;color:#333;margin-left:15px}
.mac_login .mac_login_form input.login_form_submit{background: #ff516b;background: -moz-linear-gradient(-45deg, #ff516b 0%, #826cfd 100%);background: -webkit-linear-gradient(-45deg, #ff516b 0%,#826cfd 100%);background: linear-gradient(135deg, #ff516b 0%,#826cfd 100%);;color:#fff;font-size:14px;line-height:normal;border-radius:.1875rem;cursor:pointer;text-align:center;padding:0}
   
@media (max-width: 767px){.mac_pop{width:95% !important;}.remaining-w.fr{float:initial;}.mac_login{padding: 30px 0;}}
       ...
       <div class="col-md-9"> 
        <div class="single-video-left"> 
         ...
         <div class="single-video-title box mb-3"> 
          <h2><a><?php echo $obj['vod_name']; ?></a></h2> 
          <p class="mb-0"><i class="fas fa-eye"></i> <span class="mac_hits hits" data-mid="<?php echo $maccms['mid']; ?>" data-id="<?php echo $obj['vod_id']; ?>" data-type="hits"></span> views</p> 
         </div> 
         <div class="single-video-author box mb-3"> 
          <div class="float-right">
           <a href="javascript:;" class="btn btn-outline-danger mac_ulog" data-type="2" data-mid="<?php echo $maccms['mid']; ?>" data-id="<?php echo $obj['vod_id']; ?>"> <strong><i class="fas fa-star"></i></strong>收藏</a>
          </div> 
          <img class="float-left img-fluid" src="<?php echo mac_url_img($obj['vod_pic']); ?>" alt="" /> 
          <p>所属分类:<a href="<?php echo mac_url_type($obj); ?>"><strong><?php echo $obj['type']['type_name']; ?></strong></a> <span title="" data-placement="top" data-toggle="tooltip" data-original-title="精品认证"><i class="fas fa-check-circle text-success"></i></span></p> 
         ...
         <div class="single-video-info-content box mb-3" id="playlist_<?php echo $key; ?>"> 
          ...
          <p class="tags mb-0"> 
		   ...
		   <?php endforeach; endif; else: echo "" ;endif; ?>
		   <span><a style="width: 55px;margin-top: 5px;text-align:center;background: #f7647f none repeat scroll 0 0;" href="javascript:;" id="chapter_more_button_<?php echo $key; ?>">展开</a></span>
		  </p> 
         </div>
           ...
           <div class="col-xl-3 col-sm-6 mb-3"> 
            <div class="video-card"> 
             <div class="video-card-image"> 
              <a class="play-icon" href="<?php echo mac_url_vod_play($vo); ?>"><i class="fas fa-play-circle"></i></a> 
              <a href="<?php echo mac_url_vod_play($vo); ?>"> <img class="img-fluid lazy" src="<?php echo mac_url_img($vo['vod_pic']); ?>" alt="<?php echo $vo['type']['type_name']; ?>" data-original="<?php echo mac_url_img($vo['vod_pic']); ?>" /> </a> 
              <div class="time">
         ...
         <div class="row"> 
          ...
          <div class="col-md-12"> 
           ...
           <div class="video-card video-card-list"> 
            <div class="video-card-image"> 
             <a class="play-icon" href="<?php echo mac_url_vod_play($vo); ?>"><i class="fas fa-play-circle"></i></a> 
             <a href="<?php echo mac_url_vod_play($vo); ?>"> <img class="img-fluid lazy1" style="max-height: 100%;width: auto;height: 100%" src="<?php echo mac_url_img($vo['vod_pic']); ?>" alt="<?php echo $vo['type']['type_name']; ?>" data-original="<?php echo mac_url_img($vo['vod_pic']); ?>" /> </a> 
            </div> 
            <div class="video-card-body"> 
             <div class="video-title"> 
              <a href="<?php echo mac_url_vod_play($vo); ?>"><?php echo $vo['vod_name']; ?></a> 
             ...
             <div class="video-view"> 
              <i class="fas fa-fire" style="color: red"></i> <?php echo $vo['vod_hits']; ?> 次观看   
             </div> 
            </div> 
           </div> 
		   <?php endforeach; endif; else: echo "" ;endif; ?> 
