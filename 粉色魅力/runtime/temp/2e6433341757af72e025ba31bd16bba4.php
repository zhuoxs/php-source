...
<style>.table.table-sm .div-pc {display: table-row-group;vertical-align: middle;border-color: inherit;}.table.table-sm ul {padding-left: 0;display: table-row;vertical-align: inherit;border-color: inherit;}.ui-slide-block li {float: left;border-bottom: 1px solid #dee2e6;list-style-type: none;width: 25%;padding: .3rem;overflow: hidden; text-overflow: ellipsis; white-space: nowrap;}.ui-slide-block-pc li,.ui-slide-block-pc-down li,.ui-slide-block-pc-down2 li{width: 120px;font-size: 14px;line-height: 25px !important;padding: .3rem;vertical-align: top;float: left;border-bottom: 1px solid #dee2e6;list-style-type: none;overflow: hidden; text-overflow: ellipsis; white-space: nowrap;}@media (max-width: 768px){body.sidebar-toggled #block-slide{display: block !important}.navbar-brand{width:8rem;margin-right: 0rem!important;}.table.table-sm ul{display:block;overflow:hidden;}}</style>
  ...
  <style>
		...
		.single-video-left nav {
			margin-bottom: 30px !important;
		}
		
		.single-video-left nav .page-item {
			width: 50%;
			text-align: center;
		}
		
		.single-video-left nav .page-item .page-link {
			display: initial;
			color: #333 !important;
       ...
       <div class="col-md-9"> 
        <div class="single-video-left"> 
         <div class="single-video-title box mb-3"> 
          <h2 style="text-align: center;"><a><?php echo $obj['art_name']; ?> - <?php echo $obj['art_page_list'][$param['page']]['title']; ?></a></h2> 
          <p class="mb-0"> </p>
          <div class="row"> 
           <span class="col-md-11"> <span class="float-left"><i class="fas fa-eye"></i> <span class="mac_hits hits" data-mid="<?php echo $maccms['mid']; ?>" data-id="<?php echo $obj['art_id']; ?>" data-type="hits"></span> views </span> <span class="float-left" style="margin-left: 10px">所属分类:<a href="<?php echo mac_url_type($obj['type']); ?>"><strong><?php echo $obj['type']['type_name']; ?></strong></a> <span title="" data-placement="top" data-toggle="tooltip" data-original-title="精品认证"><i class="fas fa-check-circle text-success"></i></span></span><br/><small>作者：<?php echo $obj['art_remarks']; ?>&nbsp;&nbsp;&nbsp;发布于 <?php echo mac_day($obj['art_time']); ?></small> </span> 
         ...
         <div class="single-video-info-content box mb-3"> 
		  ...
		  <nav aria-label="Page navigation example"> 
		   <ul class="pagination justify-content-center pagination-sm mb-0"> 
			<?php if($__PAGING__['record_total'] > 0): if($__PAGING__['page_current'] == 1): ?>
				<li class="page-item"><a class="page-link" href="<?php echo mac_url_type($obj['type']); ?>" title="上一页：返回小说列表">上一页：返回小说列表</a></li>
				<?php else: ?>
				<li class="page-item"><a class="page-link" href="<?php echo mac_url_page($__PAGING__['page_url'],$__PAGING__['page_prev']); ?>" title="<?php echo $obj['art_page_list'][($param['page']-1)]['title']; ?>">上一页：<?php echo $obj['art_page_list'][($param['page']-1)]['title']; ?></a></li>
				<?php endif; if($__PAGING__['page_current'] == $__PAGING__['page_total']): ?>
				<li class="page-item"><a class="page-link" href="<?php echo mac_url_type($obj['type']); ?>" title="下一页：返回小说列表">下一页：返回小说列表</a></li>
				<?php else: ?>
				<li class="page-item"><a class="page-link" href="<?php echo mac_url_page($__PAGING__['page_url'],$__PAGING__['page_next']); ?>" title="<?php echo $obj['art_page_list'][($param['page']+1)]['title']; ?>">下一页：<?php echo $obj['art_page_list'][($param['page']+1)]['title']; ?></a></li>
				<?php endif; endif; ?>
		   </ul> 
		  </nav> 
            ...
            <div class="video-card"> 
             ...
             <div class="video-card-body"> 
              <div class="video-title"> 
			   ...
			   <a style="float:right;" target="_blank" href="<?php echo mac_url_vod_play($vo); ?>">作者：<?php echo $vo['art_remarks']; ?></a>
              </div> 
        ...
        <div class="single-video-right"> 
         <div class="row"> 
          <div class="col-md-12"> 
           ...
           <div class="main-title"> 
            <h6><?php echo $obj['type']['type_name']; ?>热门小说</h6> 
           </div> 
          </div> 
          <div class="col-md-12"> 
           ...
           <div class="video-card video-card-list"> 
            ...
            <div class="video-card-body"> 
			 ...
			 <div class="video-author"> 
              <a href="<?php echo mac_url_art_detail($vo); ?>">作者：<?php echo $vo['art_remarks']; ?></a> 
             </div> 
             <div class="video-page text-success">
               <?php echo $vo['type']['type_name']; ?> 
