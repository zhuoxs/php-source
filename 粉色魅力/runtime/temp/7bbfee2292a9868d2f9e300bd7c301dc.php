  ...
  <div id="wrapper"> 
   ...
   <div id="content-wrapper"> 
    <div class="container-fluid pb-0"> 
        ...
        <div class="owl-carousel owl-carousel-category"> 
         ...
         <div class="item"> 
          <div class="category-item"> 
           <a href="<?php echo mac_url_topic_detail($vo); ?>"> <img class="img-fluid" src="<?php echo $vo['topic_pic']; ?>" alt="<?php echo $vo['topic_name']; ?>" /> <h6><?php echo $vo['topic_name']; ?></h6> </a> 
          </div> 
         </div> 
		 <?php endforeach; endif; else: echo "" ;endif; ?> 
        </div>
		<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel"> 
		 ...
		 <div class="carousel-inner"> 
		  ...
		  <div class="carousel-item"> 
		   <a href="<?php echo mac_url_vod_play($vo); ?>"> <img class="d-block w-100" data-src="<?php echo $vo['vod_pic_slide']; ?>" alt="<?php echo $vo['vod_name']; ?>" src="<?php echo $vo['vod_pic_slide']; ?>" data-holder-rendered="true" /> </a> 
		  </div>
		  <?php endforeach; endif; else: echo "" ;endif; ?> 
		 </div> 
       ...
       <div class="col-xl-3 col-sm-6 mb-3"> 
        <div class="video-card"> 
         <div class="video-card-image"> 
          ...
          <a href="<?php echo mac_url_vod_play($vo); ?>"> <img class="img-fluid lazy1" src="<?php echo mac_url_img($vo['vod_pic']); ?>" alt="<?php echo $vo['vod_name']; ?>" data-original="<?php echo mac_url_img($vo['vod_pic']); ?>" /> </a> 
          <div class="time">
         ...
         <div class="video-card-body"> 
          ...
          <div class="video-page text-success"> 
           ...
           <a title="" data-placement="top" data-toggle="tooltip" data-original-title="精选"><i class="fas fa-check-circle text-success"></i></a> 
          </div> 
      ...
      <div class="row"> 
       ...
       <div class="col-xl-3 col-sm-6 mb-3"> 
        <div class="video-card"> 
         <div class="video-card-image"> 
          <a class="play-icon" href="<?php echo mac_url_vod_play($vo); ?>"><i class="fas fa-play-circle"></i></a> 
          <a href="<?php echo mac_url_vod_play($vo); ?>"> <img class="img-fluid lazy" src="<?php echo mac_url_img($vo['vod_pic']); ?>" alt="<?php echo $vo['vod_name']; ?>" data-original="<?php echo mac_url_img($vo['vod_pic']); ?>" /> </a> 
          <div class="time">
           <?php echo $vo['type']['type_name']; ?>
          </div> 
         </div> 
	 ...
	 <?php $__TAG__ = '{"order":"asc","by":"sort","ids":"1,2,3","id":"vo1","key":"key1"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key1 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($key1 % 2 );++$key1;?>
     <hr class="mt-0" /> 
     <div class="video-block section-padding"> 
      <div class="row"> 
       <div class="col-md-12"> 
	   ...
	   <?php $__TAG__ = '{"num":"4","order":"desc","by":"time","key":"key2","id":"vo2","type":"'.$vo1['type_id'].'"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key2 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($key2 % 2 );++$key2;?>
       <div class="col-xl-3 col-sm-6 mb-3"> 
        <div class="video-card"> 
         <div class="video-card-image"> 
          <a class="play-icon" href="<?php echo mac_url_vod_play($vo2); ?>"><i class="fas fa-play-circle"></i></a> 
          <a href="<?php echo mac_url_vod_play($vo2); ?>"> <img class="img-fluid lazy" src="<?php echo mac_url_img($vo2['vod_pic']); ?>" alt="<?php echo $vo2['vod_name']; ?>" data-original="<?php echo mac_url_img($vo2['vod_pic']); ?>" /> </a> 
          <div class="time">
           <?php echo $vo2['type']['type_name']; ?>
          </div> 
         </div> 
         <div class="video-card-body"> 
          <div class="video-title"> 
           <a href="<?php echo mac_url_vod_play($vo2); ?>"><?php echo $vo2['vod_name']; ?></a> 
          </div> 
          <div class="video-page text-success"> 
           <a href="<?php echo mac_url_type($vo2['type']); ?>"><?php echo $vo2['type']['type_name']; ?></a> 
           <a title="" data-placement="top" data-toggle="tooltip" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></a> 
          </div> 
          <div class="video-view">
            <?php echo $vo2['vod_hits']; ?> 次观看  
           <i class="fas fa-calendar-alt"></i> <?php echo mac_day($vo2['vod_time']); ?> 
          </div> 
         </div> 
        </div> 
       </div>
     ...
     <div class="video-block section-padding"> 
      <div class="row"> 
	   ...
	   <?php $__TAG__ = '{"num":"8","order":"desc","by":"time","type":"8","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
       <div class="col-xl-3 col-sm-6 mb-3"> 
        <div class="video-card"> 
         <div class="video-card-image"> 
          <a class="play-icon" href="<?php echo mac_url_vod_play($vo); ?>"><i class="fas fa-play-circle"></i></a> 
     ...
     <div class="video-block section-padding"> 
      <div class="row"> 
       ...
       <div class="col-xl-12 col-sm-12 mb-3" style="padding: 0;"> 
        <div class="link"> 
         <ul class="link-ul" style="padding-left: 0;"> 
          <?php $__TAG__ = '{"order":"desc","by":"sort","type":"all","id":"vo","key":"key"}';$__LIST__ = model("Link")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
          <li class="col-xl-1 col-sm-4 mb-2"> 
           <a href="<?php echo $vo['link_url']; ?>"><?php echo $vo['link_name']; ?></a> 
          </li> 
          <?php endforeach; endif; else: echo "" ;endif; ?>
         </ul> 
        </div> 
