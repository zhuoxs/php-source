    ...
    <div class="container-fluid"> 
     <div class="video-block section-padding"> 
      <div class="row"> 
	   ...
	   <?php $__TAG__ = '{"num":"12","paging":"yes","pageurl":"art\/type","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Art")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
       <div class="col-xl-3 col-sm-6 mb-3"> 
        <div class="video-card"> 
         <div class="video-card-image"> 
          <a target="_blank" class="play-icon" href="<?php echo mac_url_art_detail($vo); ?>"><i class="fas fa-play-circle"></i></a> 
          <a target="_blank" href="<?php echo mac_url_art_detail($vo); ?>"> <img class="img-fluid lazy1" src="<?php echo mac_url_img($vo['art_pic']); ?>" alt="<?php echo $vo['art_name']; ?>" data-original="<?php echo mac_url_img($vo['art_pic']); ?>" /> </a> 
          <div class="time">
         ...
         <div class="video-card-body"> 
          <div class="video-title"> 
           <a target="_blank" href="<?php echo mac_url_art_detail($vo); ?>"><?php echo $vo['art_name']; ?></a> 
		   <a style="float:right;" target="_blank" href="<?php echo mac_url_vod_play($vo); ?>">作者：<?php echo $vo['art_remarks']; ?></a>
          </div> 
          <div class="video-page text-success">
            <?php echo $vo['type']['type_name']; ?>  
           <a title="" data-placement="top" data-toggle="tooltip" href="<?php echo mac_url_art_detail($vo); ?>" data-original-title="精选内容"><i class="fas fa-check-circle text-success"></i></a> 
          </div> 
