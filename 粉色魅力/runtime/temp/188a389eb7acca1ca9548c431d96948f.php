...
<html lang="en">
 <head> 
  ...
  <title>热门写真 美女写真视频 - <?php echo $maccms['site_name']; ?></title> 
  <meta name="description" content="<?php if($param['by'] == 'time_add' || $param['by'] == 'hits'): ?><?php echo $maccms['site_description']; else: ?> <?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?> 搜索结果<?php endif; ?>" /> 
  <meta name="keywords" content="<?php if($param['by'] == 'time_add' || $param['by'] == 'hits'): ?><?php echo $maccms['site_keywords']; else: ?> <?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?> 搜索结果<?php endif; ?>" /> 
      ...
      <div class="row"> 
       <div class="col-md-12"> 
        <div class="main-title"> 
         <h6><?php if($param['by'] == 'time_add'): ?>最近更新<?php elseif($param['by'] == 'hits'): ?>最受欢迎<?php else: ?> <?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?> 搜索结果<?php endif; ?></h6> 
        </div> 
       </div> 
	   <?php $__TAG__ = '{"num":"12","paging":"yes","pageurl":"vod\/search","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
        ...
        <div class="video-card"> 
         ...
         <div class="video-card-body"> 
          ...
          <div class="video-page text-success"> 
           <a href="<?php echo mac_url_type($vo['type']); ?>" data-original-title="精选内容"> <?php echo $vo['type']['type_name']; ?> </a>
