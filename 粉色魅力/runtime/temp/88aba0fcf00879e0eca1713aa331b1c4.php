<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:36:"template/RX03/html/user\upgrade.html";i:1551424144;s:64:"D:\phpStudy\PHPTutorial\WWW\template\RX03\html\user\include.html";i:1553153546;s:61:"D:\phpStudy\PHPTutorial\WWW\template\RX03\html\user\head.html";i:1553071466;s:61:"D:\phpStudy\PHPTutorial\WWW\template\RX03\html\user\menu.html";i:1551366038;s:61:"D:\phpStudy\PHPTutorial\WWW\template\RX03\html\user\foot.html";i:1554795970;}*/ ?>
<!DOCTYPE html>
<html>
 <head> 
  <meta charset="UTF-8" /> 
  ...
  <title>升级会员组 - 个人中心 - <?php echo $maccms['site_name']; ?></title> 
    ...
    <li class="fed-padding-x fed-part-rows"> <a class="fed-rims-info fed-btns-info fed-btns-green fed-col-xs12" href="<?php echo mac_url('user/logout'); ?>">退出</a> </li> 
     ...
     <div class="fed-main-right fed-col-xs12 fed-col-md8 fed-col-lg9"> 
      <div class="fed-part-layout fed-back-whits"> 
       ...
       <form class="fed-user-form fed-user-info fed-part-rows" action="<?php echo mac_url('user/upgrade'); ?>"> 
        <ul class="fed-user-list fed-part-rows fed-back-whits"> 
         <li class="fed-padding-x fed-part-rows fed-line-bottom"> 
          <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
           ...
           <span class="fed-col-xs6 fed-col-sm6 fed-part-eone"><?php echo $obj['group']['group_name']; ?></span> 
         ...
         <li class="fed-padding-x fed-part-rows fed-line-bottom"> 
          <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
           ...
           <span class="fed-col-xs2 fed-col-sm3 fed-part-eone fed-text-right"><i class="fed-icon-font fed-icon-you"></i></span> 
          </div> </li> <?php if(is_array($group_list) || $group_list instanceof \think\Collection || $group_list instanceof \think\Paginator): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['group_id'] > 2): ?> 
         <li class="fed-padding-x fed-part-rows fed-line-bottom"> 
          <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
           <span class="fed-col-xs4 fed-col-sm3 fed-part-eone"><?php echo $vo['group_name']; ?></span> 
           <a class="fed-subm-group fed-col-xs6 fed-col-sm6 fed-part-eone grade" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_day']; ?>" data-long="day">包天：<?php echo $vo['group_points_day']; ?>积分</a> 
           <span class="fed-col-xs2 fed-col-sm3 fed-part-eone fed-text-right"><i class="fed-icon-font fed-icon-you"></i></span> 
          </div> </li> 
         <li class="fed-padding-x fed-part-rows fed-line-bottom"> 
          <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
           <span class="fed-col-xs4 fed-col-sm3 fed-part-eone"><?php echo $vo['group_name']; ?></span> 
           <a class="fed-subm-group fed-col-xs6 fed-col-sm6 fed-part-eone grade" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_week']; ?>" data-long="week">包周：<?php echo $vo['group_points_week']; ?>积分</a> 
           <span class="fed-col-xs2 fed-col-sm3 fed-part-eone fed-text-right"><i class="fed-icon-font fed-icon-you"></i></span> 
          </div> </li> 
         <li class="fed-padding-x fed-part-rows fed-line-bottom"> 
          <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
           <span class="fed-col-xs4 fed-col-sm3 fed-part-eone"><?php echo $vo['group_name']; ?></span> 
           <a class="fed-subm-group fed-col-xs6 fed-col-sm6 fed-part-eone grade" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_month']; ?>" data-long="month">包月：<?php echo $vo['group_points_month']; ?>积分</a> 
           <span class="fed-col-xs2 fed-col-sm3 fed-part-eone fed-text-right"><i class="fed-icon-font fed-icon-you"></i></span> 
          </div> </li> 
         <li class="fed-padding-x fed-part-rows fed-line-bottom"> 
          <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
           <span class="fed-col-xs4 fed-col-sm3 fed-part-eone"><?php echo $vo['group_name']; ?></span> 
           <a class="fed-subm-group fed-col-xs6 fed-col-sm6 fed-part-eone grade" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_year']; ?>" data-long="year">包年：<?php echo $vo['group_points_year']; ?>积分</a> 
           <span class="fed-col-xs2 fed-col-sm3 fed-part-eone fed-text-right"><i class="fed-icon-font fed-icon-you"></i></span> 
