<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:32:"template/RX03/html/user/reg.html";i:1541384258;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
          ...
          <div class="col-md-5 p-5 bg-white full-height">
            <div class="login-main-left">
              <div class="text-center mb-5 login-main-left-header pt-4">
                <img src="<?php echo $maccms['path_tpl']; ?>html/style/images/favicon.png" class="img-fluid" alt="LOGO">
                <h5 class="mt-3 mb-3">欢迎注册</h5>
                <p>海量高清美女主播视频免费在线观看</p>
              </div>
              <form method="post" id="fm" action="">
                <div class="form-group">
                  <label>账号</label>
                  <input type="text" id="user_name" name="user_name" class="form-control" placeholder="请输入您的登录账号" required autofocus></div>
                <div class="form-group">
                  <label>密码</label>
                  <input type="password" id="user_pwd" name="user_pwd" class="form-control" placeholder="请输入您的登录密码" required></div>
                <div class="form-group">
                  <label>确认密码</label>
                  <input type="password" id="user_pwd2" name="user_pwd2" class="form-control" placeholder="请输入您的确认密码" required></div>
				...
				<?php endif; ?>
                <div class="mt-4">
                  <input type="button" id="btn_submit" class="btn btn-outline-primary btn-block btn-lg" value="立即注册"></div>
              </form>
              <div class="text-center mt-5">
                <p class="light-gray">已经有账户?
                  <a href="<?php echo url('user/login'); ?>">登录</a></p>
              </div>
            </div>
          </div>
              ...
              <div class="owl-carousel owl-carousel-login">
                <div class="item">
                  <div class="carousel-login-card text-center">
                    <img src="<?php echo $maccms['path_tpl']; ?>html/style/images/recharge_loading_bg.png" width="75%" class="img-fluid" alt="LOGO">
                    <h5 class="mt-5 mb-3">​海量美女主播视频免费看</h5>
                    <p class="mb-4">魅力社拥有超过20000部美女主播视频
                      <br>高速在线播放看个过瘾</p></div>
                </div>
                <div class="item">
                  <div class="carousel-login-card text-center">
                    <img src="<?php echo $maccms['path_tpl']; ?>html/style/images/loading_empty.png" width="75%" class="img-fluid" alt="LOGO">
                    <h5 class="mt-5 mb-3">VIP专区视频更精彩</h5>
                    <p class="mb-4">VIP会员专区拥有更加优质精彩的内容,无需下载，超多美女视频一触即发
                      <br></p></div>
                </div>
              </div>
            </div>
