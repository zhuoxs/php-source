...
<html lang="en">
 <head> 
  ...
  <meta name="description" content="<?php echo $obj['topic_des']; ?>" /> 
  <meta name="keywords" content="<?php echo $obj['topic_key']; ?>" /> 
