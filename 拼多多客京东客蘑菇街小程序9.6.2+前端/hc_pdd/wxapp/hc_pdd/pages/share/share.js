...
Page({
    ...
    onLoad: function(a) {
        ...
        console.log(e);
        var d = a.user_id, s = a.goods_id, i = a.itemUrl, r = a.skuId, n = a.parameter, l = a.materialUrl, u = app.globalData.couponUrl;
        d = null != d ? a.user_id : app.globalData.user_id;
    ...
    onShareAppMessage: function(a) {
        var t = this, o = t.data.goods.goods_thumbnail_url, e = t.data.goods.goods_name, d = t.data.goods.goods_title, s = t.data.goods_id, i = t.data.itemUrl, r = t.data.skuId, n = t.data.parameter, l = t.data.materialUrl, u = t.data.couponUrl;
        if (t.setData({
            goods_src: o,
            goods_name: e,
            goods_title: d
        }), 0 == n) var c = "hc_pdd/pages/details/details?goods_id=" + s + "&parameter=" + n + "&user_id=" + app.globalData.user_id; else if (1 == n) c = "hc_pdd/pages/details/details?itemUrl=" + i + "&parameter=" + n + "&user_id=" + app.globalData.user_id; else if (2 == n) c = "hc_pdd/pages/details/details?skuId=" + r + "&parameter=" + n + "&materialUrl=" + l + "&couponUrl=" + u + "&user_id=" + app.globalData.user_id;
        return {
