...
<body class="index_body">
	...
	<!--头部余额内容-->
	<div class="index_ye">
		<p class="index_ztsy">昨天收入</p>
		<p class="index_ztsy_dd"><?php echo (floatval($total_price["today"])); ?>.00元</p>
		<a class="index_tssy" href="	/index.php/Home/Public/share">提升收益</a>
		
		<div class="index_zhyehsy">
			<p class="index_syyys">我的余额：<?php echo ($data["price"]); ?>0元</p>
			<p class="index_syyys">累计收益：<?php echo (floatval($total_price["all"])); ?>元</p>
		</div>
	</div>
	...
	<div class="index_rwalb">
		<p class="index_rw_tjrw">推荐任务 <span>更多></span> </p>
			...
			<li>
				...
				<div class="index_rw_xqqs">
					...
					<div class="index_rw_log">
						<img src="/tpl/Public/images/zan.png"/>
					</div>
					<!--标题与内容-->
				...
				<div class="index_rw_zxmss">
					<p>任务分类：<span><?php if($vo["tasklb"] == '1'): ?>抖音评论<?php else: ?>抖音点赞<?php endif; ?></span> <span class="index_gjrw">
