...
;(function ($, window, document) {
    ...
    radialIndicator.defaults = {
        radius: 100, //inner radius of indicator
        barWidth: 14, //bar width
        barBgColor: '#fbe9e8', //unfilled bar color
        barColor: '#da251d', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
        ...
        fontSize : 40, //define the font size of indicator number
        interpolate: true, //interpolate color between ranges
        percentage: true, //show percentage of value
