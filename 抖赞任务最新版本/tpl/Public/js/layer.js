        ...
        if (b = b || {}, b.photos) {
            ...
            h.imgprev = function (a) {
                ...
                f.close(h.loadi), h.index = f.open(c.extend({
                    ...
                    content: '<div class="layui-layer-phimg"><img src="' + l[m].src + '" alt="' + (l[m].alt || "") + '" layer-pid="' + l[m].pid + '"><div class="layui-layer-imgsee">' + (l.length > 1 ? '<span class="layui-layer-imguide" style="display: block;"><a href="javascript:;" class="layui-layer-iconext layui-layer-imgprev"></a><a href="javascript:;" class="layui-layer-iconext layui-layer-imgnext"></a></span>' : "") + '<div class="layui-layer-imgbar" style="display:' + (e ? "block" : "") + '"><i class="close layui-layer-close"></i><span class="layui-layer-imgtit"><a href="javascript:;">' + (l[m].alt || "") + "</a><em><i>" + h.imgIndex + "</i>&nbsp;&nbsp;/&nbsp;&nbsp;" + l.length + "</em></span></div></div></div>",
