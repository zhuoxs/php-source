...
$info=pdo_get('wnjz_sun_banner',array('uniacid'=>$_W['uniacid']));
//
//
if($info['lb_imgs']){
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        $res=pdo_insert('wnjz_sun_banner',$data,array('uniacid'=>$_W['uniacid']));
        ...
        $res = pdo_update('wnjz_sun_banner', $data, array('id' => $_GPC['id'],'uniacid'=>$_W['uniacid']));
