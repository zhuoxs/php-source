...
$GLOBALS['frames'] = $this->getMainMenu();
 $type=pdo_getall('wnjz_sun_selectedtype',array('uniacid'=>$_W['uniacid']));
$system=pdo_get('wnjz_sun_system',array('uniacid'=>$_W['uniacid']));
$info=pdo_get('wnjz_sun_selected',array('seid'=>$_GPC['id'],'uniacid'=>$_W['uniacid']));
//var_dump($info);die;
if($info['imgs']){
            if(strpos($info['imgs'],',')){
...
if(checksubmit('submit')){
    ...
    elseif($_GPC['lb_imgs']==null){
        ...
        $res=pdo_insert('wnjz_sun_selected',$data,array('uniacid'=>$_W['uniacid']));
        ...
        $res=pdo_update('wnjz_sun_selected',$data,array('seid'=>$_GPC['id'],'uniacid'=>$_W['uniacid']));
        if($res){
