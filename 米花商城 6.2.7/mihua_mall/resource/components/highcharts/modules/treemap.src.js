		...
		alg_func_group: function (h, w, d, p) {
			...
			this.addElement = function (el) {
				...
				if (this.direction === 0) {
					...
					this.lW = this.nW;
					this.lP.mh = this.lP.total / this.lW;
					this.lP.lR = this.lP.aspectRatio(this.lW, this.lP.mh);
					...
					// Calculate last point old aspect ratio
					this.mh = this.nH;
					this.lP.lW = this.lP.total / this.mh;
					this.lP.lR = this.lP.aspectRatio(this.lP.lW, this.mh);
					// Calculate last point new aspect ratio
