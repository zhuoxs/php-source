    ...
    function spectrum(element, o) {
        ...
        function updateUI() {
            ...
            if (!realColor && allowEmpty) {
                ...
                var reamhex = realColor.toHexString(),
                ...
                if (opts.showAlpha) {
                    ...
                    var gradient = "linear-gradient(left, " + realAlpha + ", " + reamhex + ")";

                    if (IE) {
                        alphaSliderInner.css("filter", tinycolor(realAlpha).toFilter({ gradientType: 1 }, reamhex));
                    }
                    else {
                        ...
                        alphaSliderInner.css("background",
                            "linear-gradient(to right, " + realAlpha + ", " + reamhex + ")");
                    }
                }
