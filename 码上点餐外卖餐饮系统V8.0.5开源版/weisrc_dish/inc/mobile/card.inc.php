...
$pricelist = pdo_fetchall("SELECT * FROM " . tablename('weisrc_dish_cardprice') . " WHERE weid = :weid AND storeid=:storeid order by id", array(':weid' => $weid, ':storeid' => $storeid));
...
include $this->template($this->cur_tpl . '/card');