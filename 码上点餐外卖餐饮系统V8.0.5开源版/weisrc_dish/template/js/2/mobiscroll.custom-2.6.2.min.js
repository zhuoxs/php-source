(function(a) {
    ...
    var e, j, t, s, o, f = (new Date).getTime(), q = {}, b = function() {}, r = document.createElement("modernizr").style, x = d(["perspectiveProperty",
    ...
    a.mobiscroll.presets.select = function(d) {
        function z() {
            ...
            e.group ? (e.rtl && (b = 1), a("optgroup", j).each(function(c) {
                ...
                values : d, keys: f, label: e.groupLabel
            }
            ], c = o, b += e.rtl?-1 : 1) : c = j;
            d = [];
            f = [];
