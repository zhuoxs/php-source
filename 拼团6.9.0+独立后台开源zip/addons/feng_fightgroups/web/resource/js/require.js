...
var newurl = sysinfo.merchantid ? './resource/' : '../addons/feng_fightgroups/web/resource/';
var requireConfig = {
	baseUrl: sysinfo.merchantid ? './resource/js/app' : '../addons/feng_fightgroups/web/resource/js/app',
	paths: {
	...
	shim:{
		'ueditor': {
			deps: [newurl + 'components/ueditor/third-party/zeroclipboard/ZeroClipboard.min.js', newurl + 'components/ueditor/ueditor.config.js'],
			exports: 'UE',
