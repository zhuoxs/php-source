 ...
 * 拼团商城公共方法
 */
   function wl_tpl_ueditor($id, $value = '', $options = array()) {
	global $_GPC,$_W;
	if (!defined('TPL_INIT_UEDITOR')) {
		$s .= '<script type="text/javascript" src="'.$_W['siteroot'].'/web/resource/components/ueditor/ueditor.config.js">
		</script><script type="text/javascript" src="'.$_W['siteroot'].'/web/resource/components/ueditor/ueditor.all.min.js">
		</script><script type="text/javascript" src="'.$_W['siteroot'].'/web/resource/components/ueditor/lang/zh-cn/zh-cn.js"></script>';
	}
