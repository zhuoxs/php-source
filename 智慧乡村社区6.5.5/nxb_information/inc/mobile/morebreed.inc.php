<?php
	...
	$res = pdo_fetchall("SELECT a.*,b.huzhu FROM " . tablename('nx_information_breed') . " as a left join ".tablename('nx_information_hus')." as b on a.hid=b.hid WHERE a.weid=" . $weid." ORDER BY breid DESC LIMIT  ". $num . ",{$psize}");	
