...
`createtime` int(11) NOT NULL COMMENT '创建时间',
`townid` int(11) NOT NULL COMMENT '镇ID',
`authorid` varchar(100) DEFAULT NULL COMMENT '发布权限ID集合',
...
`poor` tinyint(1) NOT NULL DEFAULT '0',
...
`zdymenu` varchar(50) NOT NULL COMMENT '底部第二个自定义底部导航名称',
`zdyurl` text NOT NULL COMMENT '底部第二个自定义导航链接',
`zdymenu4` varchar(50) NOT NULL COMMENT '底部第四个自定义底部导航名称',
...
`cmslogo1` text NOT NULL  COMMENT '后台登录页logo',
`cmslogo2` text NOT NULL  COMMENT '后台左上角logo',
`article_index_name` VARCHAR(100) NOT NULL,
`createtime` int(10) NOT NULL,
PRIMARY KEY (`id`)
...
`weid` int(11) DEFAULT NULL COMMENT '公众号ID',
`townid` int(11) DEFAULT NULL COMMENT '村镇ID',
`villageid` int(11) DEFAULT NULL COMMENT '村庄ID',
...
`postatus` int(1) NOT NULL COMMENT '订单状态9未支付1已付款未发货2已付款已发货3已收到货待确认4收货方自然确认5有问题需人工介入处理6人工客服确认7已关闭订单',
...
//村人口增加月排行
$sql="CREATE TABLE IF NOT EXISTS ".tablename('bc_community_population_top')." (
`id` int(10) NOT NULL AUTO_INCREMENT,
  `weid` int(10) NOT NULL DEFAULT '0',
  `month` varchar(32) NOT NULL,
  `count` int(10) NOT NULL DEFAULT '0',
  `add_count` int(10) NOT NULL,
...
//乡村旅游美食
$sql="CREATE TABLE IF NOT EXISTS ".tablename('bc_community_tour_food')." (
...
//乡村旅游住宿
$sql="CREATE TABLE IF NOT EXISTS ".tablename('bc_community_tour_hotel')." (
...
//乡村旅游乡村资料
$sql="CREATE TABLE IF NOT EXISTS ".tablename('bc_community_tour_info')." (
`tour_id` int(10) NOT NULL AUTO_INCREMENT,
  `weid` int(10) NOT NULL,
  `town_id` int(10) NOT NULL,
  `hushu` varchar(20) NOT NULL COMMENT '户数',
  `zongmianji` varchar(20) NOT NULL COMMENT '总面积',
  `hezuoshe` varchar(20) NOT NULL COMMENT '专业合作社数',
  `pinkunhu` varchar(20) NOT NULL COMMENT '贫困户数（户）',
  `nongtian` varchar(20) NOT NULL COMMENT '农田面积（亩）',
  `zhuyaoxinshi` varchar(255) NOT NULL COMMENT '主要姓氏',
  `cover` varchar(255) NOT NULL,
...
//乡村旅游导航
$sql="CREATE TABLE IF NOT EXISTS ".tablename('bc_community_tour_nav')." (
`id` int(10) NOT NULL AUTO_INCREMENT,
  `weid` int(10) NOT NULL,
  `town_id` int(10) NOT NULL,
...
//乡村旅游景点
$sql="CREATE TABLE IF NOT EXISTS ".tablename('bc_community_tour_sights')." (
`sights_id` int(10) NOT NULL AUTO_INCREMENT,
  `weid` int(10) NOT NULL,
  `town_id` int(10) NOT NULL,
  `sights_name` varchar(60) NOT NULL,
  `cover` varchar(255) NOT NULL,
  `price` decimal(9,2) NOT NULL,
  `tel` varchar(32) NOT NULL,
  `businesshours` varchar(50) NOT NULL COMMENT '营业时间',
  `address` varchar(120) NOT NULL,
  `latlong` varchar(32) NOT NULL,
  `content` mediumtext NOT NULL,
  `dateline` int(10) NOT NULL DEFAULT '0',
  `good` INT(10) NOT NULL COMMENT '好评',
  `general` INT(10) NOT NULL COMMENT '中评',
  `poor` INT(10) NOT NULL COMMENT '差评',
  PRIMARY KEY (`sights_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;";
pdo_query($sql);

$sql="CREATE TABLE IF NOT EXISTS ".tablename('bc_community_assess_log')." (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `weid` int(10) NOT NULL,
