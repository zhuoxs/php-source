...
if ($_GPC['act'] == 'list_ajax') {
    ...
    foreach ($list as $key => $value) {
        ...
        echo '<div style="padding: 12px; background-color: #fff; margin-bottom: 12px;" class="article_item" data-url="'.$this->createMobileUrl('town_article',array('act'=>'view','aid'=>$value['aid'])).'">
			<div class="mui-row">
			...
			<div class="mui-row" style="margin-top: 10px;color: #c0c0c0; font-size: 12px;">
				<div class="mui-col-xs-4" style="text-align: center;"><i class="iconfont icon-chakan" style="font-size: 12px;"></i> '.$value['click'].'</div>
				<div class="mui-col-xs-4" style="border-left: 1px solid #dfdfdf;border-right: 1px solid #dfdfdf; text-align: center;"><i class="iconfont icon-comment" style="font-size: 12px;"></i> 34</div>
...
include $this->template('town_article');
//找出所有子栏目
