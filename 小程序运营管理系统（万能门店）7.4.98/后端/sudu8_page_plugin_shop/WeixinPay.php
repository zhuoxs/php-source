...
class WeixinPay {  
    ...
    private function unifiedorder() {  
        ...
        $url = 'https://api.mch.weixin.qq.com/pay/unifiedorder';  
            ...
            //  'spbill_create_ip' => '192.168.0.161', //终端IP  
                ...
                'notify_url' => $this->getNotifyUrl('/addons/sudu8_page/pay.php'), //通知地址  确保外网能正常访问  
    ...
    protected function getNotifyUrl($url){
        ...
        $current_url .= $_SERVER['HTTP_HOST'] . strstr($_SERVER['REQUEST_URI'], '/app/index', true) . $url;
        
         // file_put_contents(__DIR__."/debug88.txt", $current_url);
