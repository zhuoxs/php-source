...
class PHPExcel_Shared_Excel5
{
	...
	*/
	...
	/**
	 * Convert the height of a cell from account's units to pixels. By interpolation
	 * the relationship is: y = 4/3x. If the height hasn't been set by the account we
