...
function initializeContents()
{
    ...
    // do not show tooltips on iPad; it will cause the account having to click twice
    if (!$.browser.ipad) {
...
$(document).ready(function() {
    ...
    // chrome cannot deal with certain situations; warn the account about reduced features
