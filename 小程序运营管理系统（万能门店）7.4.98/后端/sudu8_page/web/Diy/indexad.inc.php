<?php
        ...
        $ops = array('indexad','post','delete');

        $opt = in_array($opt, $ops) ? $opt : 'indexad';
        ...
        if ($opt == 'post'){
            ...
            if (checksubmit('submit')) {
                ...
                message('图片添加成功!', $this->createWeburl('Diy', array('id' => $id, 'opt' =>'post','op' => 'indexad','cateid'=>$_GPC['cateid'],'chid'=>$_GPC['chid'],'id' => $item['id'])), 'success');
        ...
        if ($opt == 'delete') {
            ...
            message('删除成功!', $this->createWeburl('Diy', array('id' => $id, 'opt' =>'indexad','op' => 'indexad','cateid'=>$_GPC['cateid'],'chid'=>$_GPC['chid'])), 'success');

        }
return include self::template('web/Diy/indexad');
