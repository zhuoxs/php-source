...
if ($_W['ispost']) {
    ...
    if ($_W['slwl']['set']['wsbuttons_set_settings']) {
        ...
        $where['setting_name'] = 'wsbuttons_set_settings';
        pdo_update('slwl_aicard_settings', $data, $where);
    } else {
        $data['uniacid'] = $_W['uniacid'];
        $data['setting_name'] = 'wsbuttons_set_settings';
...
if ($_W['slwl']['set']['wsbuttons_set_settings']) {
    $smeta = $_W['slwl']['set']['wsbuttons_set_settings'];
}

include $this->template('web/website/buttons');
