...
// 官网分类
} else if ($operation == 'search_ws_term') {
	$keyword = $_GPC['keyword'];
...
// 官网文章
} else if ($operation == 'search_ws_news') {
	$keyword = $_GPC['keyword'];
...
// 商城分类
} else if ($operation == 'search_store_term') {
	$keyword = $_GPC['keyword'];
...
// 商城商品
} else if ($operation == 'search_store_good') {
	$keyword = $_GPC['keyword'];
