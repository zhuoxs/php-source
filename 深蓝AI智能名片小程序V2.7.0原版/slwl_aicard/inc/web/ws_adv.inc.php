...
if ($operation == 'display') {
    ...
    if ($list) {
        ...
        $total = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('slwl_aicard_website_adv') . ' WHERE 1 ' . $condition, $params);
    ...
    $one = pdo_fetch('SELECT * FROM ' . tablename('slwl_aicard_website_adv') . ' WHERE 1 ' . $condition, $params);
