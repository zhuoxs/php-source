<?php
//http://cs.tigertaoke.com/app/index.php?i=14&c=entry&do=appbottomdh&m=tiger_newhu
	//菜单//广告
global $_W, $_GPC;
		...
		$dh = pdo_fetchall("SELECT * FROM " . tablename("tiger_newhu_appbottomdh") . " WHERE showtype<>1 and  weid='{$weid}' order by px asc");
