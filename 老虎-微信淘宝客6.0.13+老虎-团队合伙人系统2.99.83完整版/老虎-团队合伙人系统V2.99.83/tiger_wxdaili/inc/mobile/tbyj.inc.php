...
// 										'tb26'=>$fsbl['d4']+$fsbl['b4'],//三级-本月已付款预估佣金数		
									'tb5'=>$byaordercount,//本人-本月已付款订单数
									'tb6'=>$fsbl['d2'],//本人-本月已付款预估佣金数
									'tb16'=>$fsbl['d3'],//二级-本月已付款预估佣金数
									'tb26'=>$fsbl['d4'],//三级-本月已付款预估佣金数	
									'tb32'=>$fsbl['b2'],//本人-本月结算预估佣金数
									'tb34'=>$fsbl['b3'],//二级-本月已结算预估佣金数
									'tb36'=>$fsbl['b4'],//三级-本月已结算预估佣金数
								);
							...
							if(empty($syaordercount)){
								...
								$data=array(
										...
										'tb10'=>$fsbl['s6'],//本人-上月已付款预估佣金数
										'tb20'=>$fsbl['s7'],//二级-上月已付款预估佣金数
										'tb30'=>$fsbl['s8'],//三级-上月已付款预估佣金数
								);
