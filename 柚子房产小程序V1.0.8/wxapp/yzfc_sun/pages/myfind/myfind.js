...
Page(_extends({}, _reload.reload, {
    ...
    getListData: function(t) {
        ...
        if (this.data.list.over) this.tips("已全部加载完。"); else {
            ...
            (0, _api.MyFindData)(e).then(function(t) {
                a.dealList(t, e.page);
            }).catch(function(t) {
                -1 == t.code ? a.tips(t.msg) : a.tips("false");
            });
    ...
    onDelTab: function(t) {
        var e = this, a = t.currentTarget.dataset.idx, i = this.data.list.data[a].id, n = this.data.list.data[a].content;
        wx.showModal({
            title: "提示",
            content: '是否删除"' + n.slice(0, 4) + '"这条动态？',
            success: function(t) {
                var a = this;
                t.confirm && (0, _api.DelFindData)({
                    fid: i
                }).then(function(t) {
