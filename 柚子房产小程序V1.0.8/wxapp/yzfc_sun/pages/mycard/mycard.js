...
Page(_extends({}, _reload.reload, {
    ...
    getListData: function() {
        ...
        if (this.data.list.over) this.tips("已全部加载完。"); else {
            ...
            (0, _api.MyPrizeData)(e).then(function(t) {
                a.dealList(t, e.page);
            }).catch(function(t) {
    ...
    onInfoTab: function(t) {
        var a = t.currentTarget.dataset.idx, e = this.data.list.data[a].id, i = this.data.list.data[a].info.prizename, s = this.data.imgLink + this.data.list.data[a].info.img_cover;
        this.navTo("../card/card?pid=" + e + "&title=" + i + "&img=" + s);
    },
