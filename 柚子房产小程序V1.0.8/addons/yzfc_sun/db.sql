...
-- ----------------------------
-- Table structure for `ims_yzfc_sun_account`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_account`;
CREATE TABLE `ims_yzfc_sun_account` (
...
-- ----------------------------
-- Records of ims_yzfc_sun_account
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_ad`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_ad`;
CREATE TABLE `ims_yzfc_sun_ad` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_ad
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_area`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_area`;
CREATE TABLE `ims_yzfc_sun_area` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_area
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_car`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_car`;
CREATE TABLE `ims_yzfc_sun_car` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_car
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_car_my_tag`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_car_my_tag`;
CREATE TABLE `ims_yzfc_sun_car_my_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_car_my_tag
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_car_tag`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_car_tag`;
CREATE TABLE `ims_yzfc_sun_car_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `typename` varchar(30) NOT NULL COMMENT '分类名称',
...
-- ----------------------------
-- Records of ims_yzfc_sun_car_tag
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_car_top`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_car_top`;
CREATE TABLE `ims_yzfc_sun_car_top` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_car_top
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_carpaylog`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_carpaylog`;
CREATE TABLE `ims_yzfc_sun_carpaylog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_carpaylog
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_comments`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_comments`;
CREATE TABLE `ims_yzfc_sun_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_comments
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_commission_withdrawal`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_commission_withdrawal`;
CREATE TABLE `ims_yzfc_sun_commission_withdrawal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
-- ----------------------------
-- Records of ims_yzfc_sun_commission_withdrawal
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_distribution`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_distribution`;
CREATE TABLE `ims_yzfc_sun_distribution` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
-- ----------------------------
-- Records of ims_yzfc_sun_distribution
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_earnings`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_earnings`;
CREATE TABLE `ims_yzfc_sun_earnings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
-- ----------------------------
-- Records of ims_yzfc_sun_earnings
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_fx`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_fx`;
CREATE TABLE `ims_yzfc_sun_fx` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
-- ----------------------------
-- Records of ims_yzfc_sun_fx
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_fxset`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_fxset`;
CREATE TABLE `ims_yzfc_sun_fxset` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_fxset
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_fxuser`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_fxuser`;
CREATE TABLE `ims_yzfc_sun_fxuser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_fxuser
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_goods`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_goods`;
CREATE TABLE `ims_yzfc_sun_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_goods
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_goods_spec`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_goods_spec`;
CREATE TABLE `ims_yzfc_sun_goods_spec` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_goods_spec
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_hblq`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_hblq`;
CREATE TABLE `ims_yzfc_sun_hblq` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
-- ----------------------------
-- Records of ims_yzfc_sun_hblq
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_help`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_help`;
CREATE TABLE `ims_yzfc_sun_help` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_help
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_hotcity`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_hotcity`;
CREATE TABLE `ims_yzfc_sun_hotcity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cityname` varchar(50) NOT NULL COMMENT '城市名称',
...
-- ----------------------------
-- Records of ims_yzfc_sun_hotcity
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_in`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_in`;
CREATE TABLE `ims_yzfc_sun_in` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_in
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_information`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_information`;
CREATE TABLE `ims_yzfc_sun_information` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_information
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_label`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_label`;
CREATE TABLE `ims_yzfc_sun_label` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_label
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_like`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_like`;
CREATE TABLE `ims_yzfc_sun_like` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `information_id` int(11) NOT NULL COMMENT '帖子id',
  `user_id` int(11) NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Records of ims_yzfc_sun_like
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_mylabel`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_mylabel`;
CREATE TABLE `ims_yzfc_sun_mylabel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_mylabel
-- ----------------------------
...
-- ----------------------------
-- Records of ims_yzfc_sun_news
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_order`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_order`;
CREATE TABLE `ims_yzfc_sun_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `money` decimal(10,2) NOT NULL COMMENT '金额',
...
-- ----------------------------
-- Records of ims_yzfc_sun_order
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_paylog`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_paylog`;
CREATE TABLE `ims_yzfc_sun_paylog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_paylog
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_share`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_share`;
CREATE TABLE `ims_yzfc_sun_share` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `information_id` int(11) NOT NULL COMMENT '帖子id',
  `user_id` int(11) NOT NULL COMMENT '用户id',
  `store_id` int(11) NOT NULL,
...
-- ----------------------------
-- Records of ims_yzfc_sun_share
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_sms`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_sms`;
CREATE TABLE `ims_yzfc_sun_sms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_sms
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_spec_value`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_spec_value`;
CREATE TABLE `ims_yzfc_sun_spec_value` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_spec_value
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_store`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_store`;
CREATE TABLE `ims_yzfc_sun_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Records of ims_yzfc_sun_store
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_store_wallet`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_store_wallet`;
CREATE TABLE `ims_yzfc_sun_store_wallet` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NOT NULL,
  `money` decimal(10,2) NOT NULL,
...
-- ----------------------------
-- Records of ims_yzfc_sun_store_wallet
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_storepaylog`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_storepaylog`;
CREATE TABLE `ims_yzfc_sun_storepaylog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NOT NULL COMMENT '商家ID',
  `money` decimal(10,2) NOT NULL,
  `time` datetime NOT NULL,
...
-- ----------------------------
-- Records of ims_yzfc_sun_storepaylog
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_storetype`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_storetype`;
CREATE TABLE `ims_yzfc_sun_storetype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_storetype
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_storetype2`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_storetype2`;
CREATE TABLE `ims_yzfc_sun_storetype2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_storetype2
-- ----------------------------
...
-- ----------------------------
-- Records of ims_yzfc_sun_system
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_top`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_top`;
CREATE TABLE `ims_yzfc_sun_top` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(11) NOT NULL COMMENT '1.一天2.一周3.一个月',
  `money` decimal(10,2) NOT NULL COMMENT '价格',
  `uniacid` int(11) NOT NULL,
...
-- ----------------------------
-- Records of ims_yzfc_sun_top
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_type`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_type`;
CREATE TABLE `ims_yzfc_sun_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type_name` varchar(20) NOT NULL COMMENT '分类名称',
  `img` varchar(100) NOT NULL COMMENT '分类图片',
  `uniacid` int(11) NOT NULL COMMENT '小程序id',
...
-- ----------------------------
-- Records of ims_yzfc_sun_type
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_type2`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_type2`;
CREATE TABLE `ims_yzfc_sun_type2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_type2
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_tzpaylog`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_tzpaylog`;
CREATE TABLE `ims_yzfc_sun_tzpaylog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_tzpaylog
-- ----------------------------
...
-- ----------------------------
-- Records of ims_yzfc_sun_user
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_userformid`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_userformid`;
CREATE TABLE `ims_yzfc_sun_userformid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Records of ims_yzfc_sun_userformid
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_withdrawal`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_withdrawal`;
CREATE TABLE `ims_yzfc_sun_withdrawal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_withdrawal
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_yellowpaylog`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_yellowpaylog`;
CREATE TABLE `ims_yzfc_sun_yellowpaylog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_yellowpaylog
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_yellowset`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_yellowset`;
CREATE TABLE `ims_yzfc_sun_yellowset` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_yellowset
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_yellowstore`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_yellowstore`;
CREATE TABLE `ims_yzfc_sun_yellowstore` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
-- ----------------------------
-- Records of ims_yzfc_sun_yellowstore
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_yjset`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_yjset`;
CREATE TABLE `ims_yzfc_sun_yjset` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_yjset
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_yjtx`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_yjtx`;
CREATE TABLE `ims_yzfc_sun_yjtx` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_yjtx
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_zx`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_zx`;
CREATE TABLE `ims_yzfc_sun_zx` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_zx
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_zx_assess`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_zx_assess`;
CREATE TABLE `ims_yzfc_sun_zx_assess` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_zx_assess
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_zx_type`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_zx_type`;
CREATE TABLE `ims_yzfc_sun_zx_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_yzfc_sun_zx_type
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_yzfc_sun_zx_zj`
-- ----------------------------
DROP TABLE IF EXISTS `ims_yzfc_sun_zx_zj`;
CREATE TABLE `ims_yzfc_sun_zx_zj` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
