...
if(checksubmit('submit')){
    $data['nav_name_one']=$_GPC['nav_name_one']?$_GPC['nav_name_one']:'首页';
    ...
    $data['nav_name_two']=$_GPC['nav_name_two']?$_GPC['nav_name_two']:'新房';
    $data['nav_img_b'] = $_GPC['nav_img_b'];
    $data['nav_name_three']=$_GPC['nav_name_three']?$_GPC['nav_name_three']:'发现';
