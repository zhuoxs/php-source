...
class AopClient
{
    ...
    protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt){
        ...
        require_once APP_PATH . 'common/library/Alipay/lotusphp_runtime/Logger/Logger.php';//调用sdk里面的AlipayUserInfoShareRequest类
    ...
    */
    ...
    public function execute($request, $authToken = null, $appInfoAuthtoken = null)
    {
        ...
        //签名数组排序
        $infoArr = array_merge($apiParams, $sysParams);
        ksort($infoArr, SORT_NATURAL);
        //签名
        $sysParams["sign"] = $this->generateSign($infoArr, $this->signType);
