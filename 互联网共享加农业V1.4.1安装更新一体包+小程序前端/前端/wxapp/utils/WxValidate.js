    ...
    return _createClass(n, [ {
        ...
        value: function() {
            ...
            n.methods = {
                ...
                tel: function(t) {
                    return n.optional(t) || /^1[34578]\d{9}$/.test(t);
                },
                url: function(t) {
                ...
                equalTo: function(t, e) {
                    return n.optional(t) || t === n.scope.detail.value[e];
                },
        ...
        key: "checkParam",
        value: function(t, e, n) {
            var i = (this.scope = n).detail.value, a = null !== i[t] && void 0 !== i[t] ? i[t] : "";
            for (var r in e) if (this.isValidMethod(r)) {
                var o = {
                    method: r,
                    parameters: e[r]
                }, u = this.methods[r](a, o.parameters);
                if ("dependency-mismatch" === u) continue;
                if (this.setValue(t, r, u, a), !u) {
                    this.formatTplAndAdd(t, o, a);
                    break;
                }
            }
        }
