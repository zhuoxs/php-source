...
pdo_insert('yzhyk_sun_baowen',$baowen);  
//签名验证
$get=$data;
$string1 = '';
ksort($get);
...
$wxkey=pdo_getcolumn('yzhyk_sun_system',array('uniacid' =>intval($get['attach'])), 'wxkey',1);
...
if($sign==$get['sign']){
    ...
    $site = WeUtility::createModuleWxapp('yzhyk_sun'); 
    $method = 'payResult';
    $site->$method($data); 
    echo 1; 
}
