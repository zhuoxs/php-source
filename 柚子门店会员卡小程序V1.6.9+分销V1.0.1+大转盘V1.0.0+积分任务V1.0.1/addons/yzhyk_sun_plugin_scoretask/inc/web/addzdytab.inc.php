...
$info=pdo_get('yzhyk_sun_plugin_scoretask_customize',array('id'=>$_GPC['id']));
if(checksubmit('submit')){
    ...
    if(empty($_GPC['id'])){  
        $res = pdo_insert('yzhyk_sun_plugin_scoretask_customize', $data);
        if($res){
        ...
        $res = pdo_update('yzhyk_sun_plugin_scoretask_customize', $data, array('id' => $_GPC['id']));
        if($res){
