...
if($item['lottery_type']==2){
    $item['title']=pdo_getcolumn('yzhyk_sun_plugin_scoretask_lotteryprize',array('id'=>$item['lotteryprize_id']),'name');
    $item['score']=pdo_getcolumn('yzhyk_sun_plugin_scoretask_lotteryprize',array('id'=>$item['lotteryprize_id']),'score');
}
