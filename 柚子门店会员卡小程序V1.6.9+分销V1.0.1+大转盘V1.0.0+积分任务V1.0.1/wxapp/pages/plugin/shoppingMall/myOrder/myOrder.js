...
Page({
    data: (_data = {
        ...
        complete: [],
        lid: ""
    }, _defineProperty(_data, "menuTapCurrent", ""), _defineProperty(_data, "current", ""), 
    _defineProperty(_data, "all", []), _data),
    onLoad: function(a) {
        var e = this, t = a.check_type;
        0 < t || (t = 0), e.setData({
            menuTapCurrent: t
    ...
    getMyOrder: function() {
        var o = this, a = (wx.getStorageSync("user"), o.data.openid), r = o.data.page, d = (o.data.pagesize, 
        o.data.all), e = o.data.menuTapCurrent;
        app.util.request({
            ...
            success: function(a) {
                ...
                if (1 == r) d = a.data.data; else for (var t in a.data.data) d.push(a.data.data[t]);
    ...
    getSign: function() {
        var o = this, a = (wx.getStorageSync("user"), o.data.openid), r = o.data.page1, d = (o.data.pagesize, 
        o.data.sign);
        app.util.request({
            url: "entry/wxapp/getMyOrder",
            data: {
    ...
    getSend: function() {
        var o = this, a = (wx.getStorageSync("user"), o.data.openid), r = o.data.page2, d = (o.data.pagesize, 
        o.data.send);
        app.util.request({
            url: "entry/wxapp/getMyOrder",
            data: {
    ...
    getComplete: function() {
        var o = this, a = (wx.getStorageSync("user"), o.data.openid), r = o.data.page3, d = (o.data.pagesize, 
        o.data.complete);
        app.util.request({
            url: "entry/wxapp/getMyOrder",
            data: {
    ...
    productsDetails: function(a) {
        var e = a.currentTarget.dataset.id, t = a.currentTarget.dataset.oid, o = (a.currentTarget.dataset.lottery_type, 
        a.currentTarget.dataset.order_status);
    ...
    method: function(a) {
        var e = a.currentTarget.dataset.status, t = a.currentTarget.dataset.id, o = a.currentTarget.dataset.oid, r = a.currentTarget.dataset.lottery_type;
