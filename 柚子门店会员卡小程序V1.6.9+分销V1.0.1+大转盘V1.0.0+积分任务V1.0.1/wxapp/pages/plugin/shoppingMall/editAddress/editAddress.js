...
Page({
    ...
    saveAddress: function(a) {
        ...
        if (t) {
            console.log(i);
            var i = e.data.id, s = a.detail.value.username, l = a.detail.value.telephone, o = d[0], n = d[1], r = d[2], u = a.detail.value.address, p = a.detail.value.zipCode, c = e.data.radioValue, g = (wx.getStorageSync("user"), 
            e.data.openid);
            app.util.request({
            ...
            u = a.detail.value.address, p = a.detail.value.zipCode, c = e.data.radioValue, wx.getStorageSync("user"), 
            g = e.data.openid;
            app.util.request({
