...
Page({
    ...
    onLoad: function(t) {
        ...
        var d = this, e = wx.getStorageSync("user").openid;
        app.util.request({
            ...
            success: function(t) {
                ...
                var o = t.data.data.end_time_z, c = Date.parse(o) / 1e3 - Date.parse(new Date()) / 1e3, l = setInterval(function() {
    ...
    submit1: function(t) {
        ...
        console.log("你的icon"), console.log(i), this.setData({
            ...
            showLoading: !1,
            success: function(t) {
                console.log("用户自己生成砍价点劵信息"), console.log(t), o.setData({});
            }
        });
    },
