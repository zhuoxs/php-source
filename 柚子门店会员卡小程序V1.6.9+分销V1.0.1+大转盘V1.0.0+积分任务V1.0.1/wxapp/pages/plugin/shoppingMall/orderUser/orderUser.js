...
Page({
    ...
    onLoad: function(t) {
        var a = t.gid;
        if (null == (e = t.id)) var e = a; else e = t.id;
        this.setData({
            id: e
        });
        var l = this;
        ...
        app.get_openid().then(function(t) {
            ...
            app.util.request({
                ...
                showLoading: !1,
                success: function(t) {
                    console.log("获取点劵商品详情信息"), console.log(t);
                    var a = t.data.data.end_time, r = (Date.parse(new Date()), parseInt(a) - parseInt(Date.parse(new Date()) / 1e3)), c = setInterval(function() {
                        var t = r, a = Math.floor(t / 3600 / 24), e = a.toString();
                        1 == e.length && (e = "0" + e);
                        var o = Math.floor((t - 3600 * a * 24) / 3600), n = o.toString();
                        1 == n.length && (n = "0" + n);
                        var s = Math.floor((t - 3600 * a * 24 - 3600 * o) / 60), i = s.toString();
                        1 == i.length && (i = "0" + i);
                        var d = (t - 3600 * a * 24 - 3600 * o - 60 * s).toString();
                        1 == d.length && (d = "0" + d), l.setData({
                            countDownDay: e,
                            countDownHour: n,
                            countDownMinute: i,
                            countDownSecond: d
                        }), --r < 0 && (clearInterval(c), wx.showToast({
                            title: "活动已结束"
                        }), l.setData({
                            countDownDay: "00",
                            countDownHour: "00",
    ...
    getAddressList: function() {
        var c = this, t = (wx.getStorageSync("user"), c.data.openid), a = wx.getStorageSync("scoretask_address_id");
        console.log("默认地址"), console.log(a), 0 < a ? (wx.setStorageSync("scoretask_address_id", 0), 
        app.util.request({
            ...
            success: function(t) {
                ...
                var a = t.data.data.id, e = t.data.data.gid, o = t.data.data.name, n = t.data.data.phone, s = t.data.data.province, i = t.data.data.zip, d = t.data.data.city, r = t.data.data.address;
                c.setData({
                    address_id: a,
                    name: o,
                    phone: n,
    ...
    submit1: function(t) {
        ...
        wx.getStorageSync("user");
        var o = a.data.openid, n = t.currentTarget.dataset.title, s = t.currentTarget.dataset.icon;
        console.log("你的icon"), console.log(s), this.setData({
            ...
            showLoading: !1,
            success: function(t) {
                console.log("用户自己生成砍价点劵信息"), console.log(t), a.setData({});
            }
        });
    },
    onShareAppMessage: function(t) {
        if ("button" === t.from) {
            ...
            return {
                ...
                path: "/pages/plugin/shoppingMall/cutPoints/cutPoints?gid=" + a + "&d_user=" + e,
                success: function(t) {
                    console.log("转发成功");
                },
                fail: function(t) {
    ...
    consignee: function(t) {
        var a = this.data.id, e = t.currentTarget.dataset.id;
    ...
    getOrderDetailByGid: function() {
        var a = this, t = a.data.openid, e = this.data.id;
        app.util.request({
    ...
    onShow: function() {
        var a = this;
        app.get_openid().then(function(t) {
            a.getAddressList(), a.getOrderDetailByGid();
        });
    },
    editor: function(t) {
