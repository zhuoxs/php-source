    ...
    modal.init = function (params) {
        ...
        if (!modal.menu) {
            modal.menu = {
                ...
                data: {
                    M0123456789101: {
                        imgurl: '../addons/weliam_merchant/web/resource/diy/images/menu-1.png',
                        linkurl: '',
                        iconclass: 'icon-home',
                        text: '首页',
                        url_type:'',
                    ...
                    M0123456789102: {
                        imgurl: '../addons/weliam_merchant/web/resource/diy/images/menu-2.png',
                        linkurl: '',
                        iconclass: 'icon-shop',
                        text: '好店',
                        url_type:'',
                    ...
                    M0123456789103: {
                        imgurl: '../addons/weliam_merchant/web/resource/diy/images/menu-3.png',
                        linkurl: '',
                    ...
                    M0123456789104: {
                        imgurl: '../addons/weliam_merchant/web/resource/diy/images/menu-4.png',
                        linkurl: '',
                    ...
                    M0123456789105: {
                        imgurl: '../addons/weliam_merchant/web/resource/diy/images/menu-5.png',
                        linkurl: '',
                        iconclass: 'icon-my',
                        text: '我的',
                        url_type:'',
    ...
    modal.initEditor = function () {
        ...
        $("#diy-editor #addItem").unbind('click').click(function () {
            ...
            modal.menu.data[itemid] = {
                imgurl: '../addons/weliam_merchant/web/resource/images/nopic-small.jpg',
                linkurl: '',
                iconclass: 'icon-home',
                text: '菜单文字',
                url_type:'',
