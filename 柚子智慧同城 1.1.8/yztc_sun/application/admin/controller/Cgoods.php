...
//                处理规格设置
    ...
    public function batchonlyvip(){
        $ids = input("post.ids");
        $ret = $this->model->where('id','in',$ids)->update(['only_vip'=>1]);
        if($ret){
            return array(
                'code'=>0,
            );
    ...
    public function batchunonlyvip(){
        $ids = input("post.ids");
        $ret = $this->model->where('id','in',$ids)->update(['only_vip'=>0]);
        if($ret){
            return array(
                'code'=>0,
            );
    ...
    public function batchwelfare(){
        $ids = input("post.ids");
        $ret = $this->model->where('id','in',$ids)->update(['is_welfare'=>1]);
        if($ret){
            return array(
                'code'=>0,
            );
...
//    取消会员免单
    public function batchunwelfare(){
        $ids = input("post.ids");
        $ret = $this->model->where('id','in',$ids)->update(['is_welfare'=>0]);
        if($ret){
            return array(
                'code'=>0,
            );
