<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cinfo/index.html";i:1553823410;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'id', width:80, title: '帖子id',fixed:'left',sort:true},
                {field:'topcat_id_z', width:100, title: '一级分类',fixed:'left',sort:true},
                {field:'cat_id_z', width:100, title: '二级分类',sort:true,},
                {field:'nickname', width:120, title: '微信昵称',sort:true},
                ...
                {field:'address', width:220, title: '地址',sort:true},
                {field:'content', width:180, title: '内容',sort:true},
                ...
                {field:'top_status_z', width:180, title: '置顶申请状态',sort:true},
                {field:'pay_status_z', width:180, title: '置顶支付状态',sort:true},
                {field:'topping_time_z', width:200, title: '置顶时间',sort:true},
