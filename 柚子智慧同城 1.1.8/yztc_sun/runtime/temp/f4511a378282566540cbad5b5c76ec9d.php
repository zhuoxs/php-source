<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cadmin/index2.html";i:1553823431;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<blockquote class="layui-elem-quote layui-quote-nm">
    <p style="font-size: 14px;">后台地址：<a href="<?php echo $_W['siteroot']; ?>addons/yztc_sun/admin/index.php"><?php echo $_W['siteroot']; ?>addons/yztc_sun/admin/index.php</a></p>
</blockquote>
<!--搜索栏-->
...
<script>
    layui.use('table', function () {
        ...
        table.render({
            elem: '#laytable'
            ,url:"<?php echo adminurl('get_list2'); ?>"
            ,cols: [[
                ...
                {field:'store_name', width:150, title: '商户',sort:true},
    ...
    $('#btnAdd2').click(function () {
        var index = layer.open({
            ...
            maxmin: true, //开启最大化最小化按钮
            area: ['893px', '600px'],
            content: "<?php echo adminurl('add2'); ?>",
        });
        layer.full(index);
        return false;
    })
    ...
    $(document).on('click','.btnEdit2',function(e){
        ...
        var index = layer.open({
            ...
            maxmin: true, //开启最大化最小化按钮
            area: ['893px', '600px'],
            content: "<?php echo adminurl('edit2'); ?>&id="+id,
        });
        layer.full(index);
        return false;
    })
    ...
    $(document).on('click','.btnCopy2',function(e){
        ...
        var index = layer.open({
            ...
            maxmin: true, //开启最大化最小化按钮
            area: ['893px', '600px'],
            content: "<?php echo adminurl('copy2'); ?>&id="+id,
        });
        layer.full(index);
        return false;
    })
