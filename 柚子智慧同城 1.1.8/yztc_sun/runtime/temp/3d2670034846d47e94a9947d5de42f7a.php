<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cmenu/index.html";i:1553823408;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use('table', function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'name', width:180, title: '菜单名称',fixed:'left',sort:true},
                // {field:'icon', width:80, title: '图标',sort:true,templet: '#dataIcon'},
                {field:'menugroup_name', width:100, title: '分组名称',sort:true},
                {field:'menu_name', width:100, title: '上级菜单',sort:true},
                ...
                {field:'store_show',fixed:'right', width:200, title: '商户后台显示',sort:true,templet: '#dataStoreShow'},
    ...
    require(['select2'], function () {
        $('.select2').select2();
        $.get("<?php echo adminurl('select','cmenugroup'); ?>", function (ret) {
