<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/ccoupon/coupon.html";i:1555123177;s:93:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/baselist.html";i:1553823406;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            elem: '#laytable'
            ,url:"<?php echo adminurl('get_coupon_list'); ?>"
    ...
    layui.use(['table','form'], function () {
        ...
        $(document).on('click','.btnGetLog',function(e){
            ...
            var index = layer.open({
                ...
                maxmin: true, //开启最大化最小化按钮
                area: ['900px', '600px'],
                content: "<?php echo adminurl('getlist'); ?>&cid="+id,
            });
            layer.full(index);
            return false;
        })
