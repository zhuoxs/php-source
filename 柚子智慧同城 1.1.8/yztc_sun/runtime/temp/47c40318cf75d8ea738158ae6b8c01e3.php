<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cuser/vipcard.html";i:1553823368;s:93:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/baselist.html";i:1553823406;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<input type="hidden" id="modelName" value="vipcard" url_name="vipcard">
<script>
    layui.use('table', function () {
        ...
        table.render({
            elem: '#laytable'
            ,url:"<?php echo adminurl('get_vipcard_list'); ?>"
            , where: { modelName: 'Vipcard' }
            ,cols: [[
                {type:'numbers',fixed:'left'},
                {type:'checkbox',fixed:'left'},
                {field:'name', width:150, title: '标题名称',fixed:'left'},
                {field:'day', width:150, title: '有效天数',sort:true},
                {field:'money', width:100, title: '售价',sort:true},
                {field:'stock', width:100, title: '库存',sort:true},
                {field:'salenum', width:100, title: '已售数量',sort:true},
