<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cad/index.html";i:1553823429;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/html" id="dataType">
    <?php $AdTypes = \enum\AdType::getList(); if(is_array($AdTypes) || $AdTypes instanceof \think\Collection || $AdTypes instanceof \think\Paginator): $i = 0; $__LIST__ = $AdTypes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        {{# if(d.type == <?php echo $key; ?>){ }}
            <?php echo $vo; ?>
        {{# } }}
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'title', width:180, title: '标题',fixed:'left',sort:true},
                {field:'pic', width:80, title: '图片',sort:true,templet: '#dataPic'},
                {field:'sort', width:180, title: '排序',sort:true},
                {field:'type', width:180, title: '类型',sort:true,templet: '#dataType'},
