<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/ccoustomize/navicon.html";i:1554424771;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="tool-box">
    <div class="layui-btn-group">
        <a href="javascript:;" id="btnAddn" class="layui-btn layui-btn-primary layui-btn-sm">新增</a>
...
<script>
    layui.use('table', function () {
        ...
        table.render({
            elem: '#laytable'
            ,url:"<?php echo adminurl('get_navicon_list'); ?>"
            ,cols: [[
    ...
    $('#btnAddn').click(function () {
        var index = layer.open({
            ...
            maxmin: true, //开启最大化最小化按钮
            area: ['893px', '600px'],
            content: "<?php echo adminurl('editnav'); ?>",
        });
        layer.full(index);
        return false;
    })
