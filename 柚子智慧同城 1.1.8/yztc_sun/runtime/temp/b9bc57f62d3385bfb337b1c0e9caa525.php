<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cinfotop/edit.html";i:1553823411;s:89:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/edit.html";i:1553823405;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-form-item">
    <label class="layui-form-label">置顶名称</label>
    <div class="layui-input-block">
        <input autocomplete="off" type="text" name="name" lay-verify="required" placeholder="请输入置顶名称" class="layui-input" value="<?php echo isset($info['name'])?$info['name']:''; ?>">
    </div>
</div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input autocomplete="off" type="number" name="day_num" lay-verify="required" placeholder="请输入天数" class="layui-input" value="<?php echo isset($info['day_num'])?$info['day_num']:''; ?>">
    </div>
</div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input autocomplete="off" type="number" name="money" lay-verify="required" placeholder="请输入金额" class="layui-input" value="<?php echo isset($info['money'])?$info['money']:''; ?>">
    </div>
</div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input autocomplete="off" type="number" name="sort" placeholder="请输入0-255之间正整数，数字越大排越前" min="0" max="255" class="layui-input" value="<?php echo isset($info['sort'])?$info['sort']:''; ?>">
    </div>
</div>
