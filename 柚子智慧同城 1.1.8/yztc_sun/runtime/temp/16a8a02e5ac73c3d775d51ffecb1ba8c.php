<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cuser/addvipcard.html";i:1553823371;s:94:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/editnosub.html";i:1553823404;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" method="post" action="<?php echo adminurl('save'); ?>&modelName=Vipcard">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input autocomplete="off" type="number" name="day" placeholder="请输入正整数" min="0"  class="layui-input" value="<?php echo isset($info['day'])?$info['day']:''; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">售价</label>
        <div class="layui-input-block">
            <input autocomplete="off" type="number" name="money" placeholder="请输入售价"  class="layui-input" value="<?php echo isset($info['money'])?$info['money']:''; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">库存</label>
        <div class="layui-input-block">
            <input autocomplete="off" type="number" name="stock" placeholder="请输入正整数" min="0" class="layui-input" value="<?php echo isset($info['stock'])?$info['stock']:''; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">排序</label>
        <div class="layui-input-block">
            <input autocomplete="off" type="number" name="sort" placeholder="请输入0-255之间正整数，数字越小排越前" min="0" max="255" class="layui-input" value="<?php echo isset($info['sort'])?$info['sort']:''; ?>">
        </div>
    </div>
...
<script>
    ...
    layui.use(['element','form'], function(){
        ...
        form.on('submit', function(data){
            ...
            var data = data.field;
            console.log(data);
            var url = "<?php echo adminurl('save'); ?>&modelName=Vipcard";
