<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cstorerecharge/edit.html";i:1553823379;s:89:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/edit.html";i:1553823405;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input autocomplete="off" type="text" name="days" lay-verify="required" placeholder="请输入有效天数" class="layui-input" value="<?php echo isset($info['days'])?$info['days']:''; ?>">
    </div>
</div>
<div class="layui-form-item">
    <label class="layui-form-label">价格</label>
    <div class="layui-input-block">
        <input autocomplete="off" type="text" name="price" placeholder="请输入价格" class="layui-input" value="<?php echo isset($info['price'])?$info['price']:''; ?>">
    </div>
</div>
