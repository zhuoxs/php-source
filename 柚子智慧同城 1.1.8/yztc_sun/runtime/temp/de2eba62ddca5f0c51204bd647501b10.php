<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cstoreuser/index.html";i:1553823377;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use('table', function () {
        ...
        $('#btnChooseUser').click(function () {
            ...
            layer.prompt({title:'输入用户id（前端个人中心顶部的UID）'}, function(value, index, elem){
                ...
                var url = "<?php echo adminurl('batchadduser'); ?>";
