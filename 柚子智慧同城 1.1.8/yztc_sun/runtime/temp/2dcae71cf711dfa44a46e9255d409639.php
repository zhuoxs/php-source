<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/ctask/index.html";i:1553823373;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="task" lay-skin="switch" lay-text="开启|关闭" lay-filter="task" <?php if(!empty($taskconfig['value'])) echo "checked"; ?>>
        </div>
    </div>
</form>
...
<script>
    layui.use(['table','form'], function () {
        ...
        form.on('switch(task)', function(obj){
            if (obj.elem.checked){
                var url = "<?php echo adminurl('starttask'); ?>";
                var msg = "开启";
            }else{
                var url = "<?php echo adminurl('closetask'); ?>";
                var msg = "关闭";
            }
