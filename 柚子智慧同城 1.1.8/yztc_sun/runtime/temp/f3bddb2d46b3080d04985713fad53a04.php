<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cdistributionorder/index.html";i:1556181880;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
    <ul class="layui-tab-title">
        <li class="<?php echo $_GPC['ordertype']==0?"layui-this":""; ?>" >普通订单</li>
        <li class="<?php echo $_GPC['ordertype'] == 1 ?"layui-this":""; ?>">抢购订单</li>
        <li class="<?php echo $_GPC['ordertype'] == 2 ?"layui-this":""; ?>">拼团订单</li>
        <li class="<?php echo $_GPC['ordertype'] == 3 ?"layui-this":""; ?>">会员卡订单</li>
        <li class="<?php echo $_GPC['ordertype'] == 4 ?"layui-this":""; ?>">预约订单</li>
    </ul>
...
<script>
    ...
    layui.use('element', function(){
        ...
        element.on('tab(docDemoTabBrief)', function(data){
            console.log(data);
            var url="<?php echo adminurl('index','cdistributionorder'); ?>";
            url=url+'&ordertype='+data.index;
            location.href=url;
        });
    });
    ...
    layui.use(['table','form'], function () {
        ...
        table.render({
            elem: '#laytable'
            ,url:"<?php echo adminurl('get_list'); ?>"+"&ordertype="+ordertype
            ,cols: [[
                {type:'numbers',fixed:'left'},
                {type:'checkbox',fixed:'left'},
                {field:'store_name', width:180, title: '所属商家',fixed:'left',sort:false},
                {field:'type_z', width:180, title: '订单类型',fixed:'left',sort:false},
                {field:'order_no', width:180, title: '订单号',fixed:'left',sort:false},
                {field:'nickname', width:180, title: '购买人',sort:false},
                {field:'create_time', width:180, title: '下单时间',sort:false},
                {field:'goods', width:180, title: '商品信息',sort:false},
                {field:'order_amount', width:200, title: '金额',sort:false},
                {field:'order_status_z', width:180, title: '订单状态',sort:false},
                {field:'distribution', width:350, title: '分销情况',sort:false},
            ]]
            ,page: true,
            height:'full-300',
        });
        ...
        form.on('switch(show_index)', function(obj){
            if (obj.elem.checked){
                var url = "<?php echo adminurl('showindexenable'); ?>";
                var msg = "是";
            }else{
                var url = "<?php echo adminurl('showindexdisable'); ?>";
                var msg = "否";
            }
            $.post(url, {ids:obj.value}, function(data){
                if (typeof data == 'string'){
        ...
        $(document).on('click','.btnDetail',function(e){
            ...
            var index = layer.open({
                ...
                maxmin: true, //开启最大化最小化按钮
                area: ['893px', '600px'],
                content: "<?php echo adminurl('detail'); ?>&id="+id,
            });
            layer.full(index);
            return false;
        })
        $(document).on('click','.btnRefund',function(e){
            ...
            var index = layer.open({
                ...
                maxmin: true, //开启最大化最小化按钮
                area: ['893px', '600px'],
                content: "<?php echo adminurl('refund'); ?>&id="+id,
            });
            layer.full(index);
            return false;
        })
        ...
        $(document).on('click','.btnFahuo',function(e){
            ...
            var index = layer.open({
                ...
                maxmin: true, //开启最大化最小化按钮
                area: ['893px', '600px'],
                content: "<?php echo adminurl('fahuo'); ?>&id="+id,
            });
            layer.full(index);
            return false;
            /*
            ...
            layer.confirm('确认发货', {
                ...
                var url = "<?php echo adminurl('fahuo'); ?>";
                $.post(url, {ids:id}, function(data){
                    if (typeof data == 'string'){
                        data = $.parseJSON(data);
                    }
        ...
        $(document).on('click','.btnFinish',function(e){
            ...
            layer.confirm('是否完成此订单', {
                ...
                var url = "<?php echo adminurl('save_finish'); ?>";
