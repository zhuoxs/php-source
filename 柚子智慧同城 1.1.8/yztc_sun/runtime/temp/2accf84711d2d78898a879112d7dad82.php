<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cuser/vipcode.html";i:1553823368;s:93:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/baselist.html";i:1553823406;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use('table', function () {
        ...
        table.render({
            elem: '#laytable'
            ,url:"<?php echo adminurl('get_vipcode_list'); ?>"
    ...
    layui.use(['table','form'], function () {
        ...
        $(document).on('click','#btnBatchExport',function(e){
            ...
            layer.confirm('是否导出所有未使用的数据', {
                ...
                var url = "<?php echo adminurl('exportData'); ?>";
                window.open(url);
                table.reload('laytable',{});
