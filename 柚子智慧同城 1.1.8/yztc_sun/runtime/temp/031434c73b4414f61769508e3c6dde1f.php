<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/ccategory/index.html";i:1553823426;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/html" id="dataTool">
    <a href="javascript:;" data-id="{{ d.id }}" data-name="{{ d.name }}" class="layui-btn layui-btn-primary layui-btn-xs btnAdd2">添加分类</a>
    ...
    layui.config({
        ...
        ptable=table.render({
            ...
            ,cols: [[
                {type:'numbers'},
                {type:'checkbox'},
                {field:'name', width:180, title: '分类'},
                {field:'index', width:180, title: '排序'},
            ...
            /*    <?php if(!$_SESSION['admin']['store_id']): ?>
                {field:'is_recommend', width:100, title: '推荐状态',templet: '#dataHot'},
                <?php endif; ?>*/
            ...
            $(document).on('click','.btnAdd2',function(e){
                ...
                var index = layer.open({
                    ...
                    maxmin: true, //开启最大化最小化按钮
                    area: ['893px', '600px'],
                    content: "<?php echo adminurl('add'); ?>&parent_id=" + id + "&parent_name=" + name,
                });
                layer.full(index);
                return false;
            })
