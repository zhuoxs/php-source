<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:110:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cdistributionmercapdetails/index.html";i:1553823422;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use(['table','form'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'nickname', width:180, title: '用户',fixed:'left',sort:true},
                {field:'mcd_type_z', width:180, title: '类型',sort:true},
                {field:'money', width:180, title: '金额',sort:true},
                {field:'ratesmoney', width:180, title: '手续费（提现用）',sort:true},
        ...
        $(document).on('click','.btnPass',function(e){
            ...
            layer.confirm('确认审核通过', {
                ...
                var url = "<?php echo adminurl('pass'); ?>";
                $.post(url, {ids:id}, function(data){
                    if (typeof data == 'string'){
                        data = $.parseJSON(data);
                    }
        ...
        $(document).on('click','.btnNopass',function(e){
            ...
            layer.confirm('确认审核拒绝', {
                ...
                var url = "<?php echo adminurl('nopass'); ?>";
                $.post(url, {ids:id}, function(data){
                    if (typeof data == 'string'){
                        data = $.parseJSON(data);
                    }
