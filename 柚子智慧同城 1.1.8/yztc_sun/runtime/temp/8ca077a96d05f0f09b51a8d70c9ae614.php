<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/index/index.html";i:1555123168;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="/addons/yztc_sun/public/static/bower_components/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/addons/yztc_sun/public/static/bower_components/font-awesome/css/font-awesome.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="/addons/yztc_sun/public/static/dist/css/AdminLTE.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="/addons/yztc_sun/public/static/dist/css/skins/_all-skins.min.css">
    ...
    <style>
        ...
        .footer{position: fixed;bottom: 0px; right: 0px;width: 100%; height:20px;z-index:1000;}
    </style>
    <link rel="stylesheet" href="/addons/yztc_sun/public/static/custom/tabs-ext.css">
</head>
...
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <!--<li>-->
                                ...
                                <!--<ul class="menu">-->
                                    <!--<li>&lt;!&ndash; start message &ndash;&gt;-->
                                        <!--<a href="#">-->
                                            <!--<div class="pull-left">-->
                                                <!--<img src="/addons/yztc_sun/public/static/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">-->
                                            <!--</div>-->
                                            <!--<h4>-->
                                                <!--Support Team-->
                                    ...
                                    <!--<li>-->
                                        <!--<a href="#">-->
                                            <!--<div class="pull-left">-->
                                                <!--<img src="/addons/yztc_sun/public/static/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">-->
                                            <!--</div>-->
                                            <!--<h4>-->
                                    ...
                                    <!--<li>-->
                                        <!--<a href="#">-->
                                            <!--<div class="pull-left">-->
                                                <!--<img src="/addons/yztc_sun/public/static/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">-->
                                            <!--</div>-->
                                            <!--<h4>-->
                                                <!--Developers-->
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php if($admin['img']): ?>/attachment/<?php echo $admin['img']; else: ?>/addons/yztc_sun/public/static/dist/img/user2-160x160.jpg<?php endif; ?>" class="user-image" alt="">
                    ...
                    <li>
                        ...
                        <a href="/addons/yztc_sun/admin/index.php?c=user&a=login&" title="退出系统" style="font-size: 20px;">
                            <i class="fa fa-home"></i>
                        </a>
                        <?php else: if(isset($GLOBALS["new_framework"])): ?>
    ...
    <div class="control-sidebar-bg"></div>
	 ...
	 <div class="container-fluid footer text-center" role="footer">
        ...
        <div class="copyright"><?php if(empty($_W['setting']['copyright']['footerleft'])): ?>Powered by <a href="http://www.we7.cc"><b>微擎</b></a>  &copy; 2014-2015 <a href="http://www.we7.cc">www.we7.cc</a><?php else: ?><?php echo $_W['setting']['copyright']['footerleft']; endif; ?></div>
    ...
    <?php if(!empty($_W['setting']['copyright']['statcode'])): ?><?php echo $_W['setting']['copyright']['statcode']; endif; if(!empty($_GPC['m']) && !in_array($_GPC['m'], array('keyword', 'special', 'welcome', 'default', 'userapi')) || defined('IN_MODULE')): ?>
    <script>
...
<!-- Bootstrap 3.3.7 -->
<script src="/addons/yztc_sun/public/static/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="/addons/yztc_sun/public/static/dist/js/adminlte.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="/addons/yztc_sun/public/static/dist/js/demo.js"></script>
