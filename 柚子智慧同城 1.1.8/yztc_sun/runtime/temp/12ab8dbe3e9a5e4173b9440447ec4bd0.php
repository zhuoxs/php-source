<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cpanic/index.html";i:1555309810;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use(['table','form'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'panic_price', width:100, title: '抢购价',sort:true},
                {field:'vip_price', width:100, title: '会员价',sort:true},
                {field:'sales_num', width:100, title: '销售量',sort:true},
                {field:'read_num', width:100, title: '浏览量',sort:true},
        ...
        $('#btnBatchEnable').click(function () {
            ...
            if (data.length > 0){
                ...
                var url = "<?php echo adminurl('batchenable'); ?>";
                $.post(url, {ids:ids.join(','),type:2}, function(data){
                    if (typeof data == 'string'){
                        data = $.parseJSON(data);
                    }
                    if (data.code == 0) {
        ...
        $('#btnBatchOnlyVip').click(function () {
            ...
            if (data.length > 0){
                ...
                var url = "<?php echo adminurl('batchonlyvip'); ?>";
                $.post(url, {ids:ids.join(',')}, function(data){
                    if (typeof data == 'string'){
                        data = $.parseJSON(data);
                    }
        ...
        $('#btnBatchUnOnlyVip').click(function () {
            ...
            if (data.length > 0){
                ...
                var url = "<?php echo adminurl('batchunonlyvip'); ?>";
                $.post(url, {ids:ids.join(',')}, function(data){
                    if (typeof data == 'string'){
                        data = $.parseJSON(data);
                    }
        ...
        $('#btnBatchWelfare').click(function () {
            ...
            if (data.length > 0){
                ...
                var url = "<?php echo adminurl('batchwelfare'); ?>";
                $.post(url, {ids:ids.join(',')}, function(data){
                    if (typeof data == 'string'){
                        data = $.parseJSON(data);
                    }
        ...
        $('#btnBatchUnWelfare').click(function () {
            ...
            if (data.length > 0){
                ...
                var url = "<?php echo adminurl('batchunwelfare'); ?>";
                $.post(url, {ids:ids.join(',')}, function(data){
                    if (typeof data == 'string'){
                        data = $.parseJSON(data);
                    }
        ...
        form.on('switch(is_activity)', function(obj){
            if (obj.elem.checked){
                var url = "<?php echo adminurl('btnBatchAddActivity'); ?>";
                var msg = "启用";
            }else{
                var url = "<?php echo adminurl('btnBatchDelActivity'); ?>";
                var msg = "关闭";
            }
            console.log(obj);
            $.post(url, {ids:obj.value}, function(data){
