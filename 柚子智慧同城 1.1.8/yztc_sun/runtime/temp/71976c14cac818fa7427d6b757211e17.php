<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cuser/memberrule.html";i:1553823369;s:94:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/editnosub.html";i:1553823404;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" method="post" action="<?php echo adminurl('savememberrule'); ?>">
    <div class="layui-form-item">
        <label class="layui-form-label">会员卡封面图</label>
        <div class="layui-input-block">
            <?php echo tpl_form_field_image('member_pic', isset($info['member_pic'])?$info['member_pic']:'','/web/resource/images/nopic.jpg'); ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <?php echo tpl_form_field_color('member_bg_color', $info['member_bg_color']) ?>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">会员卡卡号颜色</label>
        <div class="layui-input-block">
            <?php echo tpl_form_field_color('member_font_color', $info['member_font_color']) ?>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">会员须知</label>
        <div class="layui-input-block">
            <?php echo tpl_ueditor('member_rule', $info['member_rule']); ?>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    ...
    layui.use(['element','form'], function(){
        ...
        form.on('submit', function(data){
            ...
            var data = data.field;
            console.log(data);
            var url = "<?php echo adminurl('savememberrule'); ?>";
