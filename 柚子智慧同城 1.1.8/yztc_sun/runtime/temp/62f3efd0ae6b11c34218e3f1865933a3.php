<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cad/edit.html";i:1553823430;s:89:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/edit.html";i:1553823405;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        ...
        <img class="type-ad" id="ad_style" style="margin-top: 10px;display: none;" src="/addons/yztc_sun/public/static/images/ad_style.png">
    </div>
</div>
<div class="layui-form-item">
    <label class="layui-form-label">标题</label>
    <div class="layui-input-block">
        <input autocomplete="off" type="text" name="title" lay-verify="required" placeholder="请输入标题" class="layui-input" value="<?php echo isset($info['title'])?$info['title']:''; ?>">
    </div>
</div>
<div class="layui-form-item">
    <label class="layui-form-label">排序</label>
    <div class="layui-input-block">
        <input autocomplete="off" type="text" name="sort" placeholder="请输入排序" class="layui-input"  value="<?php echo isset($info['sort'])?$info['sort']:''; ?>">
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <textarea name="memo" placeholder="请输入备注" class="layui-textarea"><?php echo isset($info['memo'])?$info['memo']:''; ?></textarea>
    </div>
</div>
<script>
    require(['select2'], function () {
        ...
        //广告类型
        var ret = <?php echo \enum\AdType::getList4Select() ?>;
