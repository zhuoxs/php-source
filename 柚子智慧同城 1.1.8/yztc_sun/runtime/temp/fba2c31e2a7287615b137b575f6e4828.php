<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/cstore/index.html";i:1553823376;s:90:"/www/wwwroot/app.jishuizhibei.com/addons/yztc_sun/application/admin/view/common/index.html";i:1553823402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            ,cols: [[
              ...
              /*  {field:'pic', width:80, title: '封面图',sort:true,templet: '#dataPic'},*/
                {field:'contact', width:120, title: '联系人',sort:true},
                {field:'tel', width:120, title: '联系电话',sort:true},
                {field:'goods_count', width:180, title: '商品数量',sort:true},
                {field:'sale_count', width:180, title: '已售商品数量',sort:true},
