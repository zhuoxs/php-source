...
$info=pdo_get('yzkm_sun_kanjia_banner',array('uniacid'=>$_W['uniacid']));
if($info['img']){
    $img = $info['img'];
}
if($info['img1']){
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        $res=pdo_insert('yzkm_sun_kanjia_banner',$data);
        ...
        $res = pdo_update('yzkm_sun_kanjia_banner', $data, array('id' => $_GPC['id']));
