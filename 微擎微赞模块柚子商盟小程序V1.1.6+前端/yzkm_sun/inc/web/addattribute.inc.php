...
$GLOBALS['frames'] = $this->getMainMenu();
	$info = pdo_get('yzkm_sun_goods_spec',array('uniacid' => $_W['uniacid'],'id'=>$_GPC['id']));
		if(checksubmit('submit')){
			...
			if($_GPC['id']==''){				
				$res=pdo_insert('yzkm_sun_goods_spec',$data);
				if($res){
				...
				$res = pdo_update('yzkm_sun_goods_spec', $data, array('id' => $_GPC['id']));
				if($res){
