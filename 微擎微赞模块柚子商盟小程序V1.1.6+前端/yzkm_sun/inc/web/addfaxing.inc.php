...
$GLOBALS['frames'] = $this->getMainMenu();
	$info = pdo_get('yzkm_sun_hairers',array('uniacid' => $_W['uniacid'],'id'=>$_GPC['id']));
...
//			p($data);die;
			if($_GPC['id']==''){				
				$res=pdo_insert('yzkm_sun_hairers',$data);
				if($res){
				...
				$res = pdo_update('yzkm_sun_hairers', $data, array('id' => $_GPC['id']));
				if($res){
