    ...
    <form class="layui-form layui-form-pane" action="{:url('')}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  class="layui-input" name="name" autocomplete="off" placeholder="请填写礼物名字" value="{$info['name']}">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline upload">
                ...
                <input type="hidden" class="upload-input" name="images" id="images" value="{$info['images']}">
                <img id="img_ico" onmouseover="imgTips(this,{width:100,className:'imgTips'})" src="{$info['images']}" style="border-radius:5px;border:1px solid #ccc" width="36" height="36">
            </div>
            <div class="layui-form-mid layui-word-aux"></div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  class="layui-input" name="sort" autocomplete="off" placeholder="请填写排序值" value="{$info['sort']}">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  class="layui-input" name="price" autocomplete="off" placeholder="请填写套餐价格" value="{$info['price']}">
            </div>
