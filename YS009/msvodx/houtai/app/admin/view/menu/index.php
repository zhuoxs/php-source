...
<form class="page-list-form">
    ...
    <dl class="menu-dl1">
        <dt>
            ...
            <div class="menu-btns">
                <a href="{:url('edit?id='.$vv['id'])}" title="编a辑"><i class="layui-icon">&#xe642;</i></a>
        ...
        <dd>
            ...
            <dl class="menu-dl2">
                <dt>
                    ...
                    <div class="menu-btns">
                        <a href="{:url('edit?id='.$vvv['id'])}" title="编b辑"><i class="layui-icon">&#xe642;</i></a>
                ...
                <dd>
                    ...
                    <div class="menu-btns">
                        <a href="{:url('edit?id='.$vvvv['id'])}" title="编c辑"><i class="layui-icon">&#xe642;</i></a>
