...
<form  class="page-list-form layui-form layui-form-pane" style=" margin-left: 20px;" method="post" id="saveImgForm">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                ...
                <input type="hidden" value="2" name="type" id="code">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="titles" value="" autocomplete="off" >
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="info" value="" autocomplete="off" >
            </div>
    ...
    <div class="layui-form-item code1">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="content"  id="titlepic"  value="" autocomplete="off" >
            </div>
            <div class="layui-input-inline">
    ...
    <div class="layui-form-item code2" style="display: none;">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <textarea type="text" class="layui-input" name="code" value="" autocomplete="off" ></textarea>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="url" value="" autocomplete="off" >
            </div>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="date"  class="layui-input" id="test6" value="{:date('Y-m-d',time())} - {:date('Y-m-d',time())}" placeholder="{:date('Y-m-d',time())} - {:date('Y-m-d',time())}">
            </div>
        </div>
    <div class="layui-form-item">
