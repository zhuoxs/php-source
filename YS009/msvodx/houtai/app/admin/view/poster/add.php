...
<form  class="page-list-form layui-form layui-form-pane" style=" margin-left: 20px;" method="post" id="saveImgForm">
    ...
    <div class="layui-form-item">
        <div class="layui-word-aux"><b>说明</b>：添加广告位</div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" name="title" id="playtime" id="playtime" value="" autocomplete="off" >
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="width"  value="" autocomplete="off" >
            </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="height" value="" autocomplete="off" >
            </div>
