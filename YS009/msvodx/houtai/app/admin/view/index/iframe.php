                ...
                <li class="layui-nav-item {if condition="$kk eq 1"}layui-nav-itemed{/if}">
                    ...
                    <dl class="layui-nav-child">
                        {if condition="$vv['title'] eq '快捷菜单'"}
                            <dd><a class="admin-nav-item" data-id="0" href="{:url('admin/index/welcome')}" target="_blank">后台首页</a></dd>
							 <?php
							 	$web_server=x_get_webseting('web_server_url');
    ?>
							<dd><a class="" data-id="346" href="{$web_server}" target="_blank">浏览前台</a></dd>
