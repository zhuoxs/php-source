...
CREATE TABLE `ms_admin_annex_group`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 附件分组' ROW_FORMAT = Compact;
...
CREATE TABLE `ms_admin_config`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 83 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 系统配置' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of ms_admin_config
-- ----------------------------
INSERT INTO `ms_admin_config` VALUES (1, 'base', '网站logo', 'site_logo', 'http://oz58x3ytv.bkt.clouddn.com/rzecqjpham5retfhk6tipb07bc6cdv3d.png', '网站LOGO图片');
...
INSERT INTO `ms_admin_config` VALUES (6, 'base', 'ICP备案信息', 'site_icp', '粤ICP100030132', 'ICP备案号，用于展示在网站底部');
...
INSERT INTO `ms_admin_config` VALUES (31, 'attachment', '云转码播放密钥', 'yzm_play_secretkey', 'msvod', '防盗密钥需与云转码后台设置的保持一致,无设置请留空.(系统设置->防盗设置->防盗密钥)');
...
INSERT INTO `ms_admin_config` VALUES (53, 'email', '发送者邮箱账号', 'send_email', 'msvodx@163.com', '发送者邮箱账号');
INSERT INTO `ms_admin_config` VALUES (54, 'email', '邮箱密码', 'email_password', 'msvodx888', '发送者邮箱密码');
INSERT INTO `ms_admin_config` VALUES (55, 'email', '端口号', 'email_port', '25', '邮箱服务器端口号');
INSERT INTO `ms_admin_config` VALUES (56, 'email', '发送者email地址', 'from_email', 'msvodx@163.com', '发送者email地址');
...
INSERT INTO `ms_admin_config` VALUES (67, 'sms', '短信api账号', 'sms_api_account', 'N3806228', '短信接口账号 ');
...
INSERT INTO `ms_admin_config` VALUES (72, 'video', '云转码播放域名', 'yzm_video_play_domain', 'http://ms.92xj.net:2000', NULL);
...
INSERT INTO `ms_admin_config` VALUES (76, 'base', '手机网站logo', 'site_logo_mobile', 'http://www.msvodx.com/XResource/20180123/WfbNjKzYH56nehtwhz8mWbQx3s6z7pYi.png', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 钩子表' ROW_FORMAT = Compact;
...
CREATE TABLE `ms_admin_log`  (
  ...
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `url` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  ...
  `ip` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `ctime` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `mtime` int(10) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 操作日志' ROW_FORMAT = Compact;
...
CREATE TABLE `ms_admin_member`  (
  ...
  `ctime` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1000001 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 会员表' ROW_FORMAT = Compact;
...
CREATE TABLE `ms_admin_member_level`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '等级名称',
  ...
  `intro` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '等级简介',
  ...
  `mtime` int(10) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 会员等级' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 模块' ROW_FORMAT = Compact;
...
CREATE TABLE `ms_admin_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 管理角色' ROW_FORMAT = Compact;
...
CREATE TABLE `ms_advertisement_position`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '广告位表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_agent_apply`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员代理审核记录表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_atlas`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 605 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '相册表(图集表)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_atlas_good_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 26 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '图集收藏日志表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_atlas_watch_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 84 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '相册观看日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_banner`  (
  ...
  `target` int(1) DEFAULT 1 COMMENT '是否新页面打开1为是，0为否',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '首页banner配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ms_banner
-- ----------------------------
INSERT INTO `ms_banner` VALUES (6, '首页AD', 'http://sp.msvodx.com/XResource/20180209/sSypyBEXkbZcCXjDhsyD4rpcA26azH4j.png', 'http://www.msvod.cc/', 3, 1, '1', 1);
...
CREATE TABLE `ms_card_password`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2034 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_class`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 46 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源分类表(视频|小说|图片)' ROW_FORMAT = Dynamic;
...
INSERT INTO `ms_class` VALUES (10, '欧美频道', 0, 0, 1, 1516254918, '0', '0', 1, 1);
INSERT INTO `ms_class` VALUES (11, '王者荣耀', 1, 8, 3, 1513908860, '0', '0', 1, 1);
INSERT INTO `ms_class` VALUES (12, '性感美女', 6, 0, 2, 1516421298, '0', '0', 1, 1);
...
INSERT INTO `ms_class` VALUES (16, '玄幻小说', 0, 0, 3, 1513909479, '0', '0', 1, 0);
INSERT INTO `ms_class` VALUES (17, '言情小说', 0, 0, 3, 1513909492, '0', '0', 1, 0);
INSERT INTO `ms_class` VALUES (18, '绝地逢生', 0, 8, 3, 1513908874, '0', '0', 1, 1);
INSERT INTO `ms_class` VALUES (22, '性感车模', 0, 0, 2, 1516421391, '0', '0', 1, 0);
INSERT INTO `ms_class` VALUES (23, '沙滩美女', 0, 0, 2, 1516437912, '0', '0', 1, 0);
INSERT INTO `ms_class` VALUES (25, '国内新闻', 0, 15, 3, 1513908932, '0', '0', 1, 1);
INSERT INTO `ms_class` VALUES (27, '舞蹈视频', 0, 0, 1, 1513910194, '0', '0', 1, 0);
INSERT INTO `ms_class` VALUES (8, '游戏攻略', 6, 0, 3, 1513908844, '0', '0', 1, 1);
...
CREATE TABLE `ms_comment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 496 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统评论表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_draw_money_account`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 29 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '提现帐户信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_draw_money_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 62 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '提现记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_gift`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '打赏奖品表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_gold_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 506 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '金币明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_gratuity_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 305 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '打赏记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_image`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 8543 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '图片表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_image_collection`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 146 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '图片收藏表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 714 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登陆日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_login_setting`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '支付配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ms_login_setting
-- ----------------------------
INSERT INTO `ms_login_setting` VALUES (1, 'qq', 'QQ登录', '[{\"name\":\"APPID\",\"type\":\"text\",\"value\":\"101459043\",\"desc\":\"APPID\"},{\"name\":\"APPKey\",\"type\":\"text\",\"value\":\"ee4f10c0c0404bf61de486cf1ec717be\",\"desc\":\"APPKey\"}]', 0, 1514888879, 1519263473);
...
CREATE TABLE `ms_member`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 70 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `ms_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 47 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '前端菜单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_novel`  (
  ...
  `is_check` int(1) DEFAULT 0 COMMENT '是否审核 。1审核通过，2审核未通过，0待审核',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 53 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '小说表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_novel_collection`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 46 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '小说收藏表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_novel_good_log`  (
  ...
  `add_time` int(10) DEFAULT NULL COMMENT '点赞时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '小说收藏日志表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_novel_watch_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 94 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '小说阅读日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_recharge_package`  (
  ...
  `info` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '说明',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'vip套餐表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_share_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分享日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_sign`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 81 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员签到日志表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_tag`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源标签表(视频|小说|图片)' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ms_tag
-- ----------------------------
INSERT INTO `ms_tag` VALUES (1, '王者荣耀', 1, 1, 1);
INSERT INTO `ms_tag` VALUES (3, '美女图片', 2, 2, 1);
INSERT INTO `ms_tag` VALUES (5, '战争', 0, 3, 1);
INSERT INTO `ms_tag` VALUES (10, '军事', 0, 3, 1);
INSERT INTO `ms_tag` VALUES (11, '王者荣耀', 1, 2, 1);
...
CREATE TABLE `ms_user_atlas`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 60 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员自定义相册表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_video`  (
  ...
  `is_check` int(1) DEFAULT 0 COMMENT '是否审核 。1审核通过，2审核未通过，0待审核',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 699 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '视频表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ms_video
-- ----------------------------
INSERT INTO `ms_video` VALUES (30, '因为是春天MusicFilm-Jessica', '', '', '', 'http://ms.92xj.net:2100/20180118/myr4W07k/index.m3u8', 'http://ms.92xj.net:2100/20180118/myr4W07k/index.m3u8', 1516329866, 1517371370, '00:03:50', 5164, 0, 'http://ms.92xj.net:2100/20180118/gU6Nrz3d/1.jpg', 0, '9', '1', 1, 0, 0, '', 10, 1, 0, 1);
...
CREATE TABLE `ms_video_collection`  (
  ...
  `collection_time` int(10) DEFAULT 0 COMMENT '收藏时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 71 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '视频收藏表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_video_good_log`  (
  ...
  `add_time` int(10) DEFAULT NULL COMMENT '点赞时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 71 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '视频点赞记录表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_video_watch_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1021 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '视频观看日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_website_group_setting`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '站群配置表' ROW_FORMAT = Dynamic;


-- ----------------------------
-- Table structure for ms_domain_cname_binding
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ms_domain_cname_binding`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '域名绑定表' ROW_FORMAT = Dynamic;
