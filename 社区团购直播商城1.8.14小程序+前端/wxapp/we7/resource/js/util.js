...
util.base64Encode = function(e) {
    ...
    var e = function() {
        ...
        wx.login({
            success: function(e) {
                util.getWe7User(function(t) {
                    a ? util.upadteUser(a, function(e) {
                        "function" == typeof n && n(e);
                    }) : wx.getSetting({
                        success: function(e) {
                            1 == e.authSetting["scope.userInfo"] ? wx.getUserInfo({
                                withCredentials: !0,
                                success: function(e) {
    ...
    e = e.title), t) {
        ...
        r = t.substring(9)) : "reLaunch:" == a ? (r = t.substring(9), i = "reLaunch") : (r = t, 
        i = "redirectTo");
    }
