...
class Order extends Model
{
    ...
    {
        return $this->belongsTo('driverOrder', 'id','order_id')->field('order_id,driver_id,create_time,end_time,picture');
    }

    
    public function getStatusList()
    {
        return [ '7' => __('Status 7'),'1' => __('Status 1'), '2' => __('Status 2'), '3' => __('Status 3'), '4' => __('Status 4'), '5' => __('Status 5'), '6' => __('Status 6')];
    }
