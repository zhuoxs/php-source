<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:99:"/www/wwwroot/wushanw.com/addons/make_freight/core/public/../application/admin/view/index/index.html";i:1562722714;s:89:"/www/wwwroot/wushanw.com/addons/make_freight/core/application/admin/view/common/meta.html";i:1562722739;s:91:"/www/wwwroot/wushanw.com/addons/make_freight/core/application/admin/view/common/header.html";i:1562722740;s:89:"/www/wwwroot/wushanw.com/addons/make_freight/core/application/admin/view/common/menu.html";i:1562722740;s:92:"/www/wwwroot/wushanw.com/addons/make_freight/core/application/admin/view/common/control.html";i:1562722741;s:91:"/www/wwwroot/wushanw.com/addons/make_freight/core/application/admin/view/common/script.html";i:1562722738;}*/ ?>
<!DOCTYPE html>
...
<a href="javascript:;" class="logo">
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini"><?php if(isset($admin_title['value'])): ?><?php echo mb_strtoupper(mb_substr($admin_title['value'],0,4,'utf-8'),'utf-8'); endif; ?></span>
    <!-- 普通模式下Logo -->
    <span class="logo-lg"><b><?php if(isset($admin_title['value'])): ?><?php echo $admin_title['value']; ?></b><?php echo mb_substr($site['name'],4,null,'utf-8'); endif; ?></span>
</a>
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="<?php echo tp_url('index/index'); ?>" ><i class="fa fa-home" style="font-size:14px;"></i></a>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo tp_url('index/logout'); ?>" class="btn btn-danger"><i class="fa fa-sign-out"></i>
...
<section class="sidebar">
    <!-- 管理员信息 -->
    <div class="user-panel hidden-xs" style="display: flex;flex-direction: row;align-items: center">
    ...
    <ul class="sidebar-menu <?php if($config['fastadmin']['multiplenav']): ?>show-submenu<?php endif; ?>">
        ...
        <?php echo $menulist; ?>
            ...
            <!-- 底部链接,默认隐藏 -->
            <?php if(empty($_w_copyright)): ?>
            <footer class="main-footer " style="border-top: 1px solid #ffffff;background: #f1f4f6">
                ...
                <div class="container-fluid footer text-center" role="footer" >
                    <div class="copyright">
                        <span>Powered by </span><a href=" "><b>微擎</b></a>
                        <span > v2.0.7</span>
                        <span >  &copy; 2014-2019 www.w7.cc</span>
                    </div>
                </div>
            </footer>
            <?php endif; ?>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="control-sidebar-setting-tab">
            ...
            <ul class="list-unstyled clearfix skin-list">
                ...
                <li>
                    <a href="javascript:;" data-skin="skin-black" style="" class="clearfix full-opacity-hover">
                        <div>
                            <span style="display:block; width: 20%; float: left; height: 7px; background: #1f1f1f;"></span>
                            <span class="bg-light-black" style="display:block; width: 80%; float: left; height: 7px;"></span>
                        </div>
                        <div>
                            <span style="display:block; width: 20%; float: left; height: 20px; background: #222d32;"></span>
                            <span style="display:block; width: 80%; float: left; height: 20px; background: #f4f5f7;"></span>
                ...
                <li>
                    <a href="javascript:;" data-skin="skin-pink" style="" class="clearfix full-opacity-hover">
                        <div>
                            <span style="display:block; width: 20%; float: left; height: 7px; background: #eb6f94;"></span>
                            <span class="bg-light-black" style="display:block; width: 80%; float: left; height: 7px;"></span>
                        </div>
                        <div>
                            <span style="display:block; width: 20%; float: left; height: 20px; background: #eb6f94;"></span>
                            <span style="display:block; width: 80%; float: left; height: 20px; background: #f4f5f7;"></span>
                        </div>
                    </a>
