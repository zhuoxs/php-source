<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:113:"D:\phpStudy\PHPTutorial\WWW\we30\addons\make_freight\core\public/../application/common\view\tpl\dispatch_jump.tpl";i:1562722668;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    <div class="image">
        <img src="/we30/addons/make_freight/core/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
    </div>
    <h1><?php echo $msg; ?></h1>
    <?php if($url): ?>
        <p class="jump">
    ...
    <?php endif; ?>
    <p class="clearfix">
        <a href="<?php echo tp_url('admin/index/index'); ?>" class="btn btn-grey"><?php echo __('Go back'); ?></a>
        <?php if($url): ?>
