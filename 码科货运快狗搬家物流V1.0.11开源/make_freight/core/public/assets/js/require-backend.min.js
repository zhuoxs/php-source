            ...
            formatter: {
                ...
                normal: function (value, row, index) {
                    ...
                    if (this.operate != false) {
                        html = '<a href="javascript:;" class="searchit" data-toggle="tooltip" title="" data-field="' + this.field + '" data-value="' + value + '">' + html + '</a>';
                    }
                    return html;
                },
                toggle: function (value, row, index) {
                    ...
                    return "<a href='javascript:;' data-toggle='tooltip' title='' class='btn-change' data-id='"
                ...
                flag: function (value, row, index) {
                    ...
                    $.each(arr, function (i, value) {
                        ...
                        html.push('<a href="javascript:;" class="searchit" data-toggle="tooltip" title="" data-field="' + field + '" data-value="' + value + '"><span class="label label-' + color + '">' + display + '</span></a>');
                    });
                    return html.join(' ');
                },
