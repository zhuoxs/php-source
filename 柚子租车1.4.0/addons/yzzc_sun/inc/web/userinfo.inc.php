...
$info=pdo_get('yzzc_sun_integralset',array('uniacid'=>$_W['uniacid']));
...
if(checksubmit('submit')){
    ...
    if($info==''){
        $res = pdo_insert('yzzc_sun_integralset', $data,array('uniacid'=>$_W['uniacid']));
        ...
        $res = pdo_update('yzzc_sun_integralset', $data, array('uniacid'=>$_W['uniacid']));
    }
    if($res){
