...
$item=pdo_get('yzzc_sun_we',array('uniacid'=>$_W['uniacid']));
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        $res=pdo_insert('yzzc_sun_we',$data,array('uniacid'=>$_W['uniacid']));
        ...
        $res = pdo_update('yzzc_sun_we', $data, array('id' => $_GPC['id']));
        if($res){
