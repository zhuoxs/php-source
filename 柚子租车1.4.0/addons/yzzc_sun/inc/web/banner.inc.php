...
$infos=pdo_get('yzzc_sun_banner',array('uniacid' => $_W['uniacid']));
if($infos['lb_imgs']){
...
$info=pdo_get('yzzc_sun_system',array('uniacid' => $_W['uniacid']));
if(checksubmit('submit')){
    ...
    $set['open_fj'] = $_GPC['open_fj'];
    $set['open_ys'] = $_GPC['open_ys'];
    $set['index_haibao_pic'] = $_GPC['index_haibao_pic'];
    ...
    $set['foot_font_color_one']=$_GPC['foot_font_color_one']?$_GPC['foot_font_color_one']:'#333';
    $set['foot_font_color_two']=$_GPC['foot_font_color_two']?$_GPC['foot_font_color_two']:'#ffb62b';
    if($_GPC['id']==''){
        $res1=pdo_insert('yzzc_sun_system', $set);
    }else{
        $res2=pdo_update('yzzc_sun_system', $set, array('id' => $_GPC['id']));
    }
    if($_GPC['bid']==''){
        $res=pdo_insert('yzzc_sun_banner',$data);
    }else{
        $res3 = pdo_update('yzzc_sun_banner', $data, array('id' => $_GPC['bid']));
    }
