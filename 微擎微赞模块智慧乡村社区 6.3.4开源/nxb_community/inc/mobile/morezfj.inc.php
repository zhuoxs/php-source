<?php
	...
	$res = pdo_fetchall("SELECT a.*,b.avatar,b.nickname FROM " . tablename('bc_community_news') . " as a left join ".tablename('bc_community_member')." as b on a.mid=b.mid WHERE a.weid=" . $_W['uniacid'] . $cxtj." ORDER BY nid DESC LIMIT  ". $num . ",{$psize}");	
