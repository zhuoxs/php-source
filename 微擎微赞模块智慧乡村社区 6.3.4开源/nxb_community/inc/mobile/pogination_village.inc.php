<?php
	...
	$res = pdo_fetchall("SELECT a.*,b.avatar,b.nickname,b.realname,b.grade FROM " . tablename('bc_community_news') . " as a left join ".tablename('bc_community_member')." as b on a.mid=b.mid WHERE a.weid=" . $_W['uniacid'] . $cxtj." AND status=0 AND a.menpai=".$villageid." ORDER BY top DESC,nid DESC LIMIT  ". $num . ",{$psize}");	
					...
					.'<div class="mui-col-xs-10 pt1 pb1">'
						.'<div class="mui-row">'
								.'<div class="mui-col-xs-6 text_overflow1">'
									...
									$ht.='</span><span class="ulev-1 t-gra pl05">('.getrolename($item['grade']);
