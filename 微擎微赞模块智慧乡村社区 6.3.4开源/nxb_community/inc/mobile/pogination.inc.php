<?php
	...
	$res = pdo_fetchall("SELECT a.*,b.avatar,b.nickname,b.realname,b.grade FROM " . tablename('bc_community_news') . " as a left join ".tablename('bc_community_member')." as b on a.mid=b.mid WHERE a.weid=" . $_W['uniacid'] . $cxtj." AND status=0 AND a.danyuan=".$townid." ORDER BY top DESC,nid DESC LIMIT  ". $num . ",{$psize}");	
