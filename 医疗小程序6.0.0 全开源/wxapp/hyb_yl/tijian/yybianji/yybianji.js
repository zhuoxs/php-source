...
Page({
    ...
    onLoad: function(t) {
        var e = t.tt_id, n = t.ty_id, a = wx.getStorageSync("openid");
        this.setData({
            openid: a
        }), this.getTijian_yuyue(e, n);
    },
    onReady: function() {},
    onShow: function() {},
    onHide: function() {},
    ...
    formSubmit: function(n) {
        var t = this.data.tijian_yuyue.ty_name, a = this.data.tt_money;
        console.log(a);
        var o = wx.getStorageSync("openid");
        console.log(t), 0 == n.detail.value.tjyy_name.length || 0 == n.detail.value.tjyy_shenfenzheng.length || 0 == n.detail.value.tjyy_telphone.length ? wx.showModal({
