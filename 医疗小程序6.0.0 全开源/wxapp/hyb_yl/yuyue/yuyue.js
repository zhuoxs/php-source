...
Page((_defineProperty(_Page = {
    ...
    bindPickerChange1: function(e) {
        var a = this, t = e.detail.value, n = a.data.ids[t];
    ...
    bindPickerChange2: function(e) {
        var a = this, t = e.detail.value, n = a.data.monery, o = a.data.doctorId;
        a.setData({
            indexx: t,
            monerynum: n[t],
            onlyId: o[t]
...
_defineProperty(_Page, "onShareAppMessage", function() {}), _defineProperty(_Page, "formSubmit", function(t) {
    var n = this.data.onlyId;
    console.log(n);
    var e = t.detail.value.ky_docmoney, a = t.detail.value, o = a.ky_name, i = (a.k_name, 
    wx.getStorageSync("openid")), l = a.ky_telphone, c = a.ky_time_1, d = a.ky_doctor, s = a.ky_docmoney, r = a.ky_sex;
