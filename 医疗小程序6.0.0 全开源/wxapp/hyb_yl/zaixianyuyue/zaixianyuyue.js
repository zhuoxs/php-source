Page({
    ...
    bindPickerChange1: function(n) {
        for (var e = this, a = n.detail.value, o = e.data.doctor, m = e.data.array2, t = e.data.monery, i = 0; i < o.length; i++) if (a == o[i].id) for (var y = o[i].list, d = 0; d < y.length; d++) m.push(y[d].name), 
        t.push(y[d].money);
        e.setData({
