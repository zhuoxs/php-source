...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = $aliduanxin['key']; // AccessKeyId
        
        $accessKeySecret = $aliduanxin['scret']; // AccessKeySecret
    ...
    public static function sendSms() {
        ...
        $request->setSignName($aliduanxin['qianming']);


        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode($aliduanxin['moban_id']);
