...
Page({
    ...
    onLoad: function(o) {
        ...
        t ? d.setData({
            ...
            cachetime: "30",
            success: function(e) {
                wx.setStorageSync("url", e.data), t = e.data, d.setData({
                    url: t
                });
            }
        });
        ...
        d.setData({
            ...
            success: function(e) {
                ...
                var s = (e.data.shopprice - a).toFixed(2);
                d.setData({
                    goods: e.data,
                    totalprice: t,
                    price: o.price,
    ...
    chooseType: function(e) {
        ...
        var s = parseFloat(i) + parseFloat(t.data.price);
    ...
    formSubmit: function(e) {
        var a = !0, t = "", r = this, i = wx.getStorageSync("openid"), s = r.data.sincetype, o = r.data.deliveryfee, d = r.data.payType, n = r.data.time, c = r.data.uremark, p = r.data.shiptypetitle[s], l = (i = wx.getStorageSync("openid"), 
        r.data.totalprice), u = e.detail.value.id, y = e.detail.value.name, h = e.detail.value.tel, f = e.detail.value.count, g = e.detail.value.city, m = e.detail.value.detai, v = e.detail.value.province, w = e.detail.value.telnum, S = e.detail.formId;
        if ("1" == s) if (h && "" != h) if ("" == d) t = "请选择支付方式"; else {
            a = !1;
            var _ = {
                price: l,
                id: u,
