...
Page({
    ...
    onLoad: function(a) {
        ...
        var n = a.tab ? a.tab : 0, t = e.data.status[n], r = wx.getStorageSync("openid");
        app.util.request({
    ...
    toPay: function(t) {
        var a = this, e = wx.getStorageSync("openid"), o = a.data.g_order_id, n = a.data.g_f_index, r = a.data.payType, s = a.data.orderlist;
    ...
    toOrderder: function(t) {
        ...
        wx.navigateTo({
            url: "../orderdet/orderdet?order_id=" + a + "&ordertype=4"
        });
    },
    onReady: function() {},
    onShow: function() {},
    ...
    onReachBottom: function() {
        var e = this, o = e.data.curIndex, t = e.data.status[o], a = wx.getStorageSync("openid"), n = e.data.orderlist, r = e.data.page, s = r[o];
        app.util.request({
            url: "entry/wxapp/getOrder",
            cachetime: "10",
            data: {
            ...
            success: function(t) {
                if (2 == t.data) wx.showToast({
                    ...
                    var a = t.data;
                    n = n.concat(a), r[o] = s + 1, console.log(r), e.setData({
                        orderlist: n,
                        page: r
                    });
                }
    ...
    onShareAppMessage: function(t) {
        var a = this.data.gid, e = wx.getStorageSync("users"), o = this.data.rcontent, n = o.id, r = o.rname, s = this.data.orderlist[0].oid;
        if (console.log(s), "button" === t.from && console.log(t.target), 0 == a) var i = "/mzhk_sun/pages/index/index"; else i = "/mzhk_sun/pages/index/goods/goods?gid=" + a + "&rid=" + n + "&user_id=" + e.id + "&oid=" + s + "&is_redshare=1";
        return {
            title: r,
            path: i,
            success: function(t) {
    ...
    getUredpacket: function(t) {
        var a = this, e = t.currentTarget.dataset.rid, o = t.currentTarget.dataset.bid, n = t.currentTarget.dataset.unid, r = t.currentTarget.dataset.index, s = a.data.gid, i = wx.getStorageSync("openid"), d = a.data.urcontent;
        app.util.request({
