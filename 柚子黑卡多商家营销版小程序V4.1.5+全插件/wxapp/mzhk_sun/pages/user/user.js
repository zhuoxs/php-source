...
Page((_defineProperty(_Page = {
    ...
    onLoad: function(t) {
        var n = this;
        t = app.func.decodeScene(t), console.log(t), t.d_user_id && (app.distribution.distribution_parsent(app, t.d_user_id), 
        n.setData({
            options: t
        ...
        var e = n.data.navigate, i = n.data.cturl, r = n.data.ckurl2, d = n.data.fxurl, u = n.data.jfurl, s = n.data.lbqurl, c = n.data.hburl, l = n.data.ckurl, p = n.data.qyurl, g = n.data.qyurl3, m = n.data.tcurl3, y = n.data.tcurl, x = n.data.cjurl3, f = n.data.cjurl, h = n.data.cttext, w = n.data.cktext2, _ = n.data.fxtext, b = n.data.jftext, k = n.data.lbqtext, v = n.data.hbtext, S = n.data.cktext, q = n.data.qytext, P = n.data.qytext3, T = n.data.tctext, j = n.data.tctext3, z = n.data.cjtext, D = n.data.cjtext3;
        app.util.request({
            ...
            success: function(t) {
                ...
                }), t.data.myicon && (e[0].icon = a + t.data.myicon), t.data.mypticon && (e[1].icon = a + t.data.mypticon), 
                t.data.mykjicon && (e[2].icon = a + t.data.mykjicon), t.data.myjkicon && (e[3].icon = a + t.data.myjkicon), 
                t.data.myqgicon && (e[4].icon = a + t.data.myqgicon), t.data.mymdicon && (e[5].icon = a + t.data.mymdicon), 
                t.data.myyhqicon && (e[6].icon = a + t.data.myyhqicon), t.data.myzsicon && (e[7].icon = a + t.data.myzsicon), 
                t.data.mypsicon && (e[8].icon = a + t.data.mypsicon), t.data.mycticon && (i = a + t.data.mycticon), 
                t.data.myckicon2 && (i = a + t.data.myckicon2), t.data.myfxicon && (d = a + t.data.myfxicon), 
                t.data.myjficon && (u = a + t.data.myjficon), t.data.mylbqicon && (s = a + t.data.mylbqicon), 
                t.data.myhbicon && (c = a + t.data.myhbicon), t.data.myckicon && (l = a + t.data.myckicon), 
                t.data.myqyicon && (p = a + t.data.myqyicon), t.data.myqyicon2 && (g = a + t.data.myqyicon2), 
                t.data.mytcicon && (y = a + t.data.mytcicon), t.data.mytcicon2 && (m = a + t.data.mytcicon2), 
                t.data.mycjicon && (f = a + t.data.mycjicon), t.data.mycjicon2 && (x = a + t.data.mycjicon2), 
                t.data.mytext && (e[0].name = t.data.mytext), t.data.mypttext && (e[1].name = t.data.mypttext), 
                t.data.mykjtext && (e[2].name = t.data.mykjtext), t.data.myjktext && (e[3].name = t.data.myjktext), 
                t.data.myqgtext && (e[4].name = t.data.myqgtext), t.data.mymdtext && (e[5].name = t.data.mymdtext), 
                t.data.myyhqtext && (e[6].name = t.data.myyhqtext), t.data.myzstext && (e[7].name = t.data.myzstext), 
                t.data.mypstext && (e[8].name = t.data.mypstext), t.data.mycttext && (h = t.data.mycttext), 
                t.data.mycktext2 && (w = t.data.mycktext2), t.data.myfxtext && (_ = t.data.myfxtext), 
                t.data.myjftext && (b = t.data.myjftext), t.data.mylbqtext && (k = t.data.mylbqtext), 
                t.data.myhbtext && (v = t.data.myhbtext), t.data.mycktext && (S = t.data.mycktext), 
                t.data.myqytext && (q = t.data.myqytext), t.data.myqytext2 && (P = t.data.myqytext2), 
                t.data.mytctext && (T = t.data.mytctext), t.data.mytctext2 && (j = t.data.mytctext2), 
                t.data.mycjtext && (z = t.data.mycjtext), t.data.mycjtext2 && (D = t.data.mycjtext2), 
                n.setData({
            ...
            success: function(t) {
                var a, e = t.data;
                2 != e ? (a = e.mybanner ? o + e.mybanner[0].pop_img : "../../../style/images/headbg.png", 
                n.setData({
                    mybanner: a
                })) : n.setData({
    ...
    toFxCenter2: function() {
        var a = this, e = wx.getStorageSync("openid"), n = wx.getStorageSync("users"), t = a.data.options, o = a.data.istocenter;
        if (t) {
            var i = t.d_user_id;
    ...
    toPsorder: function(t) {
        wx.navigateTo({
            url: "/mzhk_sun/plugin3/delivery/psOrder/psOrder"
        });
    },
    toOrder: function(t) {
        wx.navigateTo({
    ...
    showModel: function(t) {
        var a = t.currentTarget.dataset.statu, e = wx.getStorageSync("openid"), n = this;
        app.util.request({
