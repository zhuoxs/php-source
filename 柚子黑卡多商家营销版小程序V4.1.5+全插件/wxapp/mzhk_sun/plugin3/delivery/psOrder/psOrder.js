...
Page({
    ...
    onLoad: function(a) {
        ...
        app.util.request({
            ...
            success: function(t) {
                var a, e;
                (console.log(t), 2 == t.data) ? n.setData((_defineProperty(a = {}, "list.data", []), _defineProperty(a, "curIndex", o), a)) : n.setData((_defineProperty(e = {}, "list.data", t.data), _defineProperty(e, "curIndex", o), e))
            }
    ...
    bargainTap: function(t) {
        var e = this,
            a = parseInt(t.currentTarget.dataset.index),
            n = e.data.status[a],
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                2 == t.data ? e.setData(_defineProperty({
                    orderlist: []
                }, "list.page", 0)) : e.setData((_defineProperty(a = {}, "list.data", t.data), _defineProperty(a, "list.page", 0), _defineProperty(a, "list.over", !1), a))
            }
        }), this.setData({
            curIndex: a
        })
    ...
    showPay: function(t) {
        var a = this,
            ...
            n = t.currentTarget.dataset.order_id,
            o = (a.data.newtotalprice, wx.getStorageSync("openid")),
            r = 0,
            i = "",
            s = 0;
        1 == e && (r = t.currentTarget.dataset.order_id, i = t.currentTarget.dataset.f_index, s = t.currentTarget.dataset.price), 1 == t.currentTarget.dataset.iscj && a.setData({
    ...
    toRefundcannel: function(t) {
        var e = this,
            ...
            n = t.currentTarget.dataset.f_index,
            o = e.data.list.data;
        wx.showModal({
            title: "提示",
            content: "确认取消退款吗",
    ...
    toReceipt: function(t) {
        var a = this,
            e = t.currentTarget.dataset.order_id,
            n = t.currentTarget.dataset.f_index,
            o = a.data.orderlist,
    ...
    onReachBottom: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                var a, e = t.data;
                o = o.concat(e), n.setData((_defineProperty(a = {}, "list.data", o), _defineProperty(a, "list.page", r), a))
            }
        })
    },
    onPackage: function() {
    ...
    onShareAppMessage: function(t) {
        var a = this.data.gid,
            ...
            n = this.data.rcontent,
            o = n.id,
            r = n.rname,
            i = this.data.orderlist[0].oid;
        if (console.log(i), "button" === t.from && console.log(t.target), 0 == a) var s = "/mzhk_sun/pages/index/index";
        else s = "/mzhk_sun/pages/index/package/package?id=" + a + "&rid=" + o + "&user_id=" + e.id + "&oid=" + i + "&is_redshare=1";
        return {
            title: r,
            path: s,
            success: function(t) {
    ...
    getUredpacket: function(t) {
        var a = this,
            ...
            n = t.currentTarget.dataset.bid,
            o = t.currentTarget.dataset.unid,
