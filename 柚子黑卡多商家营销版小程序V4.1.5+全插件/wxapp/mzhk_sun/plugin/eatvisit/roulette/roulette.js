    ...
    methods: {
        drawCanvas: function() {
            var t = wx.createCanvasContext("roulette", this),
                a = this.data.options,
                e = this.data.angelTo || -30,
                o = 295;
            t.translate(147.5, 147.5), t.clearRect(-o, -295, o, 295);
            var n = 2 * Math.PI / 360 * 60,
                i = 2 * Math.PI / 360 * -90,
                r = 2 * Math.PI / 360 * -90 + n;
            t.rotate(e * Math.PI / 180), t.beginPath(), t.lineWidth = 20, t.strokeStyle = a.bgOut, t.arc(0, 0, 130, 0, 2 * Math.PI), t.stroke(), t.beginPath(), t.lineWidth = 6, t.strokeStyle = a.bgMiddle, t.arc(0, 0, 120, 0, 2 * Math.PI), t.stroke();
            ...
            var c = a.bgInner;
            for (l = 0; l < 6; l++) t.beginPath(), t.lineWidth = 116, t.strokeStyle = c[l % c.length], t.arc(0, 0, 60, i, r), t.stroke(), i = r, r += n;
            var v = a.award;
            i = n / 2;
            for (l = 0; l < 6; l++) t.save(), t.rotate(i), t.font = a.font, t.fillStyle = a.fontColor, t.textAlign = "center", t.fillText(v[l].level, 0, -90), i += n, t.restore();
            t.draw()
        },
        getLottery: function() {
            var a = this,
