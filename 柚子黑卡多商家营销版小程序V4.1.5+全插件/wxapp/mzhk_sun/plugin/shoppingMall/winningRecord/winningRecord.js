...
Page({
    ...
    getMyOrder: function() {
        var o = this,
            ...
            s = o.data.page,
            d = (o.data.pagesize, o.data.all),
            t = o.data.menuTapCurrent;
        app.util.request({
            ...
            success: function(a) {
                ...
                if (1 == s) d = a.data.data;
                else for (var e in a.data.data) d.push(a.data.data[e]);
    ...
    getComplete: function() {
        var o = this,
            a = wx.getStorageSync("users").openid,
            s = o.data.page3,
            d = (o.data.pagesize, o.data.complete);
        app.util.request({
            url: "entry/wxapp/getMyOrder",
            data: {
                m: app.globalData.Plugin_scoretask,
    ...
    productsDetails: function(a) {
        var t = a.currentTarget.dataset.id,
            e = a.currentTarget.dataset.oid,
            o = a.currentTarget.dataset.lottery_type;
