...
var showdown = {}, parsers = {}, extensions = {}, globalOptions = getDefaultOpts(!0),
    flavor = {
        github: {
...
var rgxFindMatchPos = function(e, r, n, t) {
    var o, s, a, i, l, c = t || "",
        h = -1 < c.indexOf("g"),
        d = new RegExp(r + "|" + n, "g" + c.replace(/g/g, "")),
        u = new RegExp(r, c.replace(/g/g, "")),
        p = [];
    do {
        for (o = 0; a = d.exec(e);) if (u.test(a[0])) o++ || (i = (s = d.lastIndex) - a[0].length);
        else if (o && !--o) {
...
showdown.helper.matchRecursiveRegExp = function(e, r, n, t) {
    ...
    function t(e, r) {
        if (r = r || null, showdown.helper.isString(e)) {
            if (r = e = showdown.helper.stdExtName(e), showdown.extensions[e]) return console.warn("DEPRECATION WARNING: " + e + " is an old extension that uses a deprecated loading method.Please inform the developer that the extension should be updated!"), void
            function(e, r) {
    ...
    function c(e, r) {
        ...
        return r = (r = (r = (r = r.replace(/~/g, "~T")).replace(/\$/g, "~D")).replace(/\r\n/g, "\n")).replace(/\r/g, "\n"), s.smartIndentationFix && (n = (e = r).match(/^\s*/)[0].length, t = new RegExp("^\\s{0," + n + "}", "gm"), r = e.replace(t, "")), r = r, r = showdown.subParser("detab")(r, s, o), r = showdown.subParser("stripBlankLines")(r, s, o), showdown.helper.forEach(a, function(e) {
            r = showdown.subParser("runExtension")(e, r, s, o)
        }), r = showdown.subParser("hashPreCodeTags")(r, s, o), r = showdown.subParser("githubCodeBlocks")(r, s, o), r = showdown.subParser("hashHTMLBlocks")(r, s, o), r = showdown.subParser("hashHTMLSpans")(r, s, o), r = showdown.subParser("stripLinkDefinitions")(r, s, o), r = showdown.subParser("blockGamut")(r, s, o), r = showdown.subParser("unhashHTMLSpans")(r, s, o), r = (r = (r = showdown.subParser("unescapeSpecialChars")(r, s, o)).replace(/~D/g, "$$")).replace(/~T/g, "~"), showdown.helper.forEach(i, function(e) {
            r = showdown.subParser("runExtension")(e, r, s, o)
        }), r
    ...
    var n = function(e, r, n, t, o, s, a, i) {
        ...
        return "" !== d && null !== d && (d = d.replace(/"/g, "&quot;"), u += ' title="' + (d = showdown.helper.escapeCharacters(d, "*_", !1)) + '"'), u += ">" + l + "</a>"
    };
    return e = (e = (e = (e = p.converter._dispatch("anchors.before", e, r, p)).replace(/(\[((?:\[[^\]]*]|[^\[\]])*)][ ]?(?:\n[ ]*)?\[(.*?)])()()()()/g, n)).replace(/(\[((?:\[[^\]]*]|[^\[\]])*)]\([ \t]*()<?(.*?(?:\(.*?\).*?)?)>?[ \t]*((['"])(.*?)\6[ \t]*)?\))/g, n)).replace(/(\[([^\[\]]+)])()()()()()/g, n), e = p.converter._dispatch("anchors.after", e, r, p)
    ...
    return e = (e = (e = n.converter._dispatch("autoLinks.before", e, r, n)).replace(/<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)>/gi, t)).replace(/<(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi, o), r.simplifiedAutoLink && (e = (e = e.replace(/\b(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+)(?=\s|$)(?!["<>])/gi, t)).replace(/(?:^|[ \n\t])([A-Za-z0-9!#$%&'*+-/=?^_`\{|}~\.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?:$|[ \n\t])/gi, o)), e = n.converter._dispatch("autoLinks.after", e, r, n)
    ...
    return e = (e = (e = e.replace(/^[ ]{0,2}([ ]?\*[ ]?){3,}[ \t]*$/gm, t)).replace(/^[ ]{0,2}([ ]?\-[ ]?){3,}[ \t]*$/gm, t)).replace(/^[ ]{0,2}([ ]?_[ ]?){3,}[ \t]*$/gm, t), e = showdown.subParser("lists")(e, r, n), e = showdown.subParser("codeBlocks")(e, r, n), e = showdown.subParser("tables")(e, r, n), e = showdown.subParser("hashHTMLBlocks")(e, r, n), e = showdown.subParser("paragraphs")(e, r, n), e = n.converter._dispatch("blockGamut.after", e, r, n)
}), showdown.subParser("blockQuotes", function(e, t, o) {
    return e = (e = o.converter._dispatch("blockQuotes.before", e, t, o)).replace(/((^[ \t]{0,3}>[ \t]?.+\n(.+\n)*\n*)+)/gm, function(e, r) {
        var n = r;
        return n = (n = (n = n.replace(/^[ \t]*>[ \t]?/gm, "~0")).replace(/~0/g, "")).replace(/^[ \t]+$/gm, ""), n = showdown.subParser("githubCodeBlocks")(n, t, o), n = (n = (n = showdown.subParser("blockGamut")(n, t, o)).replace(/(^|\n)/g, "$1  ")).replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function(e, r) {
            var n = r;
    ...
    return e = (e = (e += "~0").replace(/(?:\n\n|^)((?:(?:[ ]{4}|\t).*\n+)+)(\n*[ ]{0,3}[^ \t\n]|(?=~0))/g, function(e, r, n) {
        var t = r,
            o = n,
            s = "\n";
        return t = showdown.subParser("outdent")(t), t = showdown.subParser("encodeCode")(t), t = (t = (t = showdown.subParser("detab")(t)).replace(/^\n+/g, "")).replace(/\n+$/g, ""), a.omitExtraWLInCodeBlocks && (s = ""), t = "<pre><code>" + t + s + "</code></pre>", showdown.subParser("hashBlock")(t, a, i) + o
    ...
    return e = (e = (e = e.replace(/&/g, "&amp;")).replace(/</g, "&lt;")).replace(/>/g, "&gt;"), e = showdown.helper.escapeCharacters(e, "*_{}[]\\", !1)
    ...
    var t = i.prefixHeaderId,
        c = isNaN(parseInt(i.headerLevelStart)) ? 1 : parseInt(i.headerLevelStart),
        r = i.smoothLivePreview ? /^(.+)[ \t]*\n={2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n=+[ \t]*\n+/gm,
        n = i.smoothLivePreview ? /^(.+)[ \t]*\n-{2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n-+[ \t]*\n+/gm;

    function h(e) {
        var r, n = e.replace(/[^\w]/g, "").toLowerCase();
        return l.hashLinkCounts[n] ? r = n + "-" + l.hashLinkCounts[n]++ : (r = n, l.hashLinkCounts[n] = 1), !0 === t && (t = "section"), showdown.helper.isString(t) ? t + r : r
    }
    return e = (e = (e = e.replace(r, function(e, r) {
        var n = showdown.subParser("spanGamut")(r, i, l),
            t = i.noHeaderId ? "" : ' id="' + h(r) + '"',
            o = "<h" + c + t + ">" + n + "</h" + c + ">";
        ...
        var t = showdown.subParser("spanGamut")(n, i, l),
            o = i.noHeaderId ? "" : ' id="' + h(n) + '"',
            s = c - 1 + r.length,
            a = "<h" + s + o + ">" + t + "</h" + s + ">";
    ...
    function n(e, r, n, t, o, s, a, i) {
        ...
        if (n = n.toLowerCase(), i || (i = ""), "" === t || null === t) {
            if ("" !== n && null !== n || (n = r.toLowerCase().replace(/ ?\n/g, " ")), t = "#" + n, showdown.helper.isUndefined(l[n])) return e;
            t = l[n], showdown.helper.isUndefined(c[n]) || (i = c[n]), showdown.helper.isUndefined(h[n]) || (o = h[n].width, s = h[n].height)
        }
        r = r.replace(/"/g, "&quot;"), r = showdown.helper.escapeCharacters(r, "*_", !1);
        var d = '<img src="' + (t = showdown.helper.escapeCharacters(t, "*_", !1)) + '" alt="' + r + '"';
        return i && (i = i.replace(/"/g, "&quot;"), d += ' title="' + (i = showdown.helper.escapeCharacters(i, "*_", !1)) + '"'), o && s && (d += ' width="' + (o = "*" === o ? "auto" : o) + '"', d += ' height="' + (s = "*" === s ? "auto" : s) + '"'), d += " />"
    }
    return e = (e = (e = u.converter._dispatch("images.before", e, r, u)).replace(/!\[([^\]]*?)] ?(?:\n *)?\[(.*?)]()()()()()/g, n)).replace(/!\[(.*?)]\s?\([ \t]*()<?(\S+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(['"])(.*?)\6[ \t]*)?\)/g, n), e = u.converter._dispatch("images.after", e, r, u)
    ...
    function i(e, r) {
        ...
        return e = (e = e.replace(/(\n)?(^[ \t]*)([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(~0|\2([*+-]|\d+[.])[ \t]+))/gm, function(e, r, n, t, o, s, a) {
            a = a && "" !== a.trim();
            var i = showdown.subParser("outdent")(o, h, d),
                l = "";
            ...
            })), r || -1 < i.search(/\n{2,}/) ? (i = showdown.subParser("githubCodeBlocks")(i, h, d), i = showdown.subParser("blockGamut")(i, h, d)) : (i = (i = showdown.subParser("lists")(i, h, d)).replace(/\n$/, ""), i = c ? showdown.subParser("paragraphs")(i, h, d) : showdown.subParser("spanGamut")(i, h, d)), i = "\n<li" + l + ">" + i + "</li>\n"
        })).replace(/~0/g, ""), d.gListLevel--, r && (e = e.replace(/\s+$/, "")), e
    }
    function o(e, t, o) {
        var s = "ul" === t ? /^ {0,2}\d+\.[ \t]/gm : /^ {0,2}[*+-][ \t]/gm,
            r = [],
            a = "";
        if (-1 !== e.search(s)) {
            ! function e(r) {
                var n = r.search(s); - 1 !== n ? (a += "\n\n<" + t + ">" + i(r.slice(0, n), !! o) + "</" + t + ">\n\n", s = "ul" === (t = "ul" === t ? "ol" : "ul") ? /^ {0,2}\d+\.[ \t]/gm : /^ {0,2}[*+-][ \t]/gm, e(r.slice(n))) : a += "\n\n<" + t + ">" + i(r, !! o) + "</" + t + ">\n\n"
            }(e);
    ...
    }) : (r = /(\n\n|^\n?)(([ ]{0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(~0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, e = e.replace(r, function(e, r, n, t) {
    ...
    for (var t = (e = (e = (e = n.converter._dispatch("paragraphs.before", e, r, n)).replace(/^\n+/g, "")).replace(/\n+$/g, "")).split(/\n{2,}/g), o = [], s = t.length, a = 0; a < s; a++) {
        var i = t[a];
        0 <= i.search(/~(K|G)(\d+)\1/g) || (i = (i = showdown.subParser("spanGamut")(i, r, n)).replace(/^([ \t]*)/g, "<p>"), i += "</p>"), o.push(i)
    }
    for (s = o.length, a = 0; a < s; a++) {
        for (var l = "", c = o[a], h = !1; 0 <= c.search(/~(K|G)(\d+)\1/);) {
            var d = RegExp.$1,
                u = RegExp.$2;
            l = (l = "K" === d ? n.gHtmlBlocks[u] : h ? showdown.subParser("encodeCode")(n.ghCodeBlocks[u].text) : n.ghCodeBlocks[u].codeblock).replace(/\$/g, "$$$$"), c = c.replace(/(\n\n)?~(K|G)\d+\2(\n\n)?/, l), /^<pre\b[^>]*>\s*<code\b[^>]*>/.test(c) && (h = !0)
        }
        o[a] = c
    }
    ...
    return e = n.converter._dispatch("spanGamut.before", e, r, n), e = showdown.subParser("codeSpans")(e, r, n), e = showdown.subParser("escapeSpecialCharsWithinTagAttributes")(e, r, n), e = showdown.subParser("encodeBackslashEscapes")(e, r, n), e = showdown.subParser("images")(e, r, n), e = showdown.subParser("anchors")(e, r, n), e = showdown.subParser("autoLinks")(e, r, n), e = showdown.subParser("encodeAmpsAndAngles")(e, r, n), e = showdown.subParser("italicsAndBold")(e, r, n), e = (e = showdown.subParser("strikethrough")(e, r, n)).replace(/  +\n/g, " <br />\n"), e = n.converter._dispatch("spanGamut.after", e, r, n)
    ...
    return e = (e = (e += "~0").replace(/^ {0,3}\[(.+)]:[ \t]*\n?[ \t]*<?(\S+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*\n?[ \t]*(?:(\n*)["|'(](.+?)["|')][ \t]*)?(?:\n+|(?=~0))/gm, function(e, r, n, t, o, s, a) {
        return r = r.toLowerCase(), l.gUrls[r] = showdown.subParser("encodeAmpsAndAngles")(n), s ? s + a : (a && (l.gTitles[r] = a.replace(/"|'/g, "&quot;")), i.parseImgDimensions && t && o && (l.gDimensions[r] = {
            width: t,
            height: o
        }), "")
    })).replace(/~0/, "")
    ...
    return e = (e = b.converter._dispatch("tables.before", e, g, b)).replace(/^[ \t]{0,3}\|?.+\|.+\n[ \t]{0,3}\|?[ \t]*:?[ \t]*(?:-|=){2,}[ \t]*:?[ \t]*\|[ \t]*:?[ \t]*(?:-|=){2,}[\s\S]+?(?:\n\n|~0)/gm, function(e) {
        ...
        for (r = 0; r < l.length; ++r) showdown.helper.isUndefined(u[r]) && (u[r] = ""), d.push((o = l[r], s = u[r], a = void 0, a = "", o = o.trim(), g.tableHeaderId && (a = ' id="' + o.replace(/ /g, "_").toLowerCase() + '"'), "<th" + a + s + ">" + (o = showdown.subParser("spanGamut")(o, g, b)) + "</th>\n"));
        for (r = 0; r < h.length; ++r) {
            for (var w = [], f = 0; f < d.length; ++f) showdown.helper.isUndefined(h[r][f]), w.push((i = h[r][f], "<td" + u[f] + ">" + showdown.subParser("spanGamut")(i, g, b) + "</td>\n"));
            p.push(w)
        }
        return function(e, r) {
