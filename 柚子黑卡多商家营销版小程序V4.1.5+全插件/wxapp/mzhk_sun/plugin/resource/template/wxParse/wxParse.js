...
function calMoreImageInfo(e, t, a, i) {
    ...
    if (n && 0 != n.images.length) {
        ...
        var f = l + ".width",
            v = l + ".height";
        a.setData((_defineProperty(r = {}, f, d.imageWidth), _defineProperty(r, v, d.imageheight), r))
    }
}
function wxAutoImageCal(e, t, a, i) {
    ...
    return realWindowHeight, (r = realWindowWidth - 2 * s) < e ? (o = (n = r) * t / e, d.imageWidth = n, d.imageheight = o) : (d.imageWidth = e, d.imageheight = t), d
}
