...
function stringToCode128(t) {
    var E, r, e, T = {
        ...
        C = i[0] == CHAR_TILDE ? 1 : 0,
        s = 0 < i.length ? codeSetAllowedFor(i[C++]) : CODESET.AB,
        S = 0 < i.length ? codeSetAllowedFor(i[C++]) : CODESET.AB;
    T.currcs = (r = S, e = 0, e += (E = s) == CODESET.A ? 1 : 0, e += E == CODESET.B ? -1 : 0, e += r == CODESET.A ? 1 : 0, 0 < (e += r == CODESET.B ? -1 : 0) ? CODESET.A : CODESET.B), T.currcs = function(t, E) {
    ...
    function D(t, E, r) {
        var e = [],
            i = -1;
        if (charCompatible(t, r)) r == CODESET.C && (-1 == E ? (i = SET_CODEB, r = CODESET.B) : -1 == E || charCompatible(E, r) || (charCompatible(E, CODESET.A) ? (i = SET_CODEA, r = CODESET.A) : (i = SET_CODEB, r = CODESET.B)));
        else if (-1 == E || charCompatible(E, r)) i = SET_SHIFT;
        else switch (r) {
            case CODESET.A:
        ...
        return -1 != i ? (e.push(i), e.push(codeValue(t))) : r == CODESET.C ? e.push(codeValue(t, E)) : e.push(codeValue(t)), T.currcs = r, e
    }
}
...
var Graphics = function(t, E, r) {
    this.width = E, this.height = r, this.quiet = Math.round(this.width / 40), this.border_size = 0, this.padding_width = 0, this.area = {
        width: E - 2 * this.padding_width - 2 * this.quiet,
        height: r - 2 * this.border_size,
        top: this.border_size - 4,
        left: this.padding_width + this.quiet
    }, this.ctx = t, this.fg = "#000000", this.bg = "#ffffff", this.fillBgRect(0, 0, E, r), this.fillBgRect(0, this.border_size, E, r - 2 * this.border_size)
};
