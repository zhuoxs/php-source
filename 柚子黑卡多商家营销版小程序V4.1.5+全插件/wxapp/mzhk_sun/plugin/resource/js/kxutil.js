...
function getSign(e, t, a) {
    var r = require("../../../we7/js/underscore.js"),
        i = require("../../../we7/js/md5.js"),
        n = "",
    ...
    for (var u = "", d = 0; d < n.length; d++) n[d] && n[d].name && n[d].value && (u += n[d].name + "=" + n[d].value, d < n.length - 1 && (u += "&"));
...
util.request = function(r) {
    ...
    var e, t = require("../../../we7/js/md5.js"),
        i = getApp();
    r = r || {};
    for (var a in r.cachetime = r.cachetime ? r.cachetime : 0, r.showLoading = void 0 === r.showLoading || r.showLoading, r.fromcache = null == r.fromcache || r.fromcache, r.data) void 0 === r.data[a] && delete r.data[a];
    var n = wx.getStorageSync("userInfo").sessionid,
        o = r.url;
    if (-1 == o.indexOf("http://") && -1 == o.indexOf("https://") && (o = util.url(o)), getUrlParam(o, "state") || r.data && r.data.state || !n || (o = o + "&state=we7sid-" + n), !r.data || !r.data.m) {
    ...
    if (r.fromcache && r.cachetime) {
        var d = wx.getStorageSync(u),
            f = Date.parse(new Date);
        if (d && d.data) {
            if (d.expire > f) return r.complete && "function" == typeof r.complete && r.complete(d), r.success && "function" == typeof r.success && r.success(d), wx.hideLoading(), wx.hideNavigationBarLoading(), !0;
    ...
    wx.request((_defineProperty(e = {
        ...
        var t = require("../../../we7/js/md5.js")(o),
            a = wx.getStorageSync(t);
        if (a && a.data) return r.success && "function" == typeof r.success && r.success(a), console.log("failreadcache:" + o), !0;
