...
function template($filename, $flag = TEMPLATE_DISPLAY)
{
    ...
    $source = IA_ROOT . "/addons/mzhk_sun_plugin_lottery/admin/themes/default/{$filename}.html";
    $compile = IA_ROOT . "/data/tpl/web/mzhk_sun_plugin_lottery/default/{$filename}.tpl.php";
