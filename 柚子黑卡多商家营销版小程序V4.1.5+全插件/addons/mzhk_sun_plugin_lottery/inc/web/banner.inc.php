...
$info=pdo_get('mzhk_sun_plugin_lottery_banner',array('uniacid'=>$_W['uniacid']));
if($info['lb_imgs']){
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        $res=pdo_insert('mzhk_sun_plugin_lottery_banner',$data,array('uniacid'=>$_W['uniacid']));
        ...
        $res = pdo_update('mzhk_sun_plugin_lottery_banner', $data, array('id' => $_GPC['id'],'uniacid'=>$_W['uniacid']));
