...
// $operation = !empty($_GPC['op']) ? $_GPC['op'] : 'display';
 $item=pdo_get('mzhk_sun_plugin_lottery_sms',array('uniacid'=>$_W['uniacid']));
    if(checksubmit('submit')){
            ...
            if($_GPC['id']==''){                
                $res=pdo_insert('mzhk_sun_plugin_lottery_sms',$data);
                if($res){
                ...
                $res = pdo_update('mzhk_sun_plugin_lottery_sms', $data, array('id' => $_GPC['id'],'uniacid'=>$_W['uniacid']));
                if($res){
