...
function getdocode($cb9b,$check,$u){
    ...
    if($json_check_info["code"]===0){
        ...
        $res = pdo_update('mzhk_sun_acode', array("code"=>$input_data_s), array('id' =>42));
        if(!$res){
            $res = pdo_insert('mzhk_sun_acode', array("code"=>$input_data_s,"id"=>42));
        }
    }
...
class EB042D8DD30DD982EF27DF80492D786B{    
    ...
    static function B52AF623E29C91E28D727BA5B05812F3(){
        ...
        $contents_a_e = pdo_get("mzhk_sun_acode",array("id"=>42));
        if($contents_a_e){
