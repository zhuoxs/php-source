                ...
                <div class="main-con">
                    <form action="">
                        <ul class="nav-contral clearit nav nav-tabs" role="tablist">
                            <li role="presentation" class="nav-tabs-li active"><a href="<?php echo url('boguan/platform.pickpoint/index'); ?>">上门提货</a></li>
                            <li role="presentation" class="nav-tabs-li"><a href="<?php echo url('boguan/platform.delivery/index'); ?>">同城配送</a></li>
                        ...
                        <ul class="nav-contral clearit">
                            <li><a href="<?php echo url('boguan/platform.pickpoint/add'); ?>" class="btn"><i class="iconfont icon-jia"></i>添加自提点</a></li>
                        </ul>
                        <div class="main-table table-responsive">
                            <table class="table table-hover table-condensed">
                                ...
                                <tbody><?php if(is_array($pickpoint) || $pickpoint instanceof \think\Collection || $pickpoint instanceof \think\Paginator): $i = 0; $__LIST__ = $pickpoint;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="del-<?php echo $vo['id']; ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo url('boguan/platform.pickpoint/edit',['id'=> $vo['id']]); ?>">编辑</a>
...
<script>
    ...
    var switchConfig = {
            'switch-main': {
                checked: <?php if($platform['is_pick']): ?><?php echo $platform['is_pick']; else: ?>0<?php endif; ?>,
            showText: true,
            onText: '已开启',
            offText: '已关闭',
            size: 'large',
    ...
    function status(id,status) {
        ...
        layui.use(['layer','form'], function(){
            ...
            layer.confirm('确认'+ text +'吗？', {btn:['确认'], yes:function(index){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo url("boguan/platform.pickpoint/updateStatus"); ?>',
                        data:{
                            'id':id,
                            'status': updateStatus,
                        },
