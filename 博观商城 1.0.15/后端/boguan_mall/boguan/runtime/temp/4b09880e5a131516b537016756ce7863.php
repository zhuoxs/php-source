<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:91:"/www/wwwroot/we7/addons/boguan_mall/boguan/application/boguan/view/platform/user/index.html";i:1553589054;s:85:"/www/wwwroot/we7/addons/boguan_mall/boguan/application/boguan/view/common/header.html";i:1554254463;s:93:"/www/wwwroot/we7/addons/boguan_mall/boguan/application/boguan/view/platform/pub/user-nav.html";i:1553589071;s:88:"/www/wwwroot/we7/addons/boguan_mall/boguan/application/boguan/view/common/copyright.html";i:1553776206;s:85:"/www/wwwroot/we7/addons/boguan_mall/boguan/application/boguan/view/common/footer.html";i:1554254463;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="utf-8">
...
<section class="main-body">
    ...
    <div class="main_navbar-nav">
        ...
        <div class="navbar-nav-nav">
            <ul>
                <li>
                    <a href="<?php echo url('boguan/platform.user/index'); ?>" <?php if($ctrl == 'Platform.user' && ($act == 'index' || $act=='add' || $act=='edit' || $act=='detail')): ?>class="action"<?php endif; ?>>
                    <span class="nav-icon">
                ...
                <!--<li>
                    <a href="<?php echo url('boguan/platform.user/clerk'); ?>" <?php if($act == 'clerk' || $act == 'postclerk'): ?>class="action"<?php endif; ?>>
                    <span class="nav-icon">
                ...
                <li>
                    <a href="<?php echo url('boguan/platform.vip/index'); ?>" <?php if($ctrl == 'Platform.vip'): ?>class="action"<?php endif; ?>>
                    <span class="nav-icon">
                ...
                <li>
                    <a href="<?php echo url('boguan/platform.integral/index'); ?>">
                    <span class="nav-icon">
                ...
                <div class="main-con clerk-list member-list user-list">
                    <form action="" method="get" enctype="multipart/form-data">
                        <ul class="nav-contral clearit">
                            ...
                            <li class="pull-right">
                                <input type="text" name="keyword"  class="right-input" placeholder="用户名/手机号" value="<?php echo input('keyword'); ?>">
                            </li>
                        </ul>
                    </form>
                    <div class="main-table table-responsive">
                        <table class="table table-hover table-condensed">
                            ...
                            <tbody><?php if(is_array($user) || $user instanceof \think\Collection || $user instanceof \think\Paginator): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo $vo['id']; ?></td>
                                <td class="min-img"><div><img src="<?php echo $vo['avatar']; ?>" ondragstart="return false" alt="" title=""></div></td>
                                <td class="title">
                                    <div class="name"><?php echo $vo['nickname']; ?></div>
                                    <!-- <div class="iphone">13800138000</div> -->
                                </td>
                                <td><?php echo checkData($vo['phone']); ?></td>
                                <td><?php if($vo['vip']['name']): ?><?php echo $vo['vip']['name']; else: ?>普通用户<?php endif; ?></td>
                                <td><?php echo $vo['integral']; ?></td>
                                <td><?php echo $vo['order_count']; ?></td>
                                <td><?php echo $vo['create_time']; ?></td>
                                <td><?php echo checkData($vo['latest_order']['pay_time'],'time'); ?></td>
                                <td>
                                    <a href="<?php echo url('boguan/platform.user/detail',['id'=> $vo['id']]); ?>">详情</a>
    ...
    function recharge(id,nickname,kind) {
        ...
        layui.use(['layer','form'], function(){
            ...
            layer.open({
                ...
                shade: 0.8,
                area: ['25%','24%'],
                content: '<?php echo url("boguan/Platform.user/recharge"); ?>?id='+ id + '&kind= '+ kind,
                /*end: function () {
                    window.location.reload();
                }*/
