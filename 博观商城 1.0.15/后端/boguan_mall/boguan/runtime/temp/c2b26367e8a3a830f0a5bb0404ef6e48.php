                ...
                <div class="main-con">
                    <form action="">
                        ...
                        <ul class="nav-contral clearit nav nav-tabs" role="tablist">
                            <li role="presentation" class="nav-tabs-li active"><a href="<?php echo url('boguan/platform.setting/index'); ?>">店铺信息</a></li>
                            <li role="presentation" class="nav-tabs-li"><a href="<?php echo url('boguan/platform.address/index'); ?>">退货地址</a></li>
                        </ul>

                        <div class="form-group col-xs-12 row">
                            <label class="control-label col-xs-6 col-sm-4">
                                <span class="text-danger">*</span>
                                <span class="text-title">店铺名称</span>
                        ...
                        <div class="form-group col-xs-12 row">
                            <label class="control-label col-xs-6 col-sm-4">
                                <span class="text-danger">*</span>
                                <span class="text-title">店铺logo</span>
                                <span class="text-danger2">:</span>
                            </label>
                            <div class="col-xs-6 col-sm-8 row input_box">
                                <ul class="pro-img" data-maxvalue="1">
                                    <?php if(checkImage($setting['logo'])): ?>
                                    <li class="ui-state-default middle_center" data-id="1">
                                        <img src="<?php echo $setting['logo']; ?>" ondragstart="return false" alt="" title="">
                                        <a href="javascript:;" class="pro-img-remove" onclick="deleteimg(this)"><i class="iconfont icon-tubiao39"></i></a>
                                    </li>
                                    <?php endif; ?>
                                </ul>

                                <a href="javascript:;" class="pro-img-add" <?php if(checkImage($setting['logo'])): ?>style="display:none;"<?php endif; ?> onclick="iconLibrary(this)" data-laymodal="product_img" data-toggle="modal" data-target=".icon-lib">
                                    <img src="//www.lg0578.com/addons/boguan_mall/boguan/public/boguan//images/default_add.png" ondragstart="return false" alt="" title=""></a>
                        ...
                        <div class="form-group col-xs-12 row">
                            ...
                            <div class="col-xs-6 col-sm-8 row input_box">
                                <input class="control-input" type="text" autocomplete="off" name="tel" id="tel" value="<?php echo $setting['tel']; ?>">
                            </div>
                        </div>
                        <!--<div class="form-group col-xs-12 row">
                            <label class="control-label col-xs-6 col-sm-4">
                                <span class="text-title">负责人手机号 </span>
                                <span class="text-danger2">:</span>
                            </label>
                            <div class="col-xs-6 col-sm-8 row input_box">
                                <input class="control-input" type="text" autocomplete="off" name="phone" id="phone" value="<?php echo $setting['phone']; ?>">
                            </div>
                        </div>-->
                        <div class="form-group col-xs-12 row">
                            <label class="control-label col-xs-6 col-sm-4">
                                <span class="text-danger">*</span>
                                <span class="text-title">店铺坐标</span>
                                <span class="text-danger2">:</span>
                            </label>
                            <div class="col-xs-6 col-sm-8 row input_box">
                                <div class="control-box">
                                    <input type="text" class="control-input map_baidu" readonly="" placeholder="点击获取坐标" name="location" id="location" value="<?php echo $setting['longitude']; if($setting['latitude']): ?>,<?php echo $setting['latitude']; endif; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-xs-12 row">
                            <label class="control-label col-xs-6 col-sm-4">
                                <span class="text-danger">*</span>
                                <span class="text-title">店铺地址</span>
                                <span class="text-danger2">:</span>
                            </label>
                            <div class="col-xs-6 col-sm-8 row input_box">
                                <input class="control-input input_address" type="text" autocomplete="off" placeholder="点击“店铺坐标”，自动获取位置" name="address" id="address" value="<?php echo $setting['address']; ?>">
                            </div>
                        </div>
                        <div class="form-group col-xs-12 row">
                            <label class="control-label col-xs-6 col-sm-4">
                                <span class="text-title">店铺简介</span>
                                <span class="text-danger2">:</span>
                            </label>
                            <div class="col-xs-6 col-sm-8 row input_box">
                                <script id="editor" type="text/plain" style="width:450px;height:500px;"><?php echo $setting['summary']; ?></script>
                            </div>
                        </div>
...
<!--地图插件--><script src="https://webapi.amap.com/maps?v=1.3&key=c193b7c51e579ad80ec35989db0d8898&plugin=AMap.PolyEditor"></script>
<script type="text/javascript" defer="defer" src="//www.lg0578.com/addons/boguan_mall/boguan/public/boguan//js/MapType.js"></script>
...
<script>
    ...
    $("form").submit(function(e){
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('boguan/platform.setting/index'); ?>",
            //dataType:"json",
            data:{
                "id": id,
                "name": name,
