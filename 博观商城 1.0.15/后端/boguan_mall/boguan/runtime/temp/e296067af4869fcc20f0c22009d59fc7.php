                ...
                <div class="main-con">
                    <form action="">
                        ...
                        <div class="form-group col-xs-12 row">
                            ...
                            <div class="col-xs-6 col-sm-8 row input_box">
                                <select class="control-chosen control-input" data-placeholder="请选择角色"  name="role_id" id="role_id">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>,perm"><?php echo $vo['role_name']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <!--<div class="form-group col-xs-12 row">
                            ...
                            <div class="col-xs-6 col-sm-8 row input_box">
                                <img src="http://qr.topscan.com/api.php?text=<?php echo $oauth_url; ?>"/>
                            </div>
                        </div>-->
...
<script>
      ...
      function getMpCode(ev){
        ...
        _self.popModal({
          html : function(callback){
            ...
            $.ajax({
              type: "post",
              url: "<?php echo url('boguan/platform.admin/oauthQrCode'); ?>",
            }).done(function(data){
    ...
    var productList= <?php if($userInfo): ?><?php echo $userInfo; else: ?>[]<?php endif; ?>;
        var productListCE={};
        var productSel=[];
...
//获取form表单中所提交 的内容
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('boguan/platform.admin/add'); ?>",
            //dataType:"json",
            data:{
                'data': d,
            },
