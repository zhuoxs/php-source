    ...
    <div class="main_content">
        ...
        <nav class="main_navbar main_navbar-mini">
            ...
            <div class="main_navbar-nav">
                ...
                <div class="navbar-nav-nav">
                    <ul>
                        <li>
                            <a href="<?php echo url('boguan/platform.market/index'); ?>" class="action">
                    <span class="nav-icon">
        ...
        <div class="main_mbody main_mbody-max">
            <div class="col-xs-12">
                ...
                <div class="main-con yingxiao-con">
                    <form action="">
                        <ul class="set-sanji-box">
                            <li class="clearit marketing_list1">
                                <div class="title"><h4>营销玩法</h4></div>
                                <div class="form-group col-xs-12 row">
                                    <ul class="marketing-list">
                                        <li>
                                            <a href="<?php echo url('boguan/platform.coupon/index'); ?>">
                                                <div class="list-logo middle_center">
                                                ...
                                                <div class="list-desc">向客户发放店铺优惠券</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo url('boguan/platform.share/index'); ?>">
                                                <div class="list-logo middle_center">
                                                    <span class="marketing-icon">
                                                ...
                                                <div class="list-desc">客户带客户，裂变式营销引流</div>
                                            </a>
                                        </li>
                                        <!--<li>
                                            <a href="neirong-flash.html">
                                                <div class="list-logo middle_center">
                                                    <span class="marketing-icon">
                                                      <i class="iconfont icon-icon_xianshi-mian"></i>
                                                    </span>
                                                </div>
                                                <div class="list-name">
                                                    限时抢购
                                                </div>
                                                <div class="list-desc">限时抢购</div>
                                            </a>
                                        </li>-->
                                        <?php if(session('PLUGIN_DATA')): $_result=session('PLUGIN_DATA');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                            <li>
                                                <a href="<?php echo url('boguan/'.$vo['controller'].'/index'); ?>">
                                                    <div class="list-logo middle_center">
                                                        <span class="marketing-icon">
                                                    ...
                                                    <div class="list-desc"><?php echo $vo['remark']; ?></div>
                                                </a>
                                            </li>
                            ...
                            <li class="line"></li>
                            <li class="clearit marketing_list2">
                                <div class="title"><h4>客群维护</h4></div>
                                <div class="form-group col-xs-12 row">
                                    <ul class="marketing-list">
                                        <li>
                                            <a href="<?php echo url('boguan/platform.integral/index'); ?>">
                                                ...
                                                <div class="list-desc">满额赠送积分</div>
                                            </a>
                            ...
                            <!--<li class="line"></li>
                            <li class="clearit marketing_list3">
                                <div class="title"><h4>配套工具</h4></div>
                                <div class="form-group col-xs-12 row">
                                    <ul class="marketing-list">
                                        <li>
                                            <a href="neirong-community.html">
                                                <div class="list-logo middle_center">
                                                    <span class="marketing-icon">
