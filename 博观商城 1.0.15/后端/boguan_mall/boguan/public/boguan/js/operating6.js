...
function madeTable(){
  ...
  if(specArr!=''){
    ...
    $.each(specArrTable,function(i,item){
      ...
      $('.pro-more-table tbody').append('<tr id="'+arrid+'" class="spec_tr">'+list_tbody+'<td class="min-img"><div class="imgbox middle_center"><img class="lay_imgsrc"src="'+url+'/images/default_add.png"ondragstart="return false"alt=""title=""draggable="false"><div class="imgNavUp"><span title="本地上传"onclick="iconLibrary(this)"data-laymodal="spec_img"data-toggle="modal"data-target=".icon-lib">点击上传</span></div></div></td><td class="price"><input type="number" class="control-input"></td><td class="stock"><input type="number" class="control-input"></td><td class="code"><input type="number" class="control-input"></td><td class="barcode"><input type="number" class="control-input"></td></tr>');
