...
$info=pdo_get('yzmdwsc_sun_groups',array('uniacid'=>$_W['uniacid'],'id'=>$_GPC['id']));
$id = $_GPC['id'];
...
if(checksubmit('submit')){
        ...
        if (!empty($id)) {
            ...
            unset($data['status']);
           $res = pdo_update('yzmdwsc_sun_groups',$data, array('id' => $id));
        } else {
           $res = pdo_insert('yzmdwsc_sun_groups',$data);
