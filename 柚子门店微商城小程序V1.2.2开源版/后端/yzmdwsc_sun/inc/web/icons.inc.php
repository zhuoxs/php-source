...
$GLOBALS['frames'] = $this->getMainMenu();
 $item=pdo_get('yzmdwsc_sun_yingxiao',array('uniacid'=>$_W['uniacid']));
...
//        p($_GPC);die;
            ...
            if($_GPC['id']==''){                
                $res=pdo_insert('yzmdwsc_sun_yingxiao',$data);
                if($res){
                ...
                $res = pdo_update('yzmdwsc_sun_yingxiao', $data, array('id' => $_GPC['id']));
                if($res){
