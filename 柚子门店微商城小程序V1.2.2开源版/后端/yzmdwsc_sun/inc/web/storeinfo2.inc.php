...
//查出已是商家用户
$sjuser=pdo_getall('yzmdwsc_sun_user',array('uniacid'=>$_W['uniacid']));
$info = pdo_get('yzmdwsc_sun_store_active',array('uniacid'=>$_W['uniacid'],'id'=>$_GPC['id']));
//二维数组转一维
...
//入住类型
//$typein=pdo_getall('yzmdwsc_sun_istoren',array('uniacid'=>$_W['uniacid']));
