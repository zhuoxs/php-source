...
$info=pdo_get('yzmdwsc_sun_information',array('id'=>$_GPC['id']));
//$type=pdo_get('yzmdwsc_sun_type',array('id'=>$info['type_id']));
$type=pdo_getall('yzmdwsc_sun_type',array('uniacid'=>$_W['uniacid'],'state'=>1),array(),'','num asc');
$type2=pdo_get('yzmdwsc_sun_type2',array('id'=>$info['type2_id']));
