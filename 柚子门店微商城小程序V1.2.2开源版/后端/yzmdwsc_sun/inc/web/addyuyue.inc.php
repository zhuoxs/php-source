...
$info=pdo_get('yzmdwsc_sun_goods',array('id'=>$_GPC['id']));
$spec=pdo_getall('yzmdwsc_sun_goods_spec');
$type=pdo_getall('yzmdwsc_sun_type',array('uniacid'=>$_W['uniacid'],'state'=>1));
...
if(checksubmit('submit')){
    ...
    if(empty($_GPC['id'])){
        ...
        $res = pdo_update('yzmdwsc_sun_goods', $data, array('id' => $_GPC['id']));
    }
    if($res){
