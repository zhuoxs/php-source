...
if($_GPC['op']=='delete'){
    $res=pdo_delete('byjs_sun_goods',array('id'=>$_GPC['id']));
    if($res){
...
if($_GPC['op']=='tg'){
    $res=pdo_update('byjs_sun_goods',array('state'=>2),array('id'=>$_GPC['id']));
    if($res){
...
if($_GPC['op']=='jj'){
    $res=pdo_update('byjs_sun_goods',array('state'=>3),array('id'=>$_GPC['id']));
    if($res){
