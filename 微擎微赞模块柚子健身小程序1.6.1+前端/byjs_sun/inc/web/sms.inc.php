...
$item=pdo_get('byjs_sun_sms',array('uniacid'=>$_W['uniacid']));
    if(checksubmit('submit')){
            ...
            if($_GPC['id']==''){                
                $res=pdo_insert('byjs_sun_sms',$data);
                if($res){
                ...
                $res = pdo_update('byjs_sun_sms', $data, array('id' => $_GPC['id'],'uniacid'=>$_W['uniacid']));
                if($res){
