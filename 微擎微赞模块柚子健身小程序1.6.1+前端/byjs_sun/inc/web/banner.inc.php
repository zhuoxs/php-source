...
$info=pdo_get('byjs_sun_banner',array('uniacid' => $_W['uniacid']));
if($info['lb_imgs']){
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        $res=pdo_insert('byjs_sun_banner',$data);
        if($res){
        ...
        $res = pdo_update('byjs_sun_banner', $data, array('id' => $_GPC['id'],'uniacid'=>$_W['uniacid']));
        if($res){
