...
Page({
  ...
  data: {
    ...
    loveimgsrc1: '../../../../fyly_sun/resource/images/interactive/icon-love.png',//点赞灰色背景路径
    loveimgsrc2: '../../../../fyly_sun/resource/images/interactive/icon-love-1.png',//点赞红色背景路径
    lovenum: 0,//点赞数字
    lovenumadd1: 1,
    talent:[],
    gowith: [],
  ...
  gointeractiveInfoone: function (e) {
    var expert_id = e.currentTarget.dataset.id; //获取达人圈内容id
    wx.navigateTo({
      url: '../interactiveInfoone/interactiveInfoone?id=' + expert_id,
    })
  },
  //页面跳转（结伴行详情）
  gointeractiveInfotwo: function (e) {
    var gowith_id = e.currentTarget.dataset.id; //获取结伴行内容id
    wx.navigateTo({
      url: '../interactiveInfotwo/interactiveInfotwo?gowith_id=' + gowith_id,
    })
  },
  /**
   * 生命周期函数--监听页面初次渲染完成
  ...
  attention: function (e) {
    ...
    var activeIndex = that.data.activeIndex;//获取顶部标识,为1标识在达人圈页面,为0标识在结伴行页面
    if (activeIndex == 1) {
      var talent = that.data.gowith;//结伴行
    } else {
  ...
  gototravalpage:function(e){
    var gid = e.currentTarget.dataset.gid;
    var gtype = e.currentTarget.dataset.type;
    var gowith = this.data.gowith;
    var url = "";
    console.log(gowith);
    if (gtype==1){
      url = "/fyly_sun/pages/product/visaInfo/visaInfo?id=" + gid;
    } else if (gtype == 2){
      // if (parseInt(gowith[0].goodsInfo.teamWork)==1){
      //   url = "/fyly_sun/pages/product/fightInfo/fightInfo?id=" + gid;
      // }else{
        url = "/fyly_sun/pages/product/moreFight/moreFight?id=" + gid;
      //}
    }else{
      url = "/fyly_sun/pages/product/index/index"
    }
    //console.log(url);
    wx.navigateTo({
      url: url,
    })
    //抢购  /fyly_sun/pages/product/fightInfo/fightInfo?id=
    //推荐  /fyly_sun/pages/product/moreFight/moreFight?id=
    //签证  /fyly_sun/pages/product/visaInfo/visaInfo?id=
  }
})