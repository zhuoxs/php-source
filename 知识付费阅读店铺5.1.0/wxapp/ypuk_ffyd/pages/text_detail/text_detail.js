...
Page({
    ...
    GetDetail: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                "all" == t.data.data.showmod ? WxParse.wxParse("Text", "html", t.data.data.text, e, 20) : WxParse.wxParse("Text", "html", t.data.data.preview_text, e, 20), 
                e.setData({
