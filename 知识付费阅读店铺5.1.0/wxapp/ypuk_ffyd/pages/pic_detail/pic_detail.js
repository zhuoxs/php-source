...
Page({
    ...
    onShareAppMessage: function() {
        ...
        return {
            ...
            path: "ypuk_ffyd/pages/pic_detail/pic_detail?articleid=" + t.data.articleId + "&shareuid=" + t.data.userId,
            success: function(t) {
                wx.showToast({
                    title: "转发成功",
                    icon: "success",
    ...
    showPreviewPic: function(t) {
        var e = t.currentTarget.dataset.idx;
        wx.previewImage({
            current: this.data.articleInfo.preview_pic[e],
            urls: this.data.articleInfo.preview_pic
        });
    },
    showAllPic: function(t) {
        var e = t.currentTarget.dataset.idx;
        wx.previewImage({
            current: this.data.articleInfo.pic[e],
            urls: this.data.articleInfo.pic
        });
    },
    AddComment: function() {
        this.setData({
